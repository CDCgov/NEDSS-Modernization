...
@Component
public class StreetAddressResolver {
  ...
  private static final String FIRST_FOUR_QUERY = """
       AND LEFT(pl.street_addr1, 4) = LEFT(?, 4)
      """;

  private static final String LAST_FOUR_QUERY = """
       AND RIGHT(pl.street_addr1, 4) = RIGHT(?, 4)
      """;
  private final JdbcTemplate template;

  public StreetAddressResolver(final JdbcTemplate template) {
