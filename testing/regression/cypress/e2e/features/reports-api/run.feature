Feature: Run Report API Validation
  ...
  Scenario: Run report with missing reportUid
    ...
    Then the run response status should be 422
    Then the run response should contain validation error for "reportUid"
  ...
  Scenario: Run report with missing dataSourceUid
    ...
    Then the run response status should be 422
    Then the run response should contain validation error for "dataSourceUid"
  ...
  Scenario: Run report with invalid reportUid type
    ...
    Then the run response status should be 422
    Then the run response should contain serialization error for "reportUid"
  ...
  Scenario: Run report with invalid dataSourceUid type
    ...
    Then the run response status should be 422
    Then the run response should contain serialization error for "dataSourceUid"

  Scenario: Run report with invalid isExport type
    When I send a POST request to /nbs/api/report/run with isExport as string
    Then the run response status should be 422
    Then the run response should contain serialization error for "isExport"
  ...
  Scenario: Run report with invalid basic filters
    ...
    Then the run response status should be 422
    Then the run response should contain validation error for "basicFilters"
  ...
  Scenario: Run report with an invalid advanced filter
    ...
    Then the run response status should be 422
    Then the run response should contain validation error for "advancedFilter"