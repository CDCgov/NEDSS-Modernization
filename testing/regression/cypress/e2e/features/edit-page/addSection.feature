...
Feature: Page Builder - User can verify add section while editing the page here.
  ...
  Background:
    ...
    And User navigates to Edit page and views Add a section pop-up window

  Scenario: Add a section in (Edit Mode)
    When User enters a section name in the the required text field
    And User clicks the Add section button enabled
