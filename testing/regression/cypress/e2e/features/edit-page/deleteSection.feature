...
Feature: Page Builder - User can verify delete section while editing the page here.
  ...
  Scenario: Delete Section with subsections via edit page view
    When clicks on 3 dots next to section
    And click on 'Delete section' link
  ...
  Scenario: Delete Section without elements via edit page view
    When clicks on 3 dots next to section without subsections
    And click on 'Delete section' link without subsections
    Then user gets a warning pop up window with message "Are you sure you want to delete the section?" "Deleting this section cannot be undone. Are you sure you want to continue?"
