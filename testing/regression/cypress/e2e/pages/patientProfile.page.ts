...
class PatientProfilePage {
    ...
    addPatientInvestigations() {
        ...
        cy.get(
            'body > table:nth-child(2) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(1) > table:nth-child(1) > thead:nth-child(1) > tr:nth-child(2) > td:nth-child(1) > div:nth-child(1) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(4) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > input:nth-child(1)'
        ).click();
    ...
    addPatientInvestigations_AcanthamoebaDisease() {
        ...
        cy.get(
            'body > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > form:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > button:nth-child(2)'
        ).click();
    ...
    addPatientInvestigations_AfricanTickBite() {
        ...
        cy.get("img[name='proxy.publicHealthCaseVO_s.thePublicHealthCaseDT.jurisdictionCd_button']").type(
            'Cobb County'
        );
        cy.get(
            'body > table:nth-child(2) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(1) > table:nth-child(1) > thead:nth-child(1) > tr:nth-child(2) > td:nth-child(1) > div:nth-child(1) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(4) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > input:nth-child(1)'
    ...
    verifyMorbidityEventIdNotInDocumentsRequiringReview() {
        ...
        cy.get('body').then(($body) => {
            ...
            if (!isVisible) {
                ...
                expect(tableText, 'Morbidity event ID should NOT appear in Documents Requiring Review').to.not.include(
                    eventId
                );
                return;
            }
