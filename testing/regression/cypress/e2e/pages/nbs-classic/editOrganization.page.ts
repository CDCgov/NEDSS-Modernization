...
class EditOrganizationPage {
    ...
    clickAddIdentificationButton() {
        ...
        cy.get('#BatchEntryAddButtonIdentification', { timeout: 10000 }).should('be.visible').click();
    ...
    addNewIdEntry(idDetails: any) {
        ...
        cy.wait(500);
        cy.get('select[name="organization.entityIdDT_s[i].assigningAuthorityCd"]').select(idDetails.authority, {
            force: true,
        });
    ...
    clickAddTelephoneButton() {
        ...
        cy.get('#BatchEntryAddButtonTelephone', { timeout: 10000 }).should('be.visible').click();
        cy.wait(500);
    }
    ...
    clickAddAddressButton() {
        ...
        cy.get('#BatchEntryAddButtonAddress', { timeout: 10000 }).should('be.visible').click();
        cy.wait(500);
    }
}
