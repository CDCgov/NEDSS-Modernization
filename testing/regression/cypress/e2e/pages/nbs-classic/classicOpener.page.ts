class ClassicOpenerPage {
    ...
    submitForm() {
        document.forms[0].action =
            '/nbs/ManagePageElement.do?method=editSubmit&eltType=section&waQuestionUId=' +
            Cypress.$('#pageElementUid').val();
