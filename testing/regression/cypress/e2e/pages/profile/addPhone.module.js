...
class AddPhoneModule {
    ...
    type() {
        cy.get('.usa-modal-wrapper.is-visible select[data-testid=dropdown]').first().select('Phone');
        return this;
    }

    use() {
        cy.get('.usa-modal-wrapper.is-visible select[data-testid=dropdown]').first().select('Home');
        return this;
    }
    ...
    email() {
        cy.get('.usa-modal-wrapper.is-visible #email').type('testemail@eqsandbox.com');
        return this;
    }
