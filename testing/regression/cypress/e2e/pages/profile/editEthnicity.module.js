class EditEthnicityModule {
    ...
    date() {
        ...
        cy.get(this.section).eq(2).find('.usa-input.usa-date-picker__external-input').clear();
        cy.get(this.section).eq(2).find('.usa-input.usa-date-picker__external-input').wait(500).type(formattedDate);
        return this;
    }
