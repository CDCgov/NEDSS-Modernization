class EventsTabPage {
    ...
    verifyReportCountIncreased(ReportType) {
        ...
        this.getCountBadge(reportIndex)
            ...
            .then((text) => {
                ...
                expect(newCount, ReportType + ' count should increase by 1').to.equal(initialCount + 1);
            });
    }
    ...
    verifyReportCountUnchanged(ReportType) {
        ...
        this.getCountBadge(reportIndex)
            ...
            .then((text) => {
                const newCount = parseInt(text.trim(), 10);
                cy.log(ReportType + ' - Initial: ' + initialCount + ', New: ' + newCount);
                expect(newCount, ReportType + ' count should remain the same').to.equal(initialCount);
            });
    }
    ...
    verifyTreatmentCountIncreased() {
        ...
        this.findRowByEventId(eventId)
            ...
            .then((newCount) => {
                ...
                expect(newCount, 'Treatment count for ' + eventId + ' should increase by 1').to.equal(initialCount + 1);
            });
    }
    ...
    verifyStoredMorbidityReportHasAssociation() {
        ...
        this.findRowByEventId(eventId)
            ...
            .then((text) => {
                ...
                expect(associatedText, 'Associated with should have an investigation ID').to.match(/CAS\d+/);
            });
    }
    ...
    clickStoredInvestigationId() {
        ...
        cy.get('#investigations-table tbody tr').contains('td a', investigationId).should('be.visible').click();
    }
    ...
    verifyMorbidityEventIdNotInMorbidityReports() {
        ...
        cy.get('#morbidity-reports-table')
            ...
            .within(() => {
                ...
                cy.get('tbody tr td:first-child a').then(($links) => {
                    let found = false;
                    ...
                    expect(found, 'Morbidity event ID should NOT appear in Morbidity Reports table').to.be.false;
                });
            });
    }
}
