...
Then('User enters keyword {string} in the Search field', (string: string) => {
...
Then(
    'All pages related to {string} will be returned as a list in the library in {string}',
...
Then('User selects {string} from the drop-down box', (string: string) => {
    searchAndFilterPage.selectColumn(string);
});
Then('User selects {string} from the Operator field', (string: string) => {
    searchAndFilterPage.selectOperator(string);
});
Then('User enters {string} in the Type a value field', (string: string) => {
...
Then(
    'Added filters {string} and {string} are applied and only the records matching the filters are displayed in the Page Library list',
...
Then('User enters {string} in the Type a value field - multi select', (string: string) => {
