...
Then('User select {string} left footer of the page to show the list of pages', (string: string) => {
...
Then(
    'User should see the subsequent rows listed in the library for the number of rows selected and Same results when paginating pages 3, 4, and 5',
    () => {
        pageLibraryPaginationPage.clickByPageNumber(3);
    }
);
