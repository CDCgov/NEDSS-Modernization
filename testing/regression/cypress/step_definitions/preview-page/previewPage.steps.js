...
Then(
    'user is at Preview page - Page info section with page under Draft or Published with Draft or Published status',
    () => {
        previewPagePage.navigateToPreviewPageWithStatusInitialDraft();
    }
);
...
Then(
    'New page is saved to the database and the application directs the user to the Page library Edit page to edit the additional page information',
    () => {
