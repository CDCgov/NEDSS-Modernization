...
Then(
    'Application will direct the user to the Business Library with the entries populated in the applicable columns',
    () => {
...
Then(
    'Application will validate the values added, add the business rule to the selected page and then navigate to the Business Rule library with the changes made. A confirmation success message displays, The business rule is successfully updated. Please click the unique name to edit.',
    () => {
        businessRulesPage.checkRedirectedToLibraryPage();
    }
);
