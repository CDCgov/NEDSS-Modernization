...
Then(
    'Create new condition pop-up window closes and confirmation success message displays with the new condition added in the Conditions field on Create new page',
    () => {
...
Then(
    'New page created displays with the Patient tab active for the user to start editing the detailed page information',
    () => {
