...
When('the user has enters for a patient by {string} as {string}', (string: string, string2: string) => {
    searchPage.selectId();
    searchPage.enterIdType(string);
    searchPage.enterId(string2);
});
...
Then('Name {string} information is displayed on the patient profile page', () => {
