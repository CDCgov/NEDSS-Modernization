...
class DateCompareCommandCreatorTest {
  ...
  void generates_valid_expression() {
    ...
    String expression = creator.createExpression("INV132", List.of("INV162 , INV110"), "<");
  ...
  void generates_valid_expression_single() {
    ...
    String expression = creator.createExpression("INV132", List.of("INV162"), "<");
    assertThat(expression).isEqualTo(expected);
  }
  ...
  void generates_valid_error_message_single() {
    String expected = "Admission Date  must be <=  Confirmation Date";
    String errorMessage =
        creator.createErrorMessage("Admission Date", List.of("Confirmation Date"), "<=");
    assertThat(errorMessage).isEqualTo(expected);
  }
  ...
  void generates_valid_javascript_name() {
    ...
    String functionName = creator.createJavascriptName("INV132", 10);
