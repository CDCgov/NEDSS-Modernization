...
class PageCreatorTest {
  ...
  @Mock private WaUiMetadataRepository waUiMetadatumRepository;

  @Mock WaRuleMetaDataRepository waRuleMetaDataRepository;

  @Mock private PageValidator validator;

  @InjectMocks private PageCreator pageCreator;
  ...
  void testSavePageCondMapping() {
    ...
    PageCreateRequest request =
        new PageCreateRequest(null, conditionIds, null, 0L, null, null, null);
    Long templateId = 1L;
