...
public class UpdateStaticRequestHelper {
    ...
    public static UpdateStaticRequests.UpdateHyperlink withLabel(UpdateStaticRequests.UpdateHyperlink request, String label) {
        return new UpdateStaticRequests.UpdateHyperlink(label, request.linkUrl(), request.adminComments());
    }

    public static UpdateStaticRequests.UpdateHyperlink withLink(UpdateStaticRequests.UpdateHyperlink request, String link) {
