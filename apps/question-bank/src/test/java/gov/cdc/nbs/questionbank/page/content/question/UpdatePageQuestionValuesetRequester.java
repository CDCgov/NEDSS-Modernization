...
public class UpdatePageQuestionValuesetRequester {
  ...
  ResultActions send(long page, long questionId, UpdatePageCodedQuestionValuesetRequest request)
      throws Exception {
    return mvc.perform(
        this.authenticated
            .withUser(
                put("/api/v1/pages/{page}/questions/coded/{questionId}/valueset", page, questionId))
