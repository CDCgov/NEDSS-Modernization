...
class WaRdbMetadataTest {
  ...
  void should_create_from_ui_metadata() {
    ...
    PageContentCommand.UpdateDateQuestion command = new PageContentCommand.UpdateDateQuestion(
        36l,
        "new label",
        "new tooltip",
        false,
    ...
    assertThat(rdbMetadata.getUserDefinedColumnNm()).isEqualTo(command.datamartInfo().dataMartColumnName());
