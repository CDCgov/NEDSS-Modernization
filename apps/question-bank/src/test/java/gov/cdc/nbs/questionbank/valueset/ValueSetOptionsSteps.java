...
public class ValueSetOptionsSteps {
  ...
  public void i_search_for_valuesets_by_query(String query, String sortField, String direction)
      throws Exception {
    Pageable pageable =
        PageRequest.of(
            0, 25, direction.contains("asc") ? Direction.ASC : Direction.DESC, sortField);
  ...
  public void options_are_sorted_by(String field, String direction) throws Exception {
    ...
    Comparator<String> comparator =
        (a, b) -> isAsc ? a.compareToIgnoreCase(b) : b.compareToIgnoreCase(a);
