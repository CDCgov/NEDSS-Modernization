...
public class ValueSetOptionRequester {
  ...
  ResultActions search(final ValueSetSearchRequest request, final Pageable pageable) throws Exception {
    MockHttpServletRequestBuilder builder = this.authenticated.withUser(post("/api/v1/valueset/options/search"))
