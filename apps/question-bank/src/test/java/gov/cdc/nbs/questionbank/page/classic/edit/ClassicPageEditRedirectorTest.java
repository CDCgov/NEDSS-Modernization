...
class ClassicPageEditRedirectorTest {
  ...
  @Mock
  private ClassicEditPagePreparer preparer;

  @InjectMocks
  private ClassicPageEditRedirector redirector;
  ...
  void should_redirect_to_edit() {
    ...
    assertEquals("/nbs/ManagePage.do?fromWhere=V&method=editPageContentsLoad&waTemplateUid=123", location);
  }
}
