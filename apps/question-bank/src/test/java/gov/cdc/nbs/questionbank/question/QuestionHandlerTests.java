...
public class QuestionHandlerTests {
	...
	public void sendDeleteQuestionResponseStatus() {
		...
		questionHandler.sendDeleteQuestionResponseStatus(requestStatusProducer, deleteEvent);

		verify(questionHandler, times(1)).sendDeleteQuestionResponseStatus(Mockito.any(), captor.capture());
