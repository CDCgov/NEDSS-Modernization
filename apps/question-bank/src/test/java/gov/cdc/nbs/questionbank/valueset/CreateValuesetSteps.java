...
public class CreateValuesetSteps {
  ...
  public CreateValuesetSteps(
      final CreateValuesetRequester requester,
      final Active<ResultActions> response) {
    this.requester = requester;
    this.response = response;
  }

  @When("I send a request to create a valueset with type {string}, code {string}, name {string}, and description {string}")
  ...
  @Then("the valueset is created with type {string}, code {string}, name {string}, and description {string}")
