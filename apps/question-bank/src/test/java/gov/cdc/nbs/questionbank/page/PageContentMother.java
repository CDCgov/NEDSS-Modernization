...
class PageContentMother {
  ...
  public void withSectionIn(
    ...
    harness.with(page)
        .use(found -> nthOfType(found.getUiMetadata(), tab, PageConstants.TAB_COMPONENT)
  ...
  public void withSectionIn(
    ...
    harness.with(page)
        .use(found -> nthOfType(found.getUiMetadata(), tab, PageConstants.TAB_COMPONENT)
            .ifPresent(container -> withSectionIn(found, container,
                container.getQuestionLabel() + " Section")));
  }
  ...
  public void withSectionIn(
    ...
    harness.with(page)
        .use(found -> found.getUiMetadata().stream().filter(havingName(tab))
            .findFirst()
            .ifPresent(container -> withSectionIn(found, container, name)));
  ...
  public void withSubSectionIn(
    ...
    harness.with(page)
        .use(found -> nthOfType(found.getUiMetadata(), section, PageConstants.SECTION_COMPONENT)
  ...
  public void withSubSectionIn(
    ...
    harness.with(page)
        ...
        nthOfType(found.getUiMetadata(), section, PageConstants.SECTION_COMPONENT)
            .ifPresent(
                container -> withSubSectionIn(found, container,
                    container.getQuestionLabel()
                        + " Sub-Section")));
  }
  ...
  public void withSubSectionIn(
    ...
    harness.with(page)
        .use(found -> found.getUiMetadata().stream().filter(havingName(section))
            .findFirst()
            .ifPresent(container -> withSubSectionIn(found, container, name)));
  }
  ...
  private void withSubSectionIn(
    ...
    placeWithin(found.getUiMetadata(), container, PageConstants.SECTION_COMPONENT)
        .ifPresent(order -> found.addSubSection(name, order, this.settings.createdBy(),
            Instant.now()));
  ...
  public void withContentIn(
    ...
    harness.with(page)
        ...
        found.getUiMetadata().stream().filter(havingName(subSection))
            .findFirst()
            .ifPresent(container -> withContentIn(found, container, name, 1008L, "DEM107", null)));
  }
  ...
  private void withContentIn(
    ...
    placeWithin(found.getUiMetadata(), container, type)
        .ifPresent(order -> found.addContent(name, type, order, this.settings.createdBy(),
            Instant.now(), identifier, dataType));
