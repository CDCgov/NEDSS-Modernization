...
class AddSectionServiceTest {
    ...
    @Test
    void createSectionServiceTestException() throws AddSectionException {

        AddSectionException exception =
                assertThrows(AddSectionException.class, () -> createSectionService.createSection(123L, null));

        assertEquals(
                "gov.cdc.nbs.questionbank.addsection.exception.AddSectionException: Add section exception",
                exception.toString());
    }
}
