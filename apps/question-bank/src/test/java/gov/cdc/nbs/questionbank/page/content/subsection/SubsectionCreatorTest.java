...
class SubsectionCreatorTest {
    ...
    void should_create_subsection() {
        ...
        when(page.addSubSection(Mockito.any(PageContentCommand.AddSubsection.class))).thenReturn(newSubSectionMock);
        ...
        creator.create(
                1l,
                new CreateSubSectionRequest(3l, "subsection", false),
                44l);
