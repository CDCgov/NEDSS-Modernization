...
Feature: Create Business Rule
    ...
    Scenario: I can create a require if business rule with multiple source values
        ...
        And the business rule has "target identifiers list" of: 
            | INV143 |
        And the business rule has "source value id" of: 
            | M | F |
        And the business rule has "source value text" of: 
            | Male | Female |
        ...
        And the business rule should have "source text" of "Current Sex"
        ...
        And the business rule should have "target values list" of: 
            | Age at Onset |
        And the business rule should have "target identifiers list" of: 
            | INV143 |
        And the business rule should have "source value id" of: 
            | M | F |
        And the business rule should have "source value text" of: 
            | Male | Female |