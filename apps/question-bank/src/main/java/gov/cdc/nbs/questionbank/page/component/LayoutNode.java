...
public abstract sealed class LayoutNode extends ComponentNode
    permits PageNode, SectionNode, SubSectionNode, TabNode {
  ...
  protected LayoutNode(final long identifier, final Type type, final Definition definition) {
