...
public class PageContentIdGenerator {
    ...
    public PageContentIdGenerator(final IdGeneratorService idGenerator,
    ...
    /**
     * <p>
     * Ids are a combination of the NBS_ODSE.NBS_configuration.NBS_CLASS_CODE value and the next valid Id from the
     * NBS_ODSE.Local_UID_generator NBS_QUESTION_ID_LDF row
     * </p>
     * <p>
     * Example: GA10001
     * </p>
