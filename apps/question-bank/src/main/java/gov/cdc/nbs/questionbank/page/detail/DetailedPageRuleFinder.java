...
class DetailedPageRuleFinder {
  ...
  private final RowMapper<DetailedPageRule> mapper;

  DetailedPageRuleFinder(final JdbcTemplate template) {
    this.template = template;
    this.mapper = new DetailedPageRuleMapper();
  }

  Collection<DetailedPageRule> find(final long identifier) {
