...
public class PageMetaDataDownloader {
  ...
  private static final String[] SIMPLE_PAGE_METADATA_HEADER = new String[] {
      PAGE_NAME, ORDER_NBR, QUESTION_IDENTIFIER, "question_nm", QUESTION_LABEL, "question_type",
      "desc_txt", "question_tool_tip", DATA_TYPE, "ui_display_type", "code_set_nm ", " value_set_code",
      "value_set_nm ", ENABLE_IND, DISPLAY_IND, "required_ind", "publish_ind_cd", "repeats_ind_cd",
      "field_size", "max_length", "mask", "min_value", "max_value", "default_value", OTHER_VALUE_IND_CD,
      "future_date_ind_cd", "unit_type_cd", "unit_code_set_nm", "unit_value", "question_unit_identifier",
      "unit_parent_identifier", "data_location", "part_type_cd", "participation_type", "data_cd",
      "data_use_cd", "standard_question_ind_cd", "standard_nnd_ind_cd", "coinfection_ind_cd",
      " repeat_group_seq_nbr", "question_group_seq_nbr", "batch_table_appear_ind_cd", "batch_table_column_width",
      "batch_table_header", "block_nm", "block_pivot_nbr", "question_identifier_nnd", "question_label_nnd",
      "question_required_nnd", "question_data_type_nnd", "hl7_segment_field", "order_group_id", "question_map",
      "indicator_cd", "group_nm", "sub_group_nm", "rdb_table_nm", "rdb_column_nm", "data_mart_column_nm",
      "rpt_admin_column_nm", "admin_comment"
  };

  private static final String[] COMPREHENSIVE_PAGE_METADATA_HEADER = new String[] {
      PAGE_NAME, ORDER_NBR, QUESTION_IDENTIFIER, "question_nm", QUESTION_LABEL, "question_type",
      "desc_txt", "question_oid", "question_oid_system_txt", "question_tool_tip", DATA_TYPE, "nbs_ui_component_uid",
      "ui_display_type", "code_set_group_id", "code_set_nm ", " value_set_code",
      "value_set_nm ", ENABLE_IND, DISPLAY_IND, "required_ind", "publish_ind_cd", "version_ctrl_nbr", "repeats_ind_cd",
      "field_size", "max_length", "mask", "min_value", "max_value", "default_value", OTHER_VALUE_IND_CD,
      "future_date_ind_cd", "unit_type_cd", "unit_code_set_nm", "unit_value", "question_unit_identifier",
      "unit_parent_identifier", "data_location", "legacy_data_location", "part_type_cd", "participation_type",
      "data_cd",
      "data_use_cd", "entry_method", "standard_question_ind_cd", "standard_nnd_ind_cd", "coinfection_ind_cd",
      " repeat_group_seq_nbr", "question_group_seq_nbr", "batch_table_appear_ind_cd", "batch_table_column_width",
      "batch_table_header", "block_nm", "block_pivot_nbr", "question_identifier_nnd", "question_label_nnd",
      "question_required_nnd", "question_data_type_nnd", "hl7_segment_field", "order_group_id", "question_map",
      "indicator_cd", "group_nm", "sub_group_nm", "rdb_table_nm", "rdb_column_nm", "data_mart_column_nm",
  ...
  private static final String[] PAGE_VOCABULARY_METADATA_HEADER = new String[] {
      "code_set_nm", "value_set_code", "value_set_nm", "code", "code_desc_txt", "code_short_desc_txt",
      "status_cd", "concept_code", "concept_nm", "concept_preferred_nm", "code_set_group_id", "code_system_cd",
      "code_system_desc_txt", "concept_type_cd", "effective_from_time", "effective_to_time", "add_time"};

  private static final String[] PAGE_QUESTION_VOCABULARY_METADATA_HEADER = new String[] {
      PAGE_NAME, ORDER_NBR, QUESTION_IDENTIFIER, QUESTION_LABEL, DATA_TYPE, ENABLE_IND,
      DISPLAY_IND, OTHER_VALUE_IND_CD, "code_set_nm", "value_set_code", "value_set_nm", "code",
      "code_desc_txt", "code_short_desc_txt", "status_cd", "effective_from_time", "effective_to_time",
      "concept_code", "concept_nm", "concept_preferred_nm", "code_system_cd", "code_system_desc_txt",
      "concept_type_cd", "add_time"
  };
  ...
  public ByteArrayInputStream downloadPageMetadataByWaTemplateUid(Long waTemplateUid) throws IOException {
    try (XSSFWorkbook workbook = new XSSFWorkbook()) {
      ...
      printSheet(workbook, sheet1, SIMPLE_PAGE_METADATA_HEADER, findSimpleQuestionByWaTemplateUid(waTemplateUid));
      Sheet sheet2 = workbook.createSheet("Comprehensive Question Metadata");
      printSheet(workbook, sheet2, COMPREHENSIVE_PAGE_METADATA_HEADER,
          findComprehensiveQuestionByWaTemplateUid(waTemplateUid));
      Sheet sheet3 = workbook.createSheet("Vocabulary Metadata");
      printSheet(workbook, sheet3, PAGE_VOCABULARY_METADATA_HEADER, findPageVocabularyByWaTemplateUid(waTemplateUid));
      Sheet sheet4 = workbook.createSheet("Question With Vocabulary");
      printSheet(workbook, sheet4, PAGE_QUESTION_VOCABULARY_METADATA_HEADER,
  ...
  public void printSheet(XSSFWorkbook workbook, Sheet sheet, String[] header, List<Object[]> dataList) {
    Cell cell = null;
    Row headerRow = sheet.createRow(0);

    CellStyle dateCellStyle = workbook.createCellStyle();
    CreationHelper createHelper = workbook.getCreationHelper();
    dateCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("yyyy-mm-dd hh:mm:ss.000"));
  ...
  public List<Object[]> findSimpleQuestionByWaTemplateUid(Long waTemplateUid) {
    return jdbcTemplate.query(FIND_SIMPLE_QUESTION_METADATA_BY_TEMPLATE_SQL, setter -> setter.setLong(1, waTemplateUid)
        , (rs, rowNum) -> getResultSetRow(rs));
  }

  public List<Object[]> findComprehensiveQuestionByWaTemplateUid(Long waTemplateUid) {
    return jdbcTemplate.query(FIND_COMPREHENSIVE_QUESTION_METADATA_BY_TEMPLATE_SQL,
        setter -> setter.setLong(1, waTemplateUid), (rs, rowNum) -> getResultSetRow(rs));
  }

  public List<Object[]> findPageVocabularyByWaTemplateUid(Long waTemplateUid) {
    return jdbcTemplate.query(FIND_PAGE_VOCABULARY_BY_TEMPLATE_SQL, setter -> {
  ...
  public List<Object[]> findPageQuestionVocabularyByWaTemplateUid(Long waTemplateUid) {
    return jdbcTemplate.query(FIND_PAGE_QUESTION_VOCABULARY_BY_TEMPLATE_SQL, setter -> setter.setLong(1, waTemplateUid)
        , (rs, rowNum) -> getResultSetRow(rs));
  }
