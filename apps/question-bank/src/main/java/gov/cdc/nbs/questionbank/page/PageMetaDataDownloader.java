...
public class PageMetaDataDownloader {
    ...
    private static final String[] SIMPLE_PAGE_METADATA_HEADER = new String[]{
            "page_nm", "order_nbr", "question_identifier", "question_nm", "question_label", "question_type",
    ...
    private static final String[] COMPREHENSIVE_PAGE_METADATA_HEADER = SIMPLE_PAGE_METADATA_HEADER;
    ...
    private static final String[] PAGE_QUESTION_VOCABULARY_METADATA_HEADER = new String[]{
            "page_nm", "order_nbr", "question_identifier", "question_label", "data_type", "enable_ind",
    ...
    public ByteArrayInputStream downloadPageMetadataByWaTemplateUid(Long waTemplateUid) throws IOException {
        try (XSSFWorkbook workbook = new XSSFWorkbook()) {
            ...
            printSheet(workbook, sheet2, COMPREHENSIVE_PAGE_METADATA_HEADER, findComprehensiveQuestionByWaTemplateUid(waTemplateUid));
            ...
            printSheet(workbook, sheet4, PAGE_QUESTION_VOCABULARY_METADATA_HEADER, findPageQuestionVocabularyByWaTemplateUid(waTemplateUid));
    ...
    public List<Object[]> findComprehensiveQuestionByWaTemplateUid(Long waTemplateUid) {
        return jdbcTemplate.query(FIND_COMPREHENSIVE_QUESTION_METADATA_BY_TEMPLATE_SQL, setter -> setter.setLong(1, waTemplateUid)
                , (rs, rowNum) -> getResultSetRow(rs));
    }
