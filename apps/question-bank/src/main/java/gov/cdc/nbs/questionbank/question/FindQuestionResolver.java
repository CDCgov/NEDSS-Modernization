...
public class FindQuestionResolver {
    ...
    public Page<Questionnaire.Question> findQuestions(
        ...
        log.debug("Received findQuestions request with filter: {}, and page: {}", filter, page);
        Page<Questionnaire.Question> questions = finder.find(filter, QuestionPage.toPageable(page));
