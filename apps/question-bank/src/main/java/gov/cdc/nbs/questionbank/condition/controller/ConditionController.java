...
public class ConditionController {
    ...
    @PatchMapping("/{id}")
    @PreAuthorize("hasAuthority('LDFADMINISTRATION-SYSTEM')")
    public ResponseEntity<ConditionStatusResponse> activateCondition(@PathVariable String id) {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('LDFADMINISTRATION-SYSTEM')")
    public ResponseEntity<ConditionStatusResponse> inactivateCondition(@PathVariable String id) {
