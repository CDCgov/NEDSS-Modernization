...
class DetailedPageFinder {
  ...
  private final RowMapper<DetailedPage> mapper;

  DetailedPageFinder(final JdbcTemplate template) {
    this.template = template;
    this.mapper = new DetailedPageMapper();
  }

  Optional<DetailedPage> find(final long identifier) {
