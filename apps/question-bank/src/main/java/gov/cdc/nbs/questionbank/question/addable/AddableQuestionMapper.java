...
public class AddableQuestionMapper {

  private static final AddableQuestionTables tables = new AddableQuestionTables();

  private AddableQuestionMapper() {}


  public static AddableQuestion toQuestion(Tuple tuple) {
    return new AddableQuestion(
