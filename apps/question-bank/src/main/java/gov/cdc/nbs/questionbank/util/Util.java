...
public class Util {
    ...
    /**
     * Check if an object is null, if so throw an exception with the message "<i>field</i> must not be null"
     * 
     * @param <T>
     * @param obj
    ...
    /**
     * Check if an String is null or blank, if so throw an exception with the message "<i>field</i> must not be null or
     * empty"
     * 
     * @param <T>
     * @param obj
