...
class PatientUpdaterTest {
    ...
    void should_update_ethnicity_info() {
        ...
        assertThat(data.ethnicityGroupInd()).isEqualTo(savedPerson.getEthnicity().ethnicGroup());
        assertThat(data.ethnicUnkReasonCd()).isEqualTo(savedPerson.getEthnicity().unknownReason());
