...
public class PatientUpdater {
    ...
    public Person update(final Person person, final UpdateEthnicityData data) {
        person.update(asUpdateEthnicityInfo(data));
        return personRepository.save(person);
    }
    ...
    private PatientCommand.UpdateEthnicityInfo asUpdateEthnicityInfo(UpdateEthnicityData data) {
