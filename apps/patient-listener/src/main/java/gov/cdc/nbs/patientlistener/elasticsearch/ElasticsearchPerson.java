...
import gov.cdc.nbs.patientlistener.enums.RecordStatus;
import gov.cdc.nbs.patientlistener.enums.Suffix;
import gov.cdc.nbs.patientlistener.enums.converter.DeceasedConverter;
...
import static gov.cdc.nbs.patientlistener.util.Constants.DATE_PATTERN;
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
