...
class PatientProfileEventReturnRouteLocatorConfigurationTest {
  ...
  @Test
  void should_route_to_service_when_ContextAction_is_ReturnToFileSummary() {
    service.stubFor(
    ...
    webClient
        ...
        .uri(
            builder ->
                builder.path("/nbs/any").queryParam("ContextAction", "ReturnToFileSummary").build())
        .exchange()
        .expectStatus()
        .isOk();
  }
