...
class SubmittedLabAddLocatorConfigurationTest {
    @RegisterExtension
    ...
    @Test
    void should_route_to_service_when_Add_Lab_is_submitted() {
        service.stubFor(get(urlPathMatching("/nbs/redirect/patient/report/lab/submit\\\\?.*")).willReturn(ok()));
