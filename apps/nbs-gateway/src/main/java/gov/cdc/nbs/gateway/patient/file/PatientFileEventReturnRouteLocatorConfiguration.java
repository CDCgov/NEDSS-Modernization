...
/**
 * Configures the Patient File routes to the {@code /nbs/redirect/patient/file/events/return} path
 ...
 *
 * <ul>
 *   <li>Query Parameter {@code ContextAction} of {@code ReturnToFileEvents}
 * </ul>
 */
@Configuration
