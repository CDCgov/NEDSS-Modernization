...
/**
 * Configures the NBS System Management page to route to the modernized system management page. The
 * route is enabled when the {@code nbs.gateway.system.management.enabled} property is {@code true}.
 */
@Configuration
@ConditionalOnProperty(
    prefix = "nbs.gateway.system.management",
    name = "enabled",
    havingValue = "true")
