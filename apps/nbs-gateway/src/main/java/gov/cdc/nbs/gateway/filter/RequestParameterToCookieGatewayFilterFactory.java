...
/**
 * A {@link GatewayFilter} factory that will add a {@code Set-Cookie} header to the response with the value of a request
 * parameter from the request.  The cookie will only be added if the request parameter exists and the value exists.
 *
 * <pre>
 * spring:
 *   cloud:
 ...
 */
@Component
public class RequestParameterToCookieGatewayFilterFactory extends AbstractGatewayFilterFactory<RequestParameterToCookieGatewayFilterFactory.Config> {
