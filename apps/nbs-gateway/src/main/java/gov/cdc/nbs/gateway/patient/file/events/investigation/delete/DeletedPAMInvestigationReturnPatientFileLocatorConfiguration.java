 ...
 *
 * <ul>
 *   <li>Path equal to {@code /nbs/PamAction.do}
...
class DeletedPAMInvestigationReturnPatientFileLocatorConfiguration {

  @Bean
  RouteLocator deletedPAMInvestigationPatientFileReturn(
