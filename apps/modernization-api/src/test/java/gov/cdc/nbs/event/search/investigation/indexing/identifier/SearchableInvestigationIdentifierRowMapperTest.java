...
class SearchableInvestigationIdentifierRowMapperTest {
  ...
  void should_map_from_result_set() throws SQLException {
    SearchableInvestigationIdentifierRowMapper.Column columns = new SearchableInvestigationIdentifierRowMapper.Column(
        2,
        3,
        5
    );
    ...
    SearchableInvestigationIdentifierRowMapper mapper = new SearchableInvestigationIdentifierRowMapper(columns);
