...
class InvestigationSearchResultConverterTest {
  ...
  void should_convert_to_result() {
    SearchableInvestigation searchable =
        new SearchableInvestigation(
            971L,
            "class-code-value",
            "mood-value",
            "program-area-value",
    ...
    InvestigationSearchResult converted =
        InvestigationSearchResultConverter.convert(searchable, 56.3d);
  ...
  void should_convert_to_result_with_default_score_when_score_is_null() {
    ...
    InvestigationSearchResult converted =
        InvestigationSearchResultConverter.convert(searchable, null);
        ...
        .thenReturn(
            List.of(
                new SearchableInvestigation.Person.Provider(
                    857L, "type-two-value", "first-name-two-value", "last-name-two-value")));
