...
public class InvestigationSearchCriteriaSteps {
  ...
  public void i_want_to_find_investigations_created_by(final ActiveUser user) {
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.setCreatedBy(String.valueOf(user.id())));
  }
  ...
  public void i_want_to_find_investigations_created_on(final LocalDate on) {
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventDate(
                    eventDateSearch(
                        InvestigationFilter.EventDateType.INVESTIGATION_CREATE_DATE, on)));
  }
  ...
  public void i_want_to_find_investigations_updated_by(final ActiveUser user) {
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.setLastUpdatedBy(String.valueOf(user.id())));
  }
  ...
  public void i_want_to_find_investigations_updated_on(final LocalDate on) {
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventDate(
                    eventDateSearch(InvestigationFilter.EventDateType.LAST_UPDATE_DATE, on)));
  }
    ...
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventDate(
                    eventDateSearch(
                        InvestigationFilter.EventDateType.INVESTIGATION_START_DATE, on)));
  }
  ...
  public void i_want_to_find_investigations_reported_on(final LocalDate on) {
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventDate(
                    eventDateSearch(InvestigationFilter.EventDateType.DATE_OF_REPORT, on)));
  }
    ...
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventDate(
                    eventDateSearch(
                        InvestigationFilter.EventDateType.NOTIFICATION_CREATE_DATE, on)));
  }
  ...
  public void i_want_to_find_open_investigations() {
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setInvestigationStatus(InvestigationFilter.InvestigationStatus.OPEN));
  }
  ...
  public void i_want_to_find_closed_investigations() {
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setInvestigationStatus(InvestigationFilter.InvestigationStatus.CLOSED));
  }
    ...
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventDate(
                    eventDateSearch(
                        InvestigationFilter.EventDateType.INVESTIGATION_CLOSED_DATE, on)));
  }

  private InvestigationFilter.EventDate eventDateSearch(
      final InvestigationFilter.EventDateType type, final LocalDate from) {
    return new InvestigationFilter.EventDate(type, from.minusDays(5), from.plusDays(2));
  }
  ...
  public void i_want_to_find_investigations_with_a_processing_status_of(
    ...
    this.activeCriteria.maybeActive().ifPresent(criteria -> criteria.withProcessingStatus(status));
  }
  ...
  public void i_want_to_find_investigations_with_a_case_status_of(
      final InvestigationFilter.CaseStatus status) {
    this.activeCriteria.maybeActive().ifPresent(criteria -> criteria.withCaseStatus(status));
  }
  ...
  public void i_want_to_find_investigations_with_a_notification_status_of(
    ...
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.withNotificationStatus(status));
  }
  ...
  public void i_want_to_find_investigations_within_the_program_area(
      final ProgramAreaIdentifier programArea) {
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.withProgramArea(programArea.code()));
  }

  @Given("I want to find investigations within the {jurisdiction} Jurisdiction")
  public void i_want_to_find_investigations_within_the_jurisdiction(
      final JurisdictionIdentifier jurisdiction) {
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.withJurisdiction(Long.parseLong(jurisdiction.code())));
  }
  ...
  public void i_want_to_find_investigations_for_the_patient() {
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.setPatientId(this.activePatient.active().id()));
  }
  ...
  public void i_want_to_find_investigations_for_pregnant_patients() {
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.setPregnancyStatus(PregnancyStatus.YES));
  }
  ...
  public void i_want_to_find_investigations_for_patients_that_are_not_pregnant() {
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.setPregnancyStatus(PregnancyStatus.NO));
  }
  ...
  public void i_want_to_find_investigations_for_patients_that_do_not_know_if_they_are_pregnant() {
    this.activeCriteria
        .maybeActive()
        .ifPresent(criteria -> criteria.setPregnancyStatus(PregnancyStatus.UNKNOWN));
  }
  ...
  public void i_want_to_find_investigations_for_the_condition(final String condition) {
    this.activeCriteria.maybeActive().ifPresent(criteria -> criteria.withCondition(condition));
  }
    ...
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventId(
                    new InvestigationFilter.InvestigationEventId(
                        InvestigationFilter.IdType.STATE_CASE_ID, number)));
  }
    ...
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventId(
                    new InvestigationFilter.InvestigationEventId(
                        InvestigationFilter.IdType.CITY_COUNTY_CASE_ID, number)));
  }
    ...
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setEventId(
                    new InvestigationFilter.InvestigationEventId(
                        InvestigationFilter.IdType.ABCS_CASE_ID, number)));
  }
  ...
  public void i_want_to_find_investigations_reported_by_the_organization(
      final OrganizationIdentifier organization) {
    this.activeCriteria
        .maybeActive()
        .ifPresent(
            criteria ->
                criteria.setProviderFacilitySearch(
  ...
  public void i_want_to_find_investigations_reported_by_the_organization_using_the_new_api(
      final OrganizationIdentifier organization) {
    this.activeCriteria
        .maybeActive()
        .ifPresent(
  ...
  public void i_want_to_find_investigations_reported_by_the_provider_using_the_new_api() {
    this.activeCriteria
        ...
        .ifPresent(
            criteria ->
                criteria.setReportingProviderId(
                    String.valueOf(this.activeProvider.active().identifier())));
  }
  ...
  public void i_want_to_find_investigations_related_to_the_outbreak(final String outbreak) {
    this.activeCriteria.maybeActive().ifPresent(criteria -> criteria.withOutbreak(outbreak));
  }
}
