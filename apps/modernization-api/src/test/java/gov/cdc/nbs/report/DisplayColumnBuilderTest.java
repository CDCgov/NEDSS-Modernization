...
class DisplayColumnBuilderTest {
  ...
  void build_should_create_display_column_with_correct_properties() {
    ...
    DisplayColumn result = builder.build(mockReport, mockColumn);
  ...
  void build_should_generate_unique_id() {
    ...
    DisplayColumn result1 = builder.build(mockReport, mockColumn);
    DisplayColumn result2 = builder.build(mockReport, mockColumn);
  ...
  void build_should_preserve_report_reference() {
    ...
    DisplayColumn result = builder.build(differentReport, mockColumn);
  ...
  void build_should_preserve_data_source_column_reference() {
    ...
    DisplayColumn result = builder.build(mockReport, differentColumn);
  ...
  void build_should_use_nbs_entity_type_for_id_generation() {
    builder.build(mockReport, mockColumn);
  ...
  void build_should_set_status_time_using_provided_clock() {
    ...
    assertThat(result.getStatusTime()).isEqualToIgnoringNanos(currentTime);
  }
  ...
  void build_should_generate_different_ids_for_multiple_builds() {
    ...
    DisplayColumn result1 = builder.build(mockReport, mockColumn);
    DisplayColumn result2 = builder.build(mockReport, mockColumn);
    DisplayColumn result3 = builder.build(mockReport, mockColumn);
  ...
  void build_should_handle_different_reports_and_columns() {
    ...
    DisplayColumn result1 = builder.build(report1, column1);
    DisplayColumn result2 = builder.build(report2, column2);
  ...
  void build_should_have_consistent_time_with_clock() {
    ...
    assertThat(result.getStatusTime()).isAfterOrEqualTo(beforeBuild).isBeforeOrEqualTo(afterBuild);
  }
