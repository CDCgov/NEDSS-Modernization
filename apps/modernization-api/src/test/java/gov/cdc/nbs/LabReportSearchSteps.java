...
import gov.cdc.nbs.event.LabReportFilter.LabReportDateType;
import gov.cdc.nbs.event.LabReportFilter.LabReportEventId;
import gov.cdc.nbs.event.LabReportFilter.LabReportProviderSearch;
import gov.cdc.nbs.event.LabReportFilter.LaboratoryEventDateSearch;
import gov.cdc.nbs.event.LabReportFilter.LaboratoryEventIdType;
import gov.cdc.nbs.event.LabReportFilter.ProcessingStatus;
import gov.cdc.nbs.event.LabReportFilter.ProviderType;
import gov.cdc.nbs.event.LabReportFilter.UserType;
import gov.cdc.nbs.event.labreport.LabReportFinder;
