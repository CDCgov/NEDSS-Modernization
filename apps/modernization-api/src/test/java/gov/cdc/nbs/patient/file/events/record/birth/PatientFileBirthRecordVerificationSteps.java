...
public class PatientFileBirthRecordVerificationSteps {
  ...
  public PatientFileBirthRecordVerificationSteps(
      Active<BirthRecordIdentifier> activeRecord,
  ...
  public void bornAt(final String value) throws Exception {
    this.response
        .active()
        .andExpect(jsonPath("$.[?(@.local=='%s' && @.facility=='%s')]", local(), value).exists());
  }
  ...
  public void certificate(final String treatment) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.certificate=='%s')]", local, treatment).exists());
  }
  ...
  public void collectedOn(final LocalDate on) throws Exception {
    ...
    this.response
        .active()
        .andExpect(jsonPath("$.[?(@.local=='%s' && @.collectedOn=='%s')]", local, on).exists());
  }
  ...
  public void motherFirstName(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.name.first=='%s')]", local, value).exists());
  }
  ...
  public void motherMiddleName(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.name.middle=='%s')]", local, value).exists());
  }
  ...
  public void motherLastName(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.name.last=='%s')]", local, value).exists());
  }
  ...
  public void motherSuffix(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.name.suffix=='%s')]", local, value).exists());
  }
  ...
  public void motherAddress(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.address.address=='%s')]", local, value)
                .exists());
  }
  ...
  public void motherAddress2(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.address.address2=='%s')]", local, value)
                .exists());
  }
  ...
  public void motherCity(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.address.city=='%s')]", local, value).exists());
  }
  ...
  public void motherState(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.address.state=='%s')]", local, value)
                .exists());
  }
  ...
  public void motherCounty(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.address.county=='%s')]", local, value)
                .exists());
  }
  ...
  public void motherZipcode(final String value) throws Exception {
    ...
    this.response
        .active()
        .andExpect(
            jsonPath("$.[?(@.local=='%s' && @.mother.address.zipcode=='%s')]", local, value)
                .exists());
  }
