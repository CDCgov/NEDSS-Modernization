...
public class PatientFileNameDemographicVerificationSteps {
  ...
  public void containsPrefix(final LocalDate asOf, final String value) throws Exception {
    this.response
        .active()
        .andExpect(jsonPath("$.[?(@.asOf=='%s')].prefix.value", asOf).value(value));
  }
  ...
  public void containsFirst(final LocalDate asOf, final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.[?(@.asOf=='%s')].first", asOf).value(value));
  }
  ...
  public void containsMiddle(final LocalDate asOf, final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.[?(@.asOf=='%s')].middle", asOf).value(value));
  }

  @Given(
      "the patient file name demographics as of {localDate} contains the second middle name {string}")
  public void containsSecondMiddle(final LocalDate asOf, final String value) throws Exception {
    this.response
        .active()
        .andExpect(jsonPath("$.[?(@.asOf=='%s')].secondMiddle", asOf).value(value));
  }
  ...
  public void containsLast(final LocalDate asOf, final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.[?(@.asOf=='%s')].last", asOf).value(value));
  }

  @Given(
      "the patient file name demographics as of {localDate} contains the second last name {string}")
  public void containsSecondLast(final LocalDate asOf, final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.[?(@.asOf=='%s')].secondLast", asOf).value(value));
  }
  ...
  public void containsSuffix(final LocalDate asOf, final String value) throws Exception {
    this.response
        .active()
        .andExpect(jsonPath("$.[?(@.asOf=='%s')].suffix.value", asOf).value(value));
  }
  ...
  public void containsEducationLevel(final LocalDate asOf, final String value) throws Exception {
    this.response
        .active()
        .andExpect(jsonPath("$.[?(@.asOf=='%s')].degree.value", asOf).value(value));
  }
  ...
  public void nthFirstName(final int position, final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$[%s].first", position - 1).value(value));
  }

  @Then("the {nth} name has a(n) {string} of {string}")
  public void the_nth_name_has_a_x_of_y(final int position, final String field, final String value)
      throws Exception {
