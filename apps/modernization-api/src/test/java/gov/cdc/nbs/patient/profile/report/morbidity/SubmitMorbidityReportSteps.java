...
public class SubmitMorbidityReportSteps {
  ...
  public void i_am_redirected_to_classic_nbs_to_create_an_investigation_from_the_morbidity_report() throws Exception {
    this.response.active()
        .andExpect(status().isTemporaryRedirect())
        .andExpect(header().string("Location",
            containsString("/nbs/AddObservationMorb2.do?ContextAction=SubmitAndCreateInvestigation")));
