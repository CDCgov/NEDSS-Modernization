...
class SimplePatientSearchCriteriaResolverTest {
  ...
  void should_resolve_first_name_starting_with_value() {
    ...
    Optional<SimplePatientSearchCriteria> resolved =
        new SimplePatientSearchCriteriaResolver().resolve(parameters);
        ...
        .hasValueSatisfying(
            actual ->
                assertThat(actual)
                    ...
                    .satisfies(
                        value ->
                            assertThat(value.bornOn()).isEqualTo(DateCriteria.equals(1, 1, 1990))));
  }
