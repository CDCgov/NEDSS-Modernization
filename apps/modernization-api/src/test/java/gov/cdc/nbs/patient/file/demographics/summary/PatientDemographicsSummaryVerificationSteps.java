...
public class PatientDemographicsSummaryVerificationSteps {
  ...
  PatientDemographicsSummaryVerificationSteps(
  ...
  public void summary_have_an_address_use_of(final String value) throws Exception {
    this.results.active()
        .andExpect(jsonPath("$.address.use")
            .value(value)
        );
  }
  ...
  public void summary_have_an_address_street_address_of(final String value) throws Exception {
    this.results.active()
        .andExpect(jsonPath("$.address.address")
            .value(value)
        );
  }

  @Then("the demographics summary of the patient has an address with a street address 2 of {string}")
  public void summary_have_an_address_street_address2_of(final String value) throws Exception {
    this.results.active()
        .andExpect(jsonPath("$.address.address2")
            .value(value)
        );
  }
  ...
  public void summary_have_a_phone_number_of(final String value) throws Exception {
    this.results.active()
        .andExpect(jsonPath("$.phone.number")
            .value(value)
        );
  }
  ...
  public void summary_have_an_ethnicity_of(final String value) throws Exception {
    this.results.active()
        .andExpect(jsonPath("$.ethnicity", equalToIgnoringCase(value))
  ...
  public void summary_does_not_have_any_identifications() throws Exception {
    this.results.active()
        .andExpect(jsonPath("$.identifications")
            .isEmpty()
        );
  }

  @Then("the {nth} identification in the demographics summary of the patient is a(n) {string} of {string}")
  public void summary_have_an_nth_identification_of(final int nth, final String type, final String value)
      throws Exception {
    int position = nth - 1;
    this.results.active()
  ...
  public void summary_does_not_have_any_races() throws Exception {
    this.results.active()
        .andExpect(jsonPath("$.races")
            .isEmpty()
        );
  }

  @Then("the {nth} race in the demographics summary of the patient is {string}")
  public void summary_have_an_nth_race_of(final int nth, final String value)
      throws Exception {
    int position = nth - 1;
    this.results.active()
