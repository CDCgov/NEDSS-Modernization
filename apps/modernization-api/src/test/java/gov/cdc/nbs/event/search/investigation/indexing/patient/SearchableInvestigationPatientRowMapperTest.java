...
class SearchableInvestigationPatientRowMapperTest {
  ...
  void should_map_from_result_set() throws SQLException {
    SearchableInvestigationPatientRowMapper.Column columns =
        new SearchableInvestigationPatientRowMapper.Column(2, 3, 5, 7, 11, 13, 17, 19);
    ...
    SearchableInvestigationPatientRowMapper mapper =
        new SearchableInvestigationPatientRowMapper(columns);
