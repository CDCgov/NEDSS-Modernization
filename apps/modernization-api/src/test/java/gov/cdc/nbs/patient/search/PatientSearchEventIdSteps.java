...
public class PatientSearchEventIdSteps {
  ...
  public void i_would_like_to_search_for_a_patient_using_the_morbidity_report_ID() {
    this.activeMorbidityReport
        .maybeActive()
        .map(MorbidityReportIdentifier::local)
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withMorbidity(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_document_ID() {
    this.activeCaseReport
        .maybeActive()
        .map(CaseReportIdentifier::local)
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withDocument(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_state_case_ID() {
    this.activeStateCase
        .maybeActive()
        .map(StateCaseIdentifier::local)
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withStateCase(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_county_case_ID() {
    this.activeCityCountyCase
        .maybeActive()
        .map(CityCountyCaseIdentifier::local)
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withCityCountyCase(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_notification_ID() {
    this.activeNotification
        ...
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withNotification(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_treatment_ID() {
    this.activeTreatment
        ...
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withTreatment(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_vaccination_ID() {
    this.activeVaccination
        .maybeActive()
        .map(VaccinationIdentifier::local)
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withVaccination(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_investigation_ID() {
    this.activeInvestigation
        ...
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withInvestigation(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_lab_report_ID() {
    this.activeLabReport
        .maybeActive()
        .map(LabReportIdentifier::local)
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withLabReport(identifier)));
  }
  ...
  public void i_would_like_to_search_for_a_patient_using_the_accession_number() {
    this.activeAccessionNumber
        .maybeActive()
        .map(AccessionIdentifier::local)
        .ifPresent(
            identifier ->
                this.activeCriteria.active(criteria -> criteria.withAccessionNumber(identifier)));
  }
}
