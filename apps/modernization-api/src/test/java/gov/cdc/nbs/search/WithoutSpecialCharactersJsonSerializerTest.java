...
class WithoutSpecialCharactersJsonSerializerTest {
  ...
  @ParameterizedTest
  @MethodSource("values")
  void should_serialize_string_to_with_only_letters_and_digits(final String in, final String expected)
      throws IOException {
    ...
    new WithoutSpecialCharactersJsonSerializer().serialize(
        in,
        jsonGenerator,
        serializerProvider
    );
