...
public class WebInteractionSteps {
  ...
  public WebInteractionSteps(final Active<ResultActions> activeAction) {
  ...
  public void empty() throws Exception {
    this.activeAction.active().andExpect(jsonPath("$").doesNotExist());
  }

  @Then("no values are returned")
  public void emptyList() throws Exception {
    this.activeAction.active().andExpect(jsonPath("$").isEmpty());
  }
}
