...
public class PatientMergeHistorySteps {
  ...
  @Given(
      "patient {string} {string} with id {long} was merged into patient {string} {string} with id {long} by {user}")
  public void patient_was_merged_into_another(
      String supersededFirst,
      String supersededLast,
      long supersededId,
      String survivingFirst,
      String survivingLast,
      long survivingId,
      ActiveUser user) {
