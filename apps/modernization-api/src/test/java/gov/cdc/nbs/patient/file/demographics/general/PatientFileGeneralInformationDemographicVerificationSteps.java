...
public class PatientFileGeneralInformationDemographicVerificationSteps {
  ...
  public void asOf(final LocalDate value) throws Exception {
    this.response.active().andExpect(jsonPath("$.asOf", equalTo(value.toString())));
  }
  ...
  public void maritalStatus(final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.maritalStatus.value", equalTo(value)));
  }
  ...
  public void occupation(final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.primaryOccupation.value", equalTo(value)));
  }
  ...
  public void education(final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.educationLevel.value", equalTo(value)));
  }
  ...
  public void language(final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.primaryLanguage.value", equalTo(value)));
  }
  ...
  public void speaksEnglish(final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.speaksEnglish.value", equalTo(value)));
  }
  ...
  public void maidenName(final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.maternalMaidenName").value(equalTo(value)));
  }

  @Then("the patient file general information does not include a mother's maiden name of")
  public void noMaidenName() throws Exception {
    this.response.active().andExpect(jsonPath("$.maternalMaidenName").isEmpty());
  }

  @Then("the patient file general information includes {int} adults in the residence")
  public void adults(final int value) throws Exception {
    this.response.active().andExpect(jsonPath("$.adultsInResidence").value(equalTo(value)));
  }

  @Then("the patient file general information does not include adults in the residence")
  public void noAdults() throws Exception {
    this.response.active().andExpect(jsonPath("$.adultsInResidence").isEmpty());
  }

  @Then("the patient file general information includes {int} children in the residence")
  public void children(final int value) throws Exception {
    this.response.active().andExpect(jsonPath("$.childrenInResidence").value(equalTo(value)));
  }
  ...
  public void noChildren() throws Exception {
    this.response.active().andExpect(jsonPath("$.childrenInResidence").isEmpty());
  }
  ...
  public void stateHIVCase(final String value) throws Exception {
    this.response.active().andExpect(jsonPath("$.stateHIVCase.value").value(equalTo(value)));
  }

  @Then("the patient file general information does not include a state HIV case")
  public void noStateHIVCase() throws Exception {
    this.response.active().andExpect(jsonPath("$.stateHIVCase.value").isEmpty());
  }
