...
class PatientFileBirthRecordMergerTest {
  ...
  void should_return_the_current_mother_when_there_is_nothing_to_merge_with() {
    ...
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(null, null);

    PatientFileBirthRecord.MotherInformation actual =
        PatientFileBirthRecordMerger.merge(current, null);
  ...
  void should_return_the_next_mother_when_when_there_is_nothing_to_merge_with() {
    ...
    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(null, null);

    PatientFileBirthRecord.MotherInformation actual =
        PatientFileBirthRecordMerger.merge(current, next);
  ...
  void should_return_the_current_name_when_there_is_nothing_to_merge_with() {
    ...
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(name, null);
    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(null, null);
  ...
  void should_merge_name_using_the_first_name_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name("first-name-value", null, null, null),
            null);

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name(
                "next-first-name-value", null, null, null),
            null);
  ...
  void should_merge_name_using_the_first_name_from_next_when_not_present_in_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name(null, null, null, null), null);
  ...
  void should_merge_name_using_the_middle_name_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name(
                null, "middle-name-value", null, null),
            null);

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name(
                null, "next-middle-name-value", null, null),
            null);
  ...
  void should_merge_name_using_the_last_name_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name(null, null, "last-name-value", null),
            null);

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name(
                null, null, "next-last-name-value", null),
            null);
  ...
  void should_merge_name_using_the_suffix_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name(
                null, null, null, "suffix-name-value"),
            null);

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            new PatientFileBirthRecord.MotherInformation.Name(
                null, null, null, "next-suffix-name-value"),
            null);
  ...
  void should_return_the_current_address_when_there_is_nothing_to_merge_with() {
    ...
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(null, address);
    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(null, null);
    ...
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            ...
            new PatientFileBirthRecord.MotherInformation.Address(
                "street-address-value", null, null, null, null, null));

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                "next-street-address-value", null, null, null, null, null));
  ...
  void should_merge_address_using_the_street_address_from_next_when_not_present_in_current() {
    ...
    assertThat(actual.address())
        .returns(
            "next-street-address-value", PatientFileBirthRecord.MotherInformation.Address::address);
  }
  ...
  void should_merge_address_using_the_street_address_2_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, "street-address-2-value", null, null, null, null));

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, "next-street-address-2-value", null, null, null, null));
    ...
    assertThat(actual.address())
        .returns(
            "street-address-2-value", PatientFileBirthRecord.MotherInformation.Address::address2);
  }
  ...
  void should_merge_address_using_the_street_address_2_from_next_when_not_present_in_current() {
    ...
    assertThat(actual.address())
        .returns(
            ...
            PatientFileBirthRecord.MotherInformation.Address::address2);
  }
  ...
  void should_merge_address_using_the_city_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, null, "city-value", null, null, null));

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, null, "next-city-value", null, null, null));
  ...
  void should_merge_address_using_the_state_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, null, null, "state-value", null, null));

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, null, null, "next-state-value", null, null));
  ...
  void should_merge_address_using_the_county_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, null, null, null, "county-value", null));

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, null, null, null, "next-county-value", null));
  ...
  void should_merge_address_using_the_zipcode_from_current() {
    PatientFileBirthRecord.MotherInformation current =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, null, null, null, null, "zipcode-value"));

    PatientFileBirthRecord.MotherInformation next =
        new PatientFileBirthRecord.MotherInformation(
            null,
            new PatientFileBirthRecord.MotherInformation.Address(
                null, null, null, null, null, "next-zipcode-value"));
