...
public class PatientFileContactRecordVerificationSteps {
  ...
  public void found() throws Exception {
    this.response
        .active()
        .andExpect(jsonPath("$.[*].contacts[?(@.local=='%s')]", local()).exists());
  }
  ...
  public void named(final String first, final String last) throws Exception {
    this.response
        ...
        .andExpect(
            jsonPath(
                    "$.[*].contacts[?(@.local=='%s' && @.named.first=='%s' && @.named.last=='%s')]",
                    local(), first, last)
                .exists());
  }
  ...
  public void namedOn(final LocalDate on) throws Exception {
    this.response
        .active()
        .andExpect(
            jsonPath("$.[*].contacts[?(@.local=='%s' && @.namedOn=='%s')]", local(), on).exists());
  }
  ...
  public void priority(final String value) throws Exception {
    this.response
        .active()
        .andExpect(
            jsonPath("$.[*].contacts[?(@.local=='%s' && @.priority=='%s')]", local(), value)
                .exists());
  }
  ...
  public void disposition(final String value) throws Exception {
    this.response
        .active()
        .andExpect(
            jsonPath("$.[*].contacts[?(@.local=='%s' && @.disposition=='%s')]", local(), value)
                .exists());
  }
  ...
  public void referralBasis(final String value) throws Exception {
    this.response
        .active()
        .andExpect(
            jsonPath("$.[*].contacts[?(@.local=='%s' && @.referralBasis=='%s')]", local(), value)
                .exists());
  }
  ...
  public void processingDecision(final String value) throws Exception {
    this.response
        ...
        .andExpect(
            jsonPath(
                    "$.[*].contacts[?(@.local=='%s' && @.processingDecision=='%s')]",
                    local(), value)
                .exists());
  }
  ...
  public void associated() throws Exception {
    this.response
        ...
        .andExpect(
            jsonPath(
                    "$.[*].contacts[?(@.local=='%s' && @.associated.local=='%s')]",
