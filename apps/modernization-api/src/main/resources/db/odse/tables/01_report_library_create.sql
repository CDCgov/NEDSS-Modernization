...
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[Report_Library]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[Report_Library]
GO

CREATE TABLE [dbo].[Report_Library] (
        library_uid             bigint          NOT NULL,
        ...
        CONSTRAINT PK_Report_Library PRIMARY KEY CLUSTERED (library_uid)
	)
GO
