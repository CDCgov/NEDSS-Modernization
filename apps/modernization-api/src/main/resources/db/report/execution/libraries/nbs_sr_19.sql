...
DECLARE @sasLib VARCHAR(50) = 'NBSSR00019.SAS'
DECLARE @desc VARCHAR(300) = 'TB Record Count - Summary Report by Report Date.'
DECLARE @libraryParams VARCHAR(300) = '{"count_column": "DATE_REPORTED"}'
