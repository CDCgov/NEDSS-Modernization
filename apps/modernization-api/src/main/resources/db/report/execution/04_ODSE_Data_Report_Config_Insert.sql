...
FROM (
     ...
     'RDB',
     'RDB Database Name',
     'Database name or catalog alias for the reporting DB. Used for report execution.',
     'RDB',
     ...
     'Python strftime template used when serializing Date elements.',
     '%m/%d/%Y',
     ...
     'Python strftime template used when serializing Datetime elements.',
     '%m/%d/%Y %H:%M:%S',
     'Strftime Pattern String',
     'RPT',
     '7.0.13',
