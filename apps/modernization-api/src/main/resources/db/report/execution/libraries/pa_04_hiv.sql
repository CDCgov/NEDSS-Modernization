-- Migrate the PA04_HIV.SAS library to the pa_04 python library (hiv variant)

USE [NBS_ODSE]

DECLARE @pyLib VARCHAR(50) = 'pa_04'
DECLARE @sasLib VARCHAR(50) = 'PA04_HIV.SAS'
DECLARE @desc VARCHAR(300) = 'PA04: Program Indicator Report (HIV). Returns a long-form summary table of case, partner, and cluster follow-up indicator metrics.'
DECLARE @libraryParams VARCHAR(300) = '{"variant": "hiv"}'
