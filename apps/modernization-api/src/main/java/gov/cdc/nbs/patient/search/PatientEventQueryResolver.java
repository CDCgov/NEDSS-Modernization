...
class PatientEventQueryResolver {
  ...
  private Optional<QueryVariant> applyMorbidityCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(
                    match -> match.field(MORBIDITY_REPORTS).query(criteria.getMorbidity())));
  }
  ...
  private Optional<QueryVariant> applyDocumentCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(match -> match.field(DOCUMENTS).query(criteria.getDocument())));
  }
  ...
  private Optional<QueryVariant> applyStateCaseCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(match -> match.field(STATE_CASES).query(criteria.getStateCase())));
  }
  ...
  private Optional<QueryVariant> applyAbcCaseCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(match -> match.field(ABC_CASES).query(criteria.getAbcCase())));
  }
  ...
  private Optional<QueryVariant> applyCityCountyCaseCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(
                    match -> match.field(CITY_COUNTY_CASES).query(criteria.getCityCountyCase())));
  }
  ...
  private Optional<QueryVariant> applyNotificationCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(
                    match -> match.field(NOTIFICATIONS).query(criteria.getNotification())));
  }
  ...
  private Optional<QueryVariant> applyTreatmentCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(match -> match.field(TREATMENTS).query(criteria.getTreatment())));
  }
  ...
  private Optional<QueryVariant> applyVaccinationCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(match -> match.field(VACCINATIONS).query(criteria.getVaccination())));
  }
  ...
  private Optional<QueryVariant> applyInvestigationCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(
                    match -> match.field(INVESTIGATIONS).query(criteria.getInvestigation())));
  }
  ...
  private Optional<QueryVariant> applyLabCriteria(final PatientSearchCriteria criteria) {
    return criteria
        ...
        .map(
            identifier ->
                MatchQuery.of(match -> match.field(LAB_REPORTS).query(criteria.getLabReport())));
  }

  private Optional<QueryVariant> applyAccessionNumberCriteria(
      final PatientSearchCriteria criteria) {
    return criteria
        .maybeAccessionNumber()
