...
public record SearchableInvestigation(
    ...
    String classCode,
    @JsonProperty("mood_cd")
    String mood,
    @JsonProperty("prog_area_cd")
    String programArea,
    @JsonProperty("jurisdiction_cd")
    String jurisdiction,
    @JsonProperty("jurisdiction_code_desc_txt")
    String jurisdictionName,
    @JsonProperty("program_jurisdiction_oid")
    long oid,
    @JsonProperty("case_class_cd")
    String caseClass,
    @JsonProperty("case_type_cd")
    String caseType,
    @JsonProperty("outbreak_name")
    String outbreak,
    @JsonProperty("cd_desc_txt")
    String conditionName,
    @JsonProperty("condition")
    String condition,
    @JsonProperty("pregnant_ind_cd")
    ...
    @JsonDeserialize(using = LocalDateWithTimeJsonDeserializer.class)
    LocalDate closedOn,
    @JsonProperty("curr_process_state_cd")
    String processing,
    @JsonProperty("investigation_status_cd")
    String status,
    @JsonProperty("notification_local_id")
    String notification,
    @JsonProperty("notification_add_time")
    @JsonSerialize(using = LocalDateWithTimeJsonSerializer.class)
    @JsonDeserialize(using = LocalDateWithTimeJsonDeserializer.class)
    LocalDate notifiedOn,
    @JsonProperty("notification_record_status_cd")
    String notificationStatus,
    @JsonProperty("person_participations")
    List<Person> people,
    @JsonProperty("organization_participations")
    List<Organization> organizations,
    @JsonProperty("act_ids")
  ...
  public record Identifier(
      @JsonProperty("act_id_seq")
      int sequence,
      @JsonProperty("type_cd")
      String type,
      @JsonProperty("root_extension_txt")
      String value
  ) {
  }
}
