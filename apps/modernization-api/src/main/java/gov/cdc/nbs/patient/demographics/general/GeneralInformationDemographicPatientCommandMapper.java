...
public class GeneralInformationDemographicPatientCommandMapper {
  ...
  public static PatientCommand.ClearGeneralInformationDemographics
      asClearGeneralInformationDemographics(final long patient, final RequestContext context) {
  ...
  public static PatientCommand.AssociateStateHIVCase asAssociateStateHIVCase(
    ...
    return new PatientCommand.AssociateStateHIVCase(
        patient, demographic.stateHIVCase(), context.requestedBy(), context.requestedAt());
  }
