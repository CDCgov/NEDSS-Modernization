...
class PatientLabReportsFinder {
  ...
  private static final int PROVIDER_SUFFIX_COLUMN = 8;
  private static final int DATE_COLLECTED_COLUMN = 9;
  private static final int ASSOCIATED_WITH_ID_COLUMN = 10;
  private static final int ASSOCIATED_WITH_LOCAL_COLUMN = 11;
  private static final int ASSOCIATED_WITH_CONDITION_COLUMN = 12;
  private static final int ASSOCIATED_WITH_STATUS = 13;
  private static final int PROGRAM_AREA_COLUMN = 14;
  private static final int JURISDICTION_COLUMN = 15;
  private static final int EVENT_ID_COLUMN = 16;
  private static final int SPECIMEN_SITE_COLUMN = 17;
  private static final int SPECIMEN_SOURCE_COLUMN = 18;
