...
public class PatientService {
  ...
  public Page<Person> findPatientsByFilter(PatientFilter filter, GraphQLPage page) {
    ...
    if (filter.getPhoneNumber() != null) {
      String allDigitPhoneNumber = filter.getPhoneNumber().replaceAll("[^0-9]", "");
   ...
   * @return
   */
  private PatientUpdateResponse sendUpdatePatientEvent(Long id, PatientInput input,
      UpdateSexAndBirth inputSexAndBirth, UpdateMortality mortalityInput, String updateType) {
