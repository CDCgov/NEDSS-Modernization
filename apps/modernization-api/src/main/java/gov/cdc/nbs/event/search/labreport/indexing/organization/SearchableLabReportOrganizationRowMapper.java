...
class SearchableLabReportOrganizationRowMapper implements RowMapper<SearchableLabReport.Organization> {
  ...
  @Override
  public SearchableLabReport.Organization mapRow(
    ...
    return new SearchableLabReport.Organization(
        identifier,
        type,
        subjectType,
        name
