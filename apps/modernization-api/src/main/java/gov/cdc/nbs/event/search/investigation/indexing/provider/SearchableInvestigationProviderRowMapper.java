...
class SearchableInvestigationProviderRowMapper implements RowMapper<SearchableInvestigation.Person.Provider> {
  ...
  @Override
  public SearchableInvestigation.Person.Provider mapRow(
    ...
    return new SearchableInvestigation.Person.Provider(
        identifier,
        type,
        first,
        last
