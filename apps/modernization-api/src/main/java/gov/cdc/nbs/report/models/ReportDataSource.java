...
public record ReportDataSource(
  ...
  public ReportDataSource(DataSource entity) {
    this(
        ...
        entity.getJurisdictionSecurity() != null
            && "Y".equalsIgnoreCase(entity.getJurisdictionSecurity().toString()),
        entity.getReportingFacilitySecurity() != null
            && "Y".equalsIgnoreCase(entity.getReportingFacilitySecurity().toString()));
  }
}
