...
public class PatientCreateController {
  ...
  PatientCreateController(
      final Clock clock, final PatientCreationService service, final PatientIndexer indexer) {
    this.clock = clock;
  ...
  public CreatedPatient create(
      @AuthenticationPrincipal NbsUserDetails user, @RequestBody final NewPatient newPatient) {
