...
class PatientEthnicityDemographicMerger {
  ...
  static PatientEthnicityDemographic merge(
      final PatientEthnicityDemographic current, final PatientEthnicityDemographic next) {
    ...
    return new PatientEthnicityDemographic(
        current.asOf(), current.ethnicGroup(), current.unknownReason(), detailed);
  }
