...
public class PatientIdentifierGenerator {
  ...
  public PatientIdentifierGenerator(
      final IdGeneratorService generator, final PatientShortIdentifierResolver resolver) {
  ...
  /**
   * Calls the id generator service and constructs the localId with the format "prefix + id +
   * suffix"
   */
