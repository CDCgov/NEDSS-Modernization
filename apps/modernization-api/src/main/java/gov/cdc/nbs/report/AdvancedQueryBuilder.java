...
public class AdvancedQueryBuilder {
    ...
    public AdvancedQuery.RuleGroup build() {
        ...
        return new AdvancedQuery.RuleGroup(filterValue.getId().toString(), filterValue.getValueType(), buildRules(filterValues, 0));
    }

    private List<AdvancedQuery> buildRules(List<FilterValue> filterValues, int index) {
