...
class TestIntegrationTBSummaryCountDateLibrary:
    """Integration tests for the TB Summary Count Date library."""
        ...
        report_spec = ReportSpec.model_validate(
            {
                'is_export': True,
                'is_builtin': True,
                'report_title': 'TB Summary Count Date',
                'library_name': 'tb_summary_count_date',
