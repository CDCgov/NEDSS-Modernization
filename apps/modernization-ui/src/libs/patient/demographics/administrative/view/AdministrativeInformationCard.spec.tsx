...
describe('when displaying administrative comments for a patient', () => {
    it('should display title correctly', () => {
        ...
        render(<AdministrativeInformationCard data={data} collapsible={true} id="test" title="Administrative" />);
    ...
    it('should display the data correctly', () => {
        ...
        render(<AdministrativeInformationCard data={data} collapsible={true} id="test" title="test" />);
