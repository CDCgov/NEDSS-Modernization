...
module.exports.addPatientEmail = fs.readFileSync(path.join(__dirname, 'addPatientEmail.gql'), 'utf8');
...
module.exports.updateAdministrative = fs.readFileSync(path.join(__dirname, 'updateAdministrative.gql'), 'utf8');
module.exports.updatePatientAddress = fs.readFileSync(path.join(__dirname, 'updatePatientAddress.gql'), 'utf8');
module.exports.updatePatientEmail = fs.readFileSync(path.join(__dirname, 'updatePatientEmail.gql'), 'utf8');
