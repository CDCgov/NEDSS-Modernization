...
module.exports.findAllNaicsIndustryCodes = fs.readFileSync(path.join(__dirname, 'findAllNaicsIndustryCodes.gql'), 'utf8');
...
module.exports.findAllHighestLevelOfEducation = fs.readFileSync(path.join(__dirname, 'findAllHighestLevelOfEducation.gql'), 'utf8');
...
module.exports.findAllPrimaryLanguages = fs.readFileSync(path.join(__dirname, 'findAllPrimaryLanguages.gql'), 'utf8');
module.exports.findLoincLabTest = fs.readFileSync(path.join(__dirname, 'findLoincLabTest.gql'), 'utf8');
module.exports.findAllMaritalStatus = fs.readFileSync(path.join(__dirname, 'findAllMaritalStatus.gql'), 'utf8');
module.exports.findAllPrimaryOccupations = fs.readFileSync(path.join(__dirname, 'findAllPrimaryOccupations.gql'), 'utf8');
