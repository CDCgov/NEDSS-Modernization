...
const CodedResultsAutocomplete = ({ id, label, onChange, value, ...rest }: AutocompleteSingleProps) => {
    ...
    return <Autocomplete resolver={resolver} value={value} onChange={onChange} id={id} label={label} {...rest} />;
};
