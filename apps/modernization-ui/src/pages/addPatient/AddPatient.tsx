...
import NameFields, {
  InputNameFields,
} from "./components/nameFields/NameFields";
import AddressFields, {
  InputAddressFields,
} from "./components/addressFields/AddressFields";
...
import ContactFields, {
  InputContactFields,
} from "./components/contactFields/ContactFields";
import EthnicityFields, {
  InputEthnicityFields,
} from "./components/ethnicityFields/EthnicityFields";
...
export default function AddPatient() {
  const [nameFields, setNameFields]: [
    InputNameFields,
    (inputNameFields: InputNameFields) => void
  ] = useState({
    firstName: "",
    middleName: "",
    lastName: "",
  ...
  const [addressFields, setAddressFields]: [
    InputAddressFields,
    (inputNameFields: InputAddressFields) => void
  ] = useState({
    streetAddress1: "",
    streetAddress2: "",
    city: "",
  ...
  const [contactFields, setContactFields]: [
    InputContactFields,
    (inputContactFields: InputContactFields) => void
  ] = useState({
    homePhone: "",
    workPhone: "",
    workPhoneExt: "",
  ...
  const [asOfDate, setAsOfDate]: [string, (asOfDate: string) => void] =
  ...
  window.addEventListener("load", () => {
    ...
    const scrollHandler: any = (entries: any) => {
      return entries.forEach((entry: any) => {
        ...
        const sectionLink: any = document.querySelector(
          `a[href="#${sectionId}"]`
        );
