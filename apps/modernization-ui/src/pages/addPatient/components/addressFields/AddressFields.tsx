...
export default function AddressFields({
  ...
  function updateTractValidity() {
    setIsTractValid(
      (document.getElementById("census-tract") as HTMLInputElement).validity
        .valid
    );
  }
  return (
        ...
        <Grid row gap={2}>
          <Grid col={4}>
            ...
            <Dropdown
              ...
              onChange={(v) =>
                updateCallback({ ...addressFields, state: v.target.value })
              }
            >
          ...
          <Grid col={2}>
            ...
            <TextInput
              ...
              onChange={(v) =>
                updateCallback({ ...addressFields, zip: v.target.value })
              }
            />
          </Grid>
        </Grid>
        <Grid row>
          <Grid col={6}>
            ...
            <Dropdown
              ...
              onChange={(v) =>
                updateCallback({ ...addressFields, county: v.target.value })
              }
            >
              <option value=""></option>
        ...
        <Grid row>
          <Grid col={6}>
            <FormGroup error={!isTractValid}>
              ...
              {!isTractValid ? (
                <ErrorMessage>
                  Census Tract should be in numeric XXXX or XXXX.xx format where
                  XXXX is the basic tract and xx is the suffix. XXXX ranges from
                  0001 to 9999. The suffix is limited to a range between .01 and
                  .98.
                </ErrorMessage>
              ) : (
                ""
        ...
        <Grid row>
          <Grid col={6}>
            ...
            <Dropdown
              ...
              onChange={(v) =>
                updateCallback({ ...addressFields, country: v.target.value })
              }
            >
              <option value=""></option>
