...
type AddAdultCaseReportCodedValues = {
    raceCategories: CodedValue[];
    ethnicGroups: CodedValue[];
    identificationTypes: CodedValue[];
    assigningAuthorities: CodedValue[];
...
const useAddAdultCaseReportCodedValues = () => {
    const [coded, setCoded] = useState<AddAdultCaseReportCodedValues>(initialCoded);
...
export { useAddAdultCaseReportCodedValues };
export type { AddAdultCaseReportCodedValues };
