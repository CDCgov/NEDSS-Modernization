...
export const MatchingCriteriaFieldSelection = ({ activePass, dataElementConfiguration, onAccept, onCancel }: Props) => {
    const [selectedFields, setSelectedFields] = useState<MatchingField[]>([]);
    const form = useFormContext<MatchingConfiguration>();

    // TODO filter options based on cnofig
