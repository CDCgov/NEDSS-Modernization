    ...
    return (
        <aside className={styles.helpText}>
            ...
            <div>
                ...
                <p>
                    The belongingness ratio of a new record to an existing cluster of data is the percentage of records
                    already belonging to that cluster that the new record is a match with.
                </p>
                <br />
