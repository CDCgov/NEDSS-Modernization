            ...
            <div className={styles.formContent}>
                ...
                <AddressRepeatingBlock
                    ...
                    onChange={(addressData) => {
                        setValue('addresses', addressData);
                    }}
                    errors={[]}
                />
                <PhoneAndEmailRepeatingBlock
                    ...
                    onChange={(phoneEmailData) => {
                        setValue('phoneEmails', phoneEmailData);
                    }}
                    errors={[]}
                />
                <IdentificationRepeatingBlock
                    ...
                    onChange={(identificationData) => {
                        setValue('identifications', identificationData);
                    }}
                    errors={[]}
                />
                <RaceRepeatingBlock
