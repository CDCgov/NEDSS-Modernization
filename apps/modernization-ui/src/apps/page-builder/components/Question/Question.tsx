...
// import DeleteValueset from '../DeleteValueset/DeleteValueset';
...
export const QuestionWrap = ({ que }: any) => {
    ...
    const renderAddValueSetModal = (
        <>
            <ModalToggleButton className="submit-btn display-none" modalRef={addValueModalRef}>
                Add Value set
            </ModalToggleButton>
        </>
    );
                ...
                <div className="que-list">
                    ...
                    {que?.valueSet && (
                        <div className="display-flex gap-10">
                            <ModalToggleButton modalRef={addValueModalRef} className="line-btn" type="submit" unstyled>
                                <Icon.Edit className="margin-right-2px" />
                                <span> Edit Valueset</span>
                            </ModalToggleButton>
                            {/* <DeleteValueset codeSetNm={que?.valueSet} /> */}
                        </div>
                    )}
                    {isLogicForm && (
                    ...
                    {!que?.valueSet && renderAddValueSetModal}
                    <ModalComponent
                        isLarge
                        modalRef={addValueModalRef}
                        modalHeading={'Search value set'}
                        modalBody={<ValuesetLibrary hideTabs modalRef={addValueModalRef} />}
                    />
                </div>
            </div>
        </div>
