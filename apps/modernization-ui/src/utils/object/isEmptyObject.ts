...
const isEmptyObject = (value: unknown): boolean => {
    // Checks if the value is an object (using typeof), is not null (since the javascript typeof null is 'object'),
    // array is not an and has no own enumerable properties
