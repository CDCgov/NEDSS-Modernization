...
/**
 * QPublicHealthCaseHist is a Querydsl query type for PublicHealthCaseHist
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QPublicHealthCaseHist extends EntityPathBase<PublicHealthCaseHist> {

    private static final long serialVersionUID = 1863315630L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPublicHealthCaseHist publicHealthCaseHist = new QPublicHealthCaseHist("publicHealthCaseHist");
    ...
    public final QPublicHealthCaseHistId id;
    ...
    public QPublicHealthCaseHist(String variable) {
        this(PublicHealthCaseHist.class, forVariable(variable), INITS);
    }

    public QPublicHealthCaseHist(Path<? extends PublicHealthCaseHist> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QPublicHealthCaseHist(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QPublicHealthCaseHist(PathMetadata metadata, PathInits inits) {
        this(PublicHealthCaseHist.class, metadata, inits);
    }

    public QPublicHealthCaseHist(Class<? extends PublicHealthCaseHist> type, PathMetadata metadata, PathInits inits) {
        super(type, metadata, inits);
        this.id = inits.isInitialized("id") ? new QPublicHealthCaseHistId(forProperty("id")) : null;
