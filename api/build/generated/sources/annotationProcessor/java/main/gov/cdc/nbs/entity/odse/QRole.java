...
public class QRole extends EntityPathBase<Role> {
    ...
    private static final long serialVersionUID = -99898515L;
    ...
    public final QNBSEntity subjectEntityUid;
    ...
    public QRole(Class<? extends Role> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new QRoleId(forProperty("id")) : null;
        this.subjectEntityUid = inits.isInitialized("subjectEntityUid") ? new QNBSEntity(forProperty("subjectEntityUid")) : null;
    }
