...
public class QObservation extends EntityPathBase<Observation> {
    ...
    private static final long serialVersionUID = -1672234667L;
    ...
    public final ListPath<ObsValueCoded, QObsValueCoded> obsValueCodedList = this.<ObsValueCoded, QObsValueCoded>createList("obsValueCodedList", ObsValueCoded.class, QObsValueCoded.class, PathInits.DIRECT2);
    ...
    public final QPerson subjectPersonUid;
    ...
    public QObservation(Class<? extends Observation> type, PathMetadata metadata, PathInits inits) {
        ...
        this.subjectPersonUid = inits.isInitialized("subjectPersonUid") ? new QPerson(forProperty("subjectPersonUid"), inits.get("subjectPersonUid")) : null;
    }
