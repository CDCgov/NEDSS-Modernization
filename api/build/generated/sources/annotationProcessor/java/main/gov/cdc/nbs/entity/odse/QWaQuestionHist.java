...
/**
 * QWaQuestionHist is a Querydsl query type for WaQuestionHist
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QWaQuestionHist extends EntityPathBase<WaQuestionHist> {

    private static final long serialVersionUID = -1315712439L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QWaQuestionHist waQuestionHist = new QWaQuestionHist("waQuestionHist");
    ...
    public final QWaQuestion waQuestionUid;

    public QWaQuestionHist(String variable) {
        this(WaQuestionHist.class, forVariable(variable), INITS);
    }

    public QWaQuestionHist(Path<? extends WaQuestionHist> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QWaQuestionHist(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QWaQuestionHist(PathMetadata metadata, PathInits inits) {
        this(WaQuestionHist.class, metadata, inits);
    }

    public QWaQuestionHist(Class<? extends WaQuestionHist> type, PathMetadata metadata, PathInits inits) {
        super(type, metadata, inits);
        this.waQuestionUid = inits.isInitialized("waQuestionUid") ? new QWaQuestion(forProperty("waQuestionUid")) : null;
    }
