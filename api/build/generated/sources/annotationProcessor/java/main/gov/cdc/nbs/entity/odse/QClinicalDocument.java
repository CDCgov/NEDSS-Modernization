...
/**
 * QClinicalDocument is a Querydsl query type for ClinicalDocument
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QClinicalDocument extends EntityPathBase<ClinicalDocument> {

    private static final long serialVersionUID = -590845499L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QClinicalDocument clinicalDocument = new QClinicalDocument("clinicalDocument");
    ...
    public QClinicalDocument(String variable) {
        this(ClinicalDocument.class, forVariable(variable), INITS);
    }

    public QClinicalDocument(Path<? extends ClinicalDocument> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QClinicalDocument(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QClinicalDocument(PathMetadata metadata, PathInits inits) {
        this(ClinicalDocument.class, metadata, inits);
    }

    public QClinicalDocument(Class<? extends ClinicalDocument> type, PathMetadata metadata, PathInits inits) {
