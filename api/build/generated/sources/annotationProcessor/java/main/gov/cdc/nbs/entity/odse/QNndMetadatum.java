...
/**
 * QNndMetadatum is a Querydsl query type for NndMetadatum
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QNndMetadatum extends EntityPathBase<NndMetadatum> {

    private static final long serialVersionUID = -112107715L;

    public static final QNndMetadatum nndMetadatum = new QNndMetadatum("nndMetadatum");
    ...
    public QNndMetadatum(String variable) {
        super(NndMetadatum.class, forVariable(variable));
    }

    public QNndMetadatum(Path<? extends NndMetadatum> path) {
        super(path.getType(), path.getMetadata());
    }

    public QNndMetadatum(PathMetadata metadata) {
        super(NndMetadatum.class, metadata);
    }
