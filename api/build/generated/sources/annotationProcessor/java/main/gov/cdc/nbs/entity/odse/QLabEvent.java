...
/**
 * QLabEvent is a Querydsl query type for LabEvent
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QLabEvent extends EntityPathBase<LabEvent> {

    private static final long serialVersionUID = 96708740L;

    public static final QLabEvent labEvent = new QLabEvent("labEvent");
    ...
    public QLabEvent(String variable) {
        super(LabEvent.class, forVariable(variable));
    }

    public QLabEvent(Path<? extends LabEvent> path) {
        super(path.getType(), path.getMetadata());
    }

    public QLabEvent(PathMetadata metadata) {
        super(LabEvent.class, metadata);
    }
