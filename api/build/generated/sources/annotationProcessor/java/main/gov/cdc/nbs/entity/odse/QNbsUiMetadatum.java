...
/**
 * QNbsUiMetadatum is a Querydsl query type for NbsUiMetadatum
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QNbsUiMetadatum extends EntityPathBase<NbsUiMetadatum> {

    private static final long serialVersionUID = -23635762L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QNbsUiMetadatum nbsUiMetadatum = new QNbsUiMetadatum("nbsUiMetadatum");
    ...
    public final QNbsUiComponent nbsUiComponentUid;
    ...
    public QNbsUiMetadatum(String variable) {
        this(NbsUiMetadatum.class, forVariable(variable), INITS);
    }

    public QNbsUiMetadatum(Path<? extends NbsUiMetadatum> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QNbsUiMetadatum(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QNbsUiMetadatum(PathMetadata metadata, PathInits inits) {
        this(NbsUiMetadatum.class, metadata, inits);
    }

    public QNbsUiMetadatum(Class<? extends NbsUiMetadatum> type, PathMetadata metadata, PathInits inits) {
        ...
        this.nbsUiComponentUid = inits.isInitialized("nbsUiComponentUid") ? new QNbsUiComponent(forProperty("nbsUiComponentUid")) : null;
    }
