...
@Setter
@Entity
@Table(name = "Geocoding_Result_Hist")
public class GeocodingResultHist {
    @EmbeddedId
    private GeocodingResultHistId id;

    @MapsId("geocodingResultUid")
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "geocoding_result_uid", nullable = false)
    private GeocodingResult geocodingResultUid;
