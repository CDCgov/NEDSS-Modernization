...
class AuthPermSetTest {
    ...
    void should_add_objectRight() {
        ...
        AuthBusObjRt objectRight = permissionSet.addObjectRight(
            operationType,
            objectType
        );
        ...
        assertThat(objectRight)
            .satisfies(
                actual -> assertThat(actual.permissionSet()).isSameAs(permissionSet)
            )
            .satisfies(
                actual -> assertThat(actual.objectType()).isSameAs(objectType)
            );
    ...
    void should_add_a_second_objectRight() {
        ...
        AuthBusObjRt initial = permissionSet.addObjectRight(
            new AuthBusOpType(),
            new AuthBusObjType()
        );
