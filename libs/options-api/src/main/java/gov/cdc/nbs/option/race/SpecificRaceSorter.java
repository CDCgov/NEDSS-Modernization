...
class SpecificRaceSorter {
  ...
  private static final List<String> ORDERING =
      List.of(
          "1002-5", "2028-9", "2054-5", "2076-8", "2106-3", "2131-1", "M", "PHC1175", "NASK", "U");

  private static final Comparator<Option> SPECIFIC =
      Ordering.explicit(ORDERING).onResultOf(Option::value);
   ...
   *   <li>Native Hawaiian or Other Pacific Islander
   *   <li>White
   *   <li>Other
   *   <li>Multi-Race
   *   <li>Refused to answer
   *   <li>Not Asked
   *   <li>Unknown
   * </ul>
   *
