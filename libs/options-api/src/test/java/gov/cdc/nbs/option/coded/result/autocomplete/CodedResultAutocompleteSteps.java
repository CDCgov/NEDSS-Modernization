...
public class CodedResultAutocompleteSteps {
  ...
  CodedResultAutocompleteSteps(
      final CodedResultAutocompleteRequester request, final Active<ResultActions> response) {
    this.request = request;
    this.response = response;
  }

  @When("I am trying to find coded results that start with {string}")
  public void i_am_trying_to_find_coded_results_that_start_with(final String criteria)
      throws Exception {
