...
public class CountyAutocompleteSteps {
  ...
  @When("I am trying to find counties that start with {string} for state {string}")
  ...
  @When("I am trying to find at most {int} counties that start with {string} for state {string}")
