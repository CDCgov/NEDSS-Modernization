...
@Setter
@Embeddable
public class PersonEthnicGroupHistId implements Serializable {
    private static final long serialVersionUID = -2521045286658796948L;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || Hibernate.getClass(this) != Hibernate.getClass(o))
            return false;
        PersonEthnicGroupHistId entity = (PersonEthnicGroupHistId) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(personUid, ethnicGroupCd, versionCtrlNbr);
    }
