...
@Setter
@Entity
@Table(name = "Patient_encounter_hist")
public class PatientEncounterHist {
    @EmbeddedId
    private PatientEncounterHistId id;

    @MapsId("patientEncounterUid")
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "patient_encounter_uid", nullable = false)
    private PatientEncounter patientEncounterUid;
    ...
    @Column(name = "acuity_level_cd", length = 20)
    private String acuityLevelCd;

    @Column(name = "acuity_level_desc_txt", length = 100)
    ...
    @Column(name = "admission_source_cd", length = 20)
    private String admissionSourceCd;

    @Column(name = "admission_source_desc_txt", length = 100)
    private String admissionSourceDescTxt;

    @Column(name = "birth_encounter_ind")
    private Character birthEncounterInd;
    ...
    @Column(name = "referral_source_cd", length = 20)
    private String referralSourceCd;

    @Column(name = "referral_source_desc_txt", length = 100)
