...
class NBSEntityTest {
  ...
  @Test
  void should_update_patient_mortality_location() {
  ...
  @Test
  void should_update_patient_mortality_location_when_only_city_present() {
  ...
  @Test
  void should_update_patient_mortality_location_when_only_county_present() {
  ...
  @Test
  void should_update_patient_mortality_location_when_only_state_present() {
  ...
  @Test
  void should_update_patient_mortality_location_when_only_country_present() {
  ...
  @Test
  void should_inactive_patient_mortality_when_location_not_present() {
  ...
  @Test
  void should_inactive_patient_mortality_when_not_deceased() {
