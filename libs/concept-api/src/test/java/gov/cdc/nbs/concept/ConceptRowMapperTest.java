...
class ConceptRowMapperTest {

  @Test
  void should_map_concept_from_row() throws SQLException {

    ConceptRowMapper.Column columns = new ConceptRowMapper.Column(3, 5, 7);
    ...
    ConceptRowMapper mapper = new ConceptRowMapper(columns);

    Concept actual = mapper.mapRow(resultSet, 0);
