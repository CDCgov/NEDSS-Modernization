...
/**
 * Defines the data that a user is able to act upon using hashes that represent access to a
 * program-area within a jurisdiction. The hashes are split into two areas;
 *
 * <ul>
 *   <li>{@code any} - Has access to any data within the program-area / jurisdiction
 *   <li>{@code shared} - Has access to only shared data within the program-area / jurisdiction
 * </ul>
 *
