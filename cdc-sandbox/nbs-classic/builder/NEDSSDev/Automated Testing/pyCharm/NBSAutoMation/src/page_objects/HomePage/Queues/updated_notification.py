...
class UpdatedNotification(BasePageObject):
    ...
    UPDATED_NOTIFICATION_QUEUE_XPATH = '//*[@id="myQueues"]/div/div[3]/ul[1]/li[3]/a'

    # Sort/filter Results Grid
    column1_name = "Update Date"
    column2_name = "Updated By"
    ...
    def validateSortingOnResultsGrid(self):
        ...
        time.sleep(3)
        self.sortResultsGridColumnsOneByOneUsingActions(grid_columns, "Asc")
    ...
    def getSearchText(self, key):
        search_text = None
        if key == "Condition":
            search_text = (self.findElement(NBSConstants.TYPE_CODE_XPATH, '//*[@id="parent"]/tbody/tr[1]/td[8]/a')
                           .get_attribute('text'))
    ...
    def getRandomlySelectCheckBoxOptions(check_boxes_size):
        UpdatedNotification.logger.info(check_boxes_size)
        list_random_cb = None
        if check_boxes_size is not None and int(check_boxes_size) > 1:
            ...
            list_random_cb = [1]
        UpdatedNotification.logger.info(list_random_cb)
        return list_random_cb

    def validateRemoveallNotificationSelected(self, ):
        self.performButtonClick(NBSConstants.TYPE_CODE_XPATH, '//*[@id="parent"]/tbody/tr[1]/td[1]/div/input')
        self.setWaitTimeAfterEachAction(NBSConstants.ENABLE_WAITING_TIME,
                                        NBSConstants.WAITING_TIME_IN_SECONDS)
        self.performButtonClick(NBSConstants.TYPE_CODE_XPATH, '//*[@id="removeFilters"]/table/tbody/tr/td[1]/a')

    def validateRemoveThisNotificationIconSelected(self, ):
        self.performButtonClick(NBSConstants.TYPE_CODE_XPATH, '//*[@id="parent"]/tbody/tr[1]/td[2]/div/a')
        self.setWaitTimeAfterEachAction(NBSConstants.ENABLE_WAITING_TIME,
                                        NBSConstants.WAITING_TIME_IN_SECONDS)
