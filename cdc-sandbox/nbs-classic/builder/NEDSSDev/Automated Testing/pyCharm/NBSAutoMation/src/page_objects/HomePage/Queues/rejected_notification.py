...
class RejectedNotification(BasePageObject):
    ...
    REJECTED_NOTIFICATION_QUEUE = "//*[@id='myQueues']/div/div[3]/ul[1]/li[4]/a"
    RETURN_HOME_XPATH='//*[@id="bd"]/table[1]/tbody/tr/td[1]/table/tbody/tr/td[1]/a'
    ...
    column7_name = "Status"
    column8_name = "Rejected By"
    column9_name = "Comments"
    ...
    column7_xpath = "//*[@id='parent']/thead/tr/th[7]/img"
    column8_xpath = "//*[@id='parent']/thead/tr/th[8]/img"
    column9_xpath = "//*[@id='parent']/thead/tr/th[9]/img"
    ...
    column8_filter_type = "checkbox"
    column9_filter_type = "textfield"
    ...
    def validateSortingOnResultsGrid(self):
        ...
        grid_columns = {
            ...
            self.column9_name: [self.column9_default_sort, self.column9_xpath]}
    ...
    def validateFilterOnResultsGrid(self):
        ...
        filter_columns = {
            ...
            self.column8_name: [self.column8_filter_type, self.column8_xpath, self.column8_header_index, 0],
            self.column9_name: [self.column9_filter_type, self.column9_xpath, self.column9_header_index, 2]}
    ...
    def getSearchText(self, key):
        ...
        if key == "Patient":
            ...
            search_text = (
                self.findElement(NBSConstants.TYPE_CODE_XPATH, '// *[ @ id = "parent"] / tbody / tr[1] / td[5] / a')
                .get_attribute('text'))
        elif key == "Comments":
            search_text = self.findElement(NBSConstants.TYPE_CODE_XPATH, "//*[@id='parent']/tbody/tr[1]/td[9]").text
    ...
    def getRandomlySelectCheckBoxOptions(check_boxes_size):
        RejectedNotification.logger.info(check_boxes_size)
        list_random_cb = None
        if check_boxes_size is not None and int(check_boxes_size) > 1:
            ...
            list_random_cb = [1]
        RejectedNotification.logger.info(list_random_cb)
