...
# driver_chrome.get('http://35.175.68.52:7001/nbs/login')
...
click_interview_link = driver.find_element_by_xpath(".//*[@id='interviewListID']/tbody/tr/td[1]/a")
click_interview_link.click()
...
click_edit = driver.find_element_by_name('Edit')
click_edit.click()

enter_notes_IXS111 = driver.find_element_by_id("IXS111")

many_notes = "n on produce colonel pointed. " \
             "Just four sold need over how any. In to september suspicion determine he prevailed admitting. " \
             "On adapted an as affixed limited on. Giving cousin warmly things no spring mr be abroad. Relation breeding be " \
...
for i in range(0,100):
    # enter_notes_IXS111.send_keys("Note " + str(i))
    enter_notes_IXS111.send_keys(many_notes)
    print("Note " + str(i))
    add_note = driver.find_element_by_xpath(".//*[@id='AddButtonToggleGA25100']/td/input")
    time.sleep(1)
    add_note.click()
