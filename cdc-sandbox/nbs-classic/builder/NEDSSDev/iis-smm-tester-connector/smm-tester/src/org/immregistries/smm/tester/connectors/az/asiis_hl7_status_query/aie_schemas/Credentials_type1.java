...
public class Credentials_type1 implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = Credentials_type1 Namespace
   * URI = http://AIE_Schemas.ASIIS_HL7_Status_Query Namespace Prefix = ns3
   */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
            namespacePrefix + ":Credentials_type1", xmlWriter);
      } else {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
            "Credentials_type1", xmlWriter);
      }
  ...
  public static class Factory {
     ...
     */
    public static Credentials_type1 parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      Credentials_type1 object = new Credentials_type1();
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"Credentials_type1".equals(type)) {
              ...
              return (Credentials_type1) org.immregistries.smm.tester.connectors.az.gov.azdhs.www.ExtensionMapper
