...
public class Sync_Submit implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("http://www.azdhs.gov", "Sync_Submit", "ns5");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
            namespacePrefix + ":Sync_Submit", xmlWriter);
      } else {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Sync_Submit",
            xmlWriter);
      }
  ...
  public static class Factory {
     ...
     */
    public static Sync_Submit parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      Sync_Submit object = new Sync_Submit();
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"Sync_Submit".equals(type)) {
              ...
              return (Sync_Submit) org.immregistries.smm.tester.connectors.az.gov.azdhs.www.ExtensionMapper
