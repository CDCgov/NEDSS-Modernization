...
public class Response_type0 implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = Response_type0 Namespace URI =
  ...
  protected void validateMessage(
      org.immregistries.smm.tester.connectors.az.asiis_hl7_status_query_response.aie_schemas.Message_type1[] param) {
  ...
  public void addMessage(
    ...
    if (localMessage == null) {
      localMessage =
          new org.immregistries.smm.tester.connectors.az.asiis_hl7_status_query_response.aie_schemas.Message_type1[] {};
    }
    ...
    list.add(param);
    this.localMessage =
        (org.immregistries.smm.tester.connectors.az.asiis_hl7_status_query_response.aie_schemas.Message_type1[]) list
            .toArray(
                new org.immregistries.smm.tester.connectors.az.asiis_hl7_status_query_response.aie_schemas.Message_type1[list
                    .size()]);
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
            namespacePrefix + ":Response_type0", xmlWriter);
      } else {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Response_type0",
            xmlWriter);
      }
  ...
  public static class Factory {
     ...
     */
    public static Response_type0 parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      Response_type0 object = new Response_type0();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"Response_type0".equals(type)) {
              ...
              return (Response_type0) org.immregistries.smm.tester.connectors.az.gov.azdhs.www.ExtensionMapper
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.immregistries.smm.tester.connectors.az.asiis_hl7_status_query_response.aie_schemas.Message_type1.Factory
                  .parse(reader));
          ...
          object.setMessage(
              (org.immregistries.smm.tester.connectors.az.asiis_hl7_status_query_response.aie_schemas.Message_type1[]) org.apache.axis2.databinding.utils.ConverterUtil
                  .convertToArray(
