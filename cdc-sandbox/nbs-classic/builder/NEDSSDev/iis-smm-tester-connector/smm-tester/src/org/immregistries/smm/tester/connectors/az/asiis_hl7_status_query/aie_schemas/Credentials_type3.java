...
public class Credentials_type3 implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = Credentials_type3 Namespace
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
            namespacePrefix + ":Credentials_type3", xmlWriter);
      } else {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
            "Credentials_type3", xmlWriter);
      }
  ...
  public static class Factory {
     ...
     */
    public static Credentials_type3 parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      Credentials_type3 object = new Credentials_type3();
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"Credentials_type3".equals(type)) {
              ...
              return (Credentials_type3) org.immregistries.smm.tester.connectors.az.gov.azdhs.www.ExtensionMapper
