/**
 * Data Object for USER_PROFILE table
 */
package gov.cdc.nedss.systemservice.ejb.nbssecurityejb.dt;

import gov.cdc.nedss.systemservice.util.RootDTInterface;
import java.sql.Timestamp;

public class UserProfileDT implements RootDTInterface {

  private String firstName;
  private String lastName;
  private String nedssEntryId;
  ...
  public void setSharedInd(String aSharedInd) {
	...
	public void setNedssEntryId(String string) {
		nedssEntryId = string;
	}
}