...
<tr>
	<td>
				<nedss:container id="section1" name="ImportExport" classType="sect" displayImg="false" defaultDisplay="collapse">
	               <nedss:container id="subSec1" name="Manage Systems" classType="subSect" defaultDisplay="collapse">
					<tr>
						<td style="padding-left:20px;">
							<table role="presentation" class="srtmanage">
								<tr><td  valign="top"><td align="left" valign="top" nowrap>
								<a href="/nbs//ReceivingSystem.do?method=manageLoad&initLoad=true">Manage Sending and Receiving Systems</a></td></tr>
