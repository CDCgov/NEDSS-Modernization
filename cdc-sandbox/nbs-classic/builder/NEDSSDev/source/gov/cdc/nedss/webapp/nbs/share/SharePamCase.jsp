...
<html lang="en">
	...
	function tOwnership() {
		...
		if( recipient != null && recipient == 0) {
			...
			getElementByIdOrByName("shareRecipient").style.color="#CC0000";
			isError = true;		
		}
		else {
		...
		if( comment != null && comment== 0) {
			...
			getElementByIdOrByName("shareComments").style.color="#CC0000";
			isError = true;		
		}
		else {
              ...
              <tr style="background:#FFF;">
                  <td colspan="2">
		           ...
		           <tr id="exportList">
		               ...
		               <td class="InputField">
			               	<html:select title="Recipient" property="pamClientVO.oldPamProxyVO.notificationVO_s.theNotificationDT.exportReceivingFacilityUid"  styleId ="recipient">
		               ...
		               <td>
				 	<textarea title="Share Comments" rows="6" cols="60" id="NTF137" onkeydown="checkMaxLength(this)" onkeyup="checkMaxLength(this)"></textarea>
				 </td>
		          </tr>
     		          <tr>
