...
<html:form styleId="addNotesForm" action="/AddNotes.do?method=saveForm" method="post">
    <table role="presentation" role="presentation" class="formTable" style="width:100%; height:100%; margin:0px;">
        <tr>
            <td colspan="2">
        ...
        <!-- Notes -->
        <tr>
            <td class="fieldName" id="notesLabel"> <span style="color:#CC0000; font-weight:bold;">*</span> Notes:</td>
            <td><html:textarea rows="5" cols="40" name="addNotesForm" property="notes"> </html:textarea></td>
        </tr>
        <!-- Public/Private -->
        <tr>
...
<script type="text/javascript">
    <% if (request.getAttribute("confirmation") != null && String.valueOf(request.getAttribute("confirmation")).equals("true")) { %>
    	 var appnd ="";   
    ...
    function submitNotes() {
        ...
        if (hasErrors) {
            ...
            document.addNotesForm.action="/nbs/AddNotes.do?method=saveForm";
