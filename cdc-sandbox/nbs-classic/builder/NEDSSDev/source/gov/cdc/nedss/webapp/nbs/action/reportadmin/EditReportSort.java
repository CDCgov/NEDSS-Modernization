 ...
 * @author Ed Jenkins
 */
public class EditReportSort extends Action
{

    /**
     * Logger.
     */
    private static final Logger logger = Logger.getLogger(EditReportSort.class);

    /**
     * Constructor.
     */
    public EditReportSort()
    {
    }
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        {
       	 	logger.error("Error in Report EditReportSort: " +ex.getMessage());
       	 	ex.printStackTrace();
