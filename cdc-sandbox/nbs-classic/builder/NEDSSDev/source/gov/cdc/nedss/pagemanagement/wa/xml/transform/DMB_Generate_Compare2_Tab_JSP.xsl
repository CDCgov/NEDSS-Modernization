...
<tr><td>
         ...
         <xsl:for-each select="SubSection">
             ...
             <xsl:choose>
                 <xsl:when test="$SubSectionVisible= 'T'">
                     <xsl:text disable-output-escaping="yes"><![CDATA[<nedss:container id="]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" name="]]></xsl:text><xsl:value-of select="SubSectionName"/><xsl:text disable-output-escaping="yes"><![CDATA[" isHidden="F" classType="subSect" >]]></xsl:text>							
                 </xsl:when>
                 <xsl:otherwise>
                     <xsl:text disable-output-escaping="yes"><![CDATA[<nedss:container id="]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" name="]]></xsl:text><xsl:value-of select="SubSectionName"/><xsl:text disable-output-escaping="yes"><![CDATA[" isHidden="T" classType="subSect" >]]></xsl:text>
                 </xsl:otherwise>
             </xsl:choose>  
		...
		<table role="presentation"  class="dtTable" align="center" >
		  <thead >
		   ...
		   <tbody id="questionbody]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2">
		      ...
		      <td style="width:3%;text-align:center;"><input id="view" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked2(this.id,']]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View">                            
		  ...
		  <tbody id="noquestionbody]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2">
		  <tr id="nopattern]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" class="odd" style="display:none">
		...
		<xsl:otherwise>  
                ...
                <td>
                <xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="TextQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"/>]]></xsl:text>
			...
			<xsl:variable name="thisValSet" select="CodedQuestion/ValueSetName" />
				...
				<xsl:when test="$thisValSet= 'P_RACE_CAT' or $thisValSet= 'PHVS_RACECATEGORY_CDC_NULLFLAVOR'">
					...
					<xsl:text disable-output-escaping="yes"><![CDATA[<logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.unKnownRace" value="1"><bean:message bundle="RVCT" key="rvct.unknown"/>,</logic:equal>]]></xsl:text>
               	 	   ...
               	 	   <xsl:otherwise> <!-- default is Yes/No checkbox -->
               	 			<tr> <td class="fieldName"> 
					<xsl:if test="$thisReq= 'T'"><xsl:text disable-output-escaping="yes"><![CDATA[<span style="color:#CC0000">*</span>]]></xsl:text></xsl:if> 
               				<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L" title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text>
                			<xsl:value-of select="CodedQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
                			</td>
                			<td>
            	...
            	<xsl:when test="substring($thisControl,1,11) = 'MultiSelect' or substring($thisControl,1,19) = 'ReadOnlyMultiSelect'">
                	...
                	<xsl:value-of select="CodedQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span></td><td>]]></xsl:text>
                	  <xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" />]]></xsl:text>
...
<xsl:text disable-output-escaping="yes"><![CDATA[<td> <span id="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_Oth" />]]></xsl:text> <xsl:text disable-output-escaping="yes"><![CDATA[<nedss:view name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.answer(]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Oth)"/></td></tr>]]></xsl:text>
                           ...
                           <xsl:when test="$thisCodeset = 'COUNTY_CCD'">
								<xsl:choose>
									<xsl:when test="CodedQuestion/SourceField">
										...
										<xsl:text disable-output-escaping="yes"><![CDATA[<nedss:view name="]]></xsl:text><xsl:copy-of select="$theForm" /><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp" /><xsl:text disable-output-escaping="yes"><![CDATA[.answer(]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName" /><xsl:text disable-output-escaping="yes"><![CDATA[)" methodNm="CountyCodes" methodParam="${]]></xsl:text><xsl:copy-of select="$theForm" /><xsl:text disable-output-escaping="yes"><![CDATA[.attributeMap2.]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_STATE}"/>]]></xsl:text>
		...
		<xsl:comment>processing Numeric Question</xsl:comment>
                <xsl:text disable-output-escaping="yes"><![CDATA[<tr><td class="fieldName">]]></xsl:text>
                <xsl:if test="$thisReq= 'T'"><xsl:text disable-output-escaping="yes"><![CDATA[<span style="color:#CC0000">*</span>]]></xsl:text></xsl:if> 
                <xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="NumericQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L" title="]]></xsl:text><xsl:value-of select="NumericQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text>
                ...
                <xsl:text disable-output-escaping="yes"><![CDATA[</td><td>]]></xsl:text>
                 <xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="NumericQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"/>]]></xsl:text>
		...
		<xsl:comment>processing Date Question</xsl:comment>
                ...
                <xsl:text disable-output-escaping="yes"><![CDATA[<span title="]]></xsl:text><xsl:value-of select="DateQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[" id="]]></xsl:text><xsl:value-of select="DateQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L">]]></xsl:text><xsl:value-of select="DateQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
                 ...
                 <xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="DateQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"/>]]></xsl:text>
		...
		<xsl:comment>processing Participation Question</xsl:comment>
                ...
                <xsl:value-of select="ParticipationQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
                   ...
                   <xsl:choose>  
					<xsl:when test="$SectionAllowBatchEntry= 'Y'">
                   		<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><![CDATA[_2_Disp"]]><xsl:text disable-output-escaping="yes"><![CDATA[/>]]></xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
		...
		<xsl:when test="$thisVisible= 'F'">
 		...
 		<xsl:comment>processing TextArea</xsl:comment>
                <tr> <td class="fieldName"> 
                <xsl:if test="$thisReq= 'T'"><xsl:text disable-output-escaping="yes"><![CDATA[<span style="color:#CC0000">*</span>]]></xsl:text></xsl:if> 
                <xsl:text disable-output-escaping="yes"><![CDATA[<span title="]]></xsl:text><xsl:value-of select="TextArea/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[" id="]]></xsl:text><xsl:value-of select="TextArea/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L">]]></xsl:text>
                <xsl:value-of select="TextArea/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
                </td>
                <td>
                 <xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="TextArea/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"/>]]></xsl:text>
