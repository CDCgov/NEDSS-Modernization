...
/**
 * <p>Title: MeaslesCreateSubmit</p>
 * <p>Description: This is a Submit action class for create investigation for all the Measles conditions.</p>
...
public class MeaslesCreateSubmit
    extends BaseCreateSubmit
{

  //For logging
  static final LogUtils logger = new LogUtils(MeaslesCreateSubmit.class.
                                              getName());
  static String strLock = "lock";

  public MeaslesCreateSubmit()
  {
  }
  /**
  ...
  */
      ...
      NEDSSAppConcurrentDataException, ServletException
  {
    ...
    {
    	logger.error("Exception in Measles Create Submit: " + e.getMessage());
