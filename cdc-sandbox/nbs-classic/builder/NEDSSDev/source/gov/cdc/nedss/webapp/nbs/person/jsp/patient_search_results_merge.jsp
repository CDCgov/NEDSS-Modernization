    ...
    <head>
         ...
         */
          ...
          * MergePatientNew: merge patient functionality. It validates there's at least 2 patients selected for merging and if there's a survivor selected
          the merge columns needs to be selected as well. If all validations are correct, a double dare message will show before merging
          the patients.
          */
         ...
         function MergePatientNew(){
         	...
         	//if survivor is selected, the corresponding patient merge checkbox needs to be selected
         		...
         		if(selectedSurvivor.length==1){
         			...
         			errorMsgArray.push("You selected a PatientId as the Survivor but you unchecked the associated Merge checkbox. Please recheck the merge checkbox or choose another Survivor.");  
         		...
         		if(errorMsgArray!=null && errorMsgArray.size()>0){
         		 ...
         		 if (confirm(confirmMsg)){
         		 		...
         		 		for(var i = 0 ; i< selected.length; i++){
                             ...
                             uid = uid.replace("'","");
                             if(uid!=null && uid.indexOf("%")!=-1){//ND-24493
                               	 uid = uid.substring(0, uid.indexOf("%"))
                                }
         			    ...
         			    var action ='/nbs/MergeCandidateList1.do?ContextAction=Merge&survivor='+survivor+"&merge="+merge;
	 ...
	 {
	            document.forms[0].action ='/nbs/MergeCandidateList1.do?ContextAction=filterPatientSubmit';
	            document.forms[0].submit();
         } 
         
        function clearFilter()
	{
	             document.forms[0].action ='/nbs/MergeCandidateList1.do?ContextAction=removeFilter';
	             document.forms[0].submit();                                    
        }
        ...
        <div id="doc3">
            <div id="bd">
            	...
            	<div  style="text-align:right; margin-bottom:8px;">
                        <a  href='<c:out value="${newSearchHref}"/>'>New Search</a>
                     	&nbsp;|&nbsp;
                     	<a href='<c:out value="${refineSearchHref}"/>'>Refine Search</a>
                </div>
                <!-- Top button bar -->
            	...
            	Your Search Criteria:  <c:out value="${DSSearchCriteriaString}"/> resulted in <c:out value="${queueCount}"/> possible matches. 
				Would you like to <a href='<c:out value="${refineSearchHref}"/>'> refine your search</a><logic:match name="personSearchForm" property="attributeMap.reportType" value="N">
               ...
               <html:form action="/LoadMergeCandidateList1.do">                  
                        <table role="presentation" width="100%">                        
                            <tr>
                                <td align="center">   
								
								  <logic:match name="personSearchForm" property="attributeMap.reportType" value="N">                                                                    
                                    <display:table name="personList" class="dtTable" pagesize="20"  id="searchResultsTable" style="border: 1px solid black;" requestURI="/nbs/MergeCandidateList1.do?ContextAction=sortingByColumn&existing=true&initLoad=true" 
