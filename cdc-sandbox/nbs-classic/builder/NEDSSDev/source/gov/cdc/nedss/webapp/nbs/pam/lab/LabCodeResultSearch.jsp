    ...
    <title>Search for Coded Result</title>
		...
		document.onkeypress=function(e){
            ...
            function findCodedResult()
            {
                ...
                document.forms[0].action ="/nbs/LabSingleSelectLink.do?method=codedResultSearchSubmit";
    ...
    <td valign="top">
        ...
        <html:form action="/LabTestLoincLink.do">
       	<nedss:container id="subsec0" classType="subSect" displayImg="false">
        	<tr>
	        	<td class="fieldName" id="testName"><span>Coded Result Description:</span></td>
	            <td>				 
	            	<html:text title="Coded Result Description" styleId="codedResult" name="labResultedTestForm" property="searchCriteria(CODEDRESULT)" size="25" maxlength="100"/>
	            </td>
	        </tr>             
	        <tr>
				...
				<td> 
					...
					<table role="presentation">
						...
						<tr>
						<td>
							<html:radio title="Long list, provides standard coded results" name="labResultedTestForm" property="searchCriteria(CODESEARCHLIST)" styleId="searchResultList" value="SNOMEDRESULT" >Long list, provides standard coded results</html:radio>
						</td>
						</tr>
					</table> 
				</td>
