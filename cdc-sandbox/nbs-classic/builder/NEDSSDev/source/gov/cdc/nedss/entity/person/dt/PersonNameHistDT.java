...
/**
* Name:		    PersonNameHistDT
* Description:	PersonNameHist data table object
* Copyright:	Copyright (c) 2002
* Company: 	    Computer Sciences Corporation
* @author	    NEDSS Development Team
* @version	    1.0
*/
public class PersonNameHistDT extends AbstractVO
{
   ...
   public void setProgramJurisdictionOid (Long aProgramJurisdictionOid )
   {
    ...
    voClass =  (( PersonNameHistDT) objectname1).getClass();
