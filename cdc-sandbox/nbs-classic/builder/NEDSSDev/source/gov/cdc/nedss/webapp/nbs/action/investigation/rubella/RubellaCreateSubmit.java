...
/**
 *
 * <p>Title: RubellaCreateSubmit</p>
 * <p>Description: This is a submit action class for create investigation for the Rubella condition.</p>
...
public class RubellaCreateSubmit
    extends BaseCreateSubmit
{

  //For logging
  static final LogUtils logger = new LogUtils(RubellaCreateSubmit.class.
                                              getName());
  static String strLock = "lock";

  public RubellaCreateSubmit()
  {
  }
  /**
  ...
  */
      ...
      IOException, ServletException
  {
        ...
        sContextAction.equals(NBSConstantUtil.SubmitNoViewAccess))
    {
      ...
      {
        logger.fatal("ERROR - NEDSSAppConcurrentDataException, The data has been modifid by another user, please recheck! ", ncde);
      ...
      NEDSSAppConcurrentDataException, ServletException
  {
    ...
    {
    	logger.error("Exception in Rubella Create Submit: " + e.getMessage());
    	e.printStackTrace();
