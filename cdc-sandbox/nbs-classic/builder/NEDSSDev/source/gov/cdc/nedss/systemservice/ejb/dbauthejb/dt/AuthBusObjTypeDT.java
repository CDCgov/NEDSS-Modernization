...
/**
 *@Name:  AuthBusObjTypeDT.java
 *@Description: Refactored code
 *@Company: 	SAIC
 *@author	Pradeep K Sharma
 *@version	4.4.1
 *@OriginalName: SecureBusinessObjectTypeDT.java
 *@Description: DT for the Bus Obj Type - i.e. System, Patient, Organization
...
public class AuthBusObjTypeDT extends AbstractVO implements RootDTInterface {
	...
	private String jurisdictionInd;
	...
	public String getBusObjDispNm() {
		return busObjDispNm;
	}

	public void setBusObjDispNm(String busObjDispNm) {
		this.busObjDispNm = busObjDispNm;
	}

	public String getProgAreaInd() {
		return progAreaInd;
	}

	public void setProgAreaInd(String progAreaInd) {
		this.progAreaInd = progAreaInd;
	}

	public String getJurisdictionInd() {
		return jurisdictionInd;
	}

	public void setJurisdictionInd(String jurisdictionInd) {
		this.jurisdictionInd = jurisdictionInd;
	}
	...
	public String toString() {
		...
		try {
			...
			Field[] f = AuthBusObjTypeDT.class.getDeclaredFields();
