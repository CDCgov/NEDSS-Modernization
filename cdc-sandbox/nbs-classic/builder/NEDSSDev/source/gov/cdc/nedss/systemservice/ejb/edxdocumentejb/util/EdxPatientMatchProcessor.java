...
public class EdxPatientMatchProcessor {
	...
	public static void main(String[] args) {
		System.out
				.println("EdxPatientMatchProcessor batch process  started.  Please wait");
		try {
			...
			if (args.length == 1) {
				...
				System.out.println("Usage :  EdxPatientMatchProcessor  [run]");
				System.exit(-1);
			}
		...
		System.out.println("EdxPatientMatchProcessor Complete!!!");
	}
	...
	private static void generateHashCdforPatients(String userName) {
		...
		try {
			...
			String sMethod = "getPatientHashCd";
