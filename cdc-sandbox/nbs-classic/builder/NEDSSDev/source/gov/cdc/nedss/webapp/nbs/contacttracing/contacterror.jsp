...
<html lang="en">
    <head>
     <title>NBS: Error page</title>
        ...
        <style type="text/css">
            table tr td.fieldName {text-align:left; width:10%;  pading-right:0.20em; font-weight:bold;}    
        </style>
           ...
           function closePopUp()
            {
                    ...
                    opener.document.forms[0].action ="/nbs/HomePage.do?method=loadHomePage";
            ...
            <div id="bd">
               ...
               <table role="presentation">
                ...
                <tr>
                    <td class="fieldName"  colspan="2">
                        <span>
                        You will then need to return to the <a href class="cursorHand" onclick="return closePopUp();"> NBS Home Page</a> and reprocess your transaction.  DO NOT utilize your browser's BACK or REFRESH buttons.
                        </span>
                    </td>
                </tr>
                <tr>
            ...
            if ( e2 != null ) {
             ...
             errorOutput = stackTrace.toString();
               ...
               if(errorOutput != null)
                ...
                int strln = tsb.length();
                int loopln = strln / trimin;
                for (int i = 0; i < loopln; i++) {
                  tsb.insert(((i+1) * trimin)+(4*i), "<br>");
                }       
                }
                else{
                tsb= new StringBuffer(errorOutput);
