...
/**
* Name:		    PhysicalLocatorHistDT
* Description:	PhysicalLocatorHist data table object
* Copyright:	Copyright (c) 2002
* Company: 	    Computer Sciences Corporation
* @author	    NEDSS Development Team
* @version	    1.0
*/
public class PhysicalLocatorHistDT extends AbstractVO
{
   ...
   {
      voClass =  ((PhysicalLocatorHistDT) objectname1).getClass();
