...
public class InvestigationEditLoad
    extends CommonAction
{

    //For logging
    static final LogUtils logger = new LogUtils(InvestigationEditLoad.class.getName());
    private String investigationFormCdForLDF = null;
    /**
     * empty constructor
     */
    public InvestigationEditLoad()
    {
    }
