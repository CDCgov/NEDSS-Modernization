...
public class ByMethodValueComparator implements Comparator{

   //For logging
   static final LogUtils logger = new LogUtils(ByMethodValueComparator.class.getName());

   Class<?> clazz;
   Method valueGetter;
   boolean ascending = true;

   public ByMethodValueComparator(Class<?> c){
      clazz = c;
   }
