...
<html lang="en">
	...
	function closePopup()
	{
		if (isFormSubmission == false) {
         		...
         		if (invest != null)  	invest.style.display = "none";  
	                return true;
			    } 
		    }
	function showCount() {
	...
	function submitAssociateCoinfections()
	{
		...
		if (contextAction=="Edit") {
		     ...
		     document.forms[0].action ="/nbs/LoadManageCoinfectionAssociation.do?method=associateInterviewsToInvestigationsSubmit&ContextAction=Submit&AssociatedInvestigations="+filler.value+"&sourceUid="+sourceUid ;
...
<body class="popup"  onload="showCount();addRolePresentationToTabsAndSections();" onunload="closePopup()">
 ...
 <tr> <td>
	...
	<% if (request.getAttribute("RemovedInvestigationsInfoMsg") != null) { %>
			  <div class="infoBox messages" style="text-align: left;">
			  	<%=(String)request.getAttribute("RemovedInvestigationsInfoMsg")%>
			  </div>    
	<% } %>       
   <!-- Bottom button bar -->
   	<div class="popupButtonBar">
