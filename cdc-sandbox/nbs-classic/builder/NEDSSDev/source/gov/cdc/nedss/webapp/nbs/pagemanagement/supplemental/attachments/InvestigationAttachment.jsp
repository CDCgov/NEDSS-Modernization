...
<html:form styleId="fileAttachmentForm" action="/InvUploadFiles.do" enctype="multipart/form-data" method="post">
    <table role="presentation" class="formTableNA" style=" width:100%; height:100%; margin:0px;">
        ...
        <tr>
            ...
            <td><html:file onkeypress="this.click();" size="62" property="ctFile" style="height: 1.8em;" onchange="handleNewFileSelection(this.value)" name="fileUploadForm"> </html:file></td>
        </tr>

        <!-- File Name -->
        <tr>
            <td class="fieldName" id="fileNameLabel"> <span style="color:#CC0000; font-weight:bold;">*</span> Name:</td>
            <td><html:text size="62" property="fileName" name="fileUploadForm"> </html:text></td>
        </tr>
        <!-- File Description -->
        <tr>
            <td class="fieldName" valign="top"> Description:</td>
            <td><html:textarea style="WIDTH: 500px; HEIGHT: 100px;" property="fileDescription" name="fileUploadForm"  onkeyup="chkMaxLength(this,2000)" onkeydown="chkMaxLength(this,2000)" > </html:textarea></td>
        </tr>
        <!-- Actions -->
        <tr>
...
blockEnterKey();
    <% if (request.getAttribute("confirmation") != null && 
   	    ...
   	    <%if (request.getAttribute("newAttachment") != null){%>		
			...
			appnd +='<td><a href="javascript:loadAttachment(&quot;/nbs/InvDownloadFile.do?nbsAttachmentUid=${fn:escapeXml(attachmentUid)}&fileNmTxt=${fn:escapeXml(fileNmTxt)}&quot;)" disabled="" style="cursor: pointer;">${fn:escapeXml(fileNmTxt)}</a></td>';
	...
	function submitAttachment() {
        ...
        if (hasErrors) {
            ...
            document.fileUploadForm.action="/nbs/InvUploadFiles.do?method=doUpload";
