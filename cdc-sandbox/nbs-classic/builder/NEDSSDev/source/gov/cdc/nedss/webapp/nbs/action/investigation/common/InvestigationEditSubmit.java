...
public class InvestigationEditSubmit extends CommonAction  {


  //For logging
  static final LogUtils logger = new LogUtils(InvestigationEditSubmit.class.getName());
  static String strLock = "lock";

   public InvestigationEditSubmit()
   {
   }
