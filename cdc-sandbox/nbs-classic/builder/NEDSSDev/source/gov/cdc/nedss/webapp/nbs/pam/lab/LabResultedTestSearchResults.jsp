	            ...
	            <form method="post" id="nedssForm" action="">
	                <nedss:container id="section1" name="Search Results" classType="sect" 
	                    ...
	                    <div style="width:100%; text-align:right;margin:4px 0px 4px 0px;">
	                        <a href="<c:out value="${NewSearchLink}" />">New Search</a>&nbsp;|&nbsp;
	                    ...
	                    <%//String searchType = (String) request.getAttribute("searchType");
	                      if(NEDSSConstants.TEST_TYPE_LOCAL.equals(searchType)
						        ...
						        <div class="infoBox messages">
			                        Your Search Criteria: Resulted Test contains ' <i> <c:out value="${SearchCriteria}" /> </i>
			                        ' resulted in <b> <c:out value="${ResultsCount}" /> </b> possible matches.
			                    </div>
					      <%} else {%>
					    	<div class="infoBox messages">
		                        Your Search Criteria: Coded Result Description contains ' <i> <c:out value="${SearchCriteria}" /> </i>
		                        ' resulted in <b> <c:out value="${ResultsCount}" /> </b> possible matches.
		                    </div>
					    <%}%>
