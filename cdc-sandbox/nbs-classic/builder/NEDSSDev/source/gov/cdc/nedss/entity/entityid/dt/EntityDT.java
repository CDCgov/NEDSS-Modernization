/**
 * Title: EntityDT helper class.
 * Description: A helper class for entity data table object
...
public class EntityDT extends AbstractVO
{
   ...
   /**
    * Sets the value of the EntityDT property.
    * @param entityUid the new value of the entityUid property
    * @param classCd the new value of the classCd property
    * @param progAreaCd the new value of the progAreaCd property
    * @param jurisdictionCd the new value of the jurisdictionCd property
    * @param programJurisdictionOid the new value of the programJurisdictionOid property
    * @param sharedInd the new value of the sharedInd property
    ...
    */
    public EntityDT (  Long entityUid,
                      String classCd,
                      String progAreaCd ,
   ...
   /**
    * Sets the value of both entityUid and itDirty properties
   ...
   /**
    * Sets the value of both classCd and itDirty properties
    ...
    */
    ...
    {
      voClass =  (( EntityDT) objectname1).getClass();
