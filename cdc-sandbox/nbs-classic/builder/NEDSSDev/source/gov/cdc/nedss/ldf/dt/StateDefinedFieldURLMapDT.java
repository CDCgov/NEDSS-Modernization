//Source file: C:\\rational_rose_dev\\source\\gov\\gov\\cdc\\nedss\\ldf\\dt\\StateDefinedFieldDT.java
...
public class StateDefinedFieldURLMapDT extends AbstractVO implements RootDTInterface
{
    ...
    */
   public StateDefinedFieldURLMapDT()
   {

   }

   /**
    * Access method for the pageUid property.
    *
    * @return   the current value of the pageUid property
    */
    ...
    */
   public void setPageUid(Long aPageUid)
   {
      pageUid = aPageUid;
   }
   ...
   public void setPageName(String aPageName)
   {
     ...
     /**
    * Access method for the pageUrl property.
    *
    * @return   the current value of the pageUrl property
    */
    ...
    *
    * @param aPageUrl the new value of the pageUrl property
    */
   public void setPageUrl(String aPageUrl)
   {
    ...
    /**
    * Access method for the businessObject property.
    *
    * @return   the current value of the businessObject property
    */
    ...
    *
    * @param aPageUrl the new value of the businessObject property
    */
   public void setBusinessObject(String aBusinessObject)
   {
      businessObject = aBusinessObject;
   }
    ...
    *
    * @param aPageUrl the new value of the sortOrder property
    */
