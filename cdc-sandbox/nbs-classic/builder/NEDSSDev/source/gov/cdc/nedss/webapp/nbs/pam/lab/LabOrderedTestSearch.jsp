...
<html lang="en">
    <head>
    <base target="_self">
    <title>Search for Order Test</title>
...
<%--                 var id = '<%= request.getParameter("identifier")!=null? HTMLEncoder.encodeHtml(String.valueOf(request.getParameter("identifier"))):null%>'; --%>
				...
				var labId = getElementByIdOrByNameNode("attributeMap.NBS_LAB365Uid", parentDoc).value;
				
				if(getElementByIdOrByNameNode("NBS_LAB365",parentDoc).textContent=="")
					labId="";
                if(labTest.length == 0)
                {
                ...
                document.forms[0].action ="/nbs/SingleSelectLinkPB.do?method=orderedTestSearchSubmit&identifier="+id+"&labId="+labId;
    ...
    <td valign="top">
    	<div class="popupTitle">
            Search for Ordered Test
        </div>
        
        <div class="popupButtonBar">
            <input type="button" id="Submit" name="aSubmit" value="Submit" onclick="return findOrderedTest();"/>
        ...
        <html:form action="/LabTestLoincLink.do">
       	<nedss:container id="subsec0" classType="subSect" displayImg="false">
        	<tr>
	        	<td class="fieldName" id="testName"><span title="Please enter all or part of an test name">Test Name:</span></td>
	            <td>				 
	       ...
	       <tr>
				...
				<td> 
					...
					<table role="presentation">
						<tr>
						<td>
							<html:radio title="Short list, includes generic names of tests" name="labResultedTestForm" property="searchCriteria(SEARCHLIST)" styleId="searchList" value="LOCAL" >Short list, includes local tests</html:radio>
						</td>
						</tr>
						<tr>
						<td>
							<html:radio title="Long list, provides detailed names of tests" name="labResultedTestForm" property="searchCriteria(SEARCHLIST)" styleId="searchList" value="LOINC" >Long list, includes standard (LOINC) tests</html:radio>
						</td>
						</tr>
						<tr>
						<!--<tr>
    ...
    <td valign="bottom"> 
        <div class="popupButtonBar">
	        <input type="button" id="Submit" name="Submit" value="Submit" onclick="return findOrderedTest();"/>
	        <input type="button" name="Cancel" value="Cancel" onclick="return closePopup();" />
	    </div>
	</td>
    </tr> 
