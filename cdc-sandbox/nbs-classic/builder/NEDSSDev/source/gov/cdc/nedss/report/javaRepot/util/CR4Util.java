...
public class CR4Util {
	...
	public Collection<Object> processRequest(String fromConfirmationDate,String toConfirmationDate, String[] hangoutArray, NBSSecurityObj nbsSecurityObj) throws NEDSSAppException {
		...
		try {
			...
			Collection<Object>  hangoutLocationCollection=reportPatientDAO.getAssociatedHangoutsWithinDateRange(fromConfirmTime, toConfirmTime, hangoutValues.toString(), null, nbsSecurityObj);
			...
			while(iterator.hasNext()){
				...
				if(coll !=null){
					...
					while(iterator2.hasNext()){
						...
						if(reportPatientDT.getReferralBasis()!=null && reportPatientDT.getReferralBasis().startsWith("C1") ){
