...
public class LocallyDefinedLaboratoryResultsAction extends DispatchAction{
	
	static final LogUtils logger = new LogUtils(LocallyDefinedLaboratoryResultsAction.class.getName());
	...
	public ActionForward searchLabLoad(ActionMapping mapping, ActionForm form,HttpServletRequest request,HttpServletResponse response) {
		try{
			...
			request.setAttribute(SRTAdminConstants.PAGE_TITLE ,SRTAdminConstants.MANAGE_LD_LABRESULTS);
		}
