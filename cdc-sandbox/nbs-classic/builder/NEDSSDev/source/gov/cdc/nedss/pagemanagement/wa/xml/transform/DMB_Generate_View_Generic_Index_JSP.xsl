...
<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes"/>
    ...
    <xsl:template match="Page" xml:space="preserve">
       <xsl:comment> ### DMB: BEGIN VIEW GENERIC INDEX JSP PAGE GENERATE ###--</xsl:comment>
	...
	var isAssociated = "<%= request.getAttribute("isAssociated")%>";
	if(isAssociated=="true"){
	alert("The interview you are attempting to delete is referred to in one or more contact records. Please delete the affected contact records, or choose another interview in the affected contact records before attempting to delete the interview record.")
	return false;
	}
    ...
    <% } %>
		...
		<logic:notEqual name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="genericType" value="GENERIC_NO_POPUP_BUSINESS_OBJECT_TYPE">
			<div class="popupButtonBar">
				<logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="securityMap(editGenericPermission)" value="true">
					...
					<logic:notEqual name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="businessObjectType" value="VAC">
						<logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="businessObjectType" value="ISO">
					  	<logic:notEqual name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="actionModeParent" value="View">
				...
				<logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="securityMap(deleteGenericPermission)" value="true">
					 <logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="businessObjectType" value="VAC">
							<input type="submit" name="Delete" value="Delete" onclick="return deleteVaccination(${actUid});" />
					 </logic:equal>
					 <logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="businessObjectType" value="IXS">
							<input type="submit" name="Delete" value="Delete" onclick="return deleteInterview();" />
							<logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="attributeMap.COINFECTION_INV_EXISTS" value="true">
