    ...
    <body  onload="startCountdown();srtOnLoad();">
        <div id="doc3">
			...
			<logic:empty name="triggerCodeForm" property="actionMode">
                ...
                <html:form action="/SearchTriggerCodes.do">
                        ...
                        <fieldset style="border-width:0px;" id="search">
                            <nedss:container id="subsec1" classType="subSect" displayImg ="false">
                                ...
                                <tr>
                                    ...
                                    <td>
										<html:select name = "triggerCodeForm" property="codingSystemSelected" styleId="codingSystem" size="50">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <html:text styleId="code" name = "triggerCodeForm" property="codeSelected" size="56" maxlength="20" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
										...
										<html:select name = "triggerCodeForm" property="displayNameOperatorSelected" styleId="srchCriteria" acomplete="false">
								...
								<tr>
                                    ...
                                    <td>
                                        <html:select name = "triggerCodeForm" property="defaultConditionSelected" styleId="defaultCondition" size="40">
