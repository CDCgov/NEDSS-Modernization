package gov.cdc.nedss.ldf.group.ejb.dt;
...
public class DfSfMetadataGroupDT implements RootDTInterface {
  ...
  private boolean itIsDirty;
  private boolean itIsDelete;

  public void setDfsfMetadataGroupUid(Long aDfSfMetadataGroupUid){
    dfSfMetadataGroupUid = aDfSfMetadataGroupUid;
  }

  public Long getDfsfMetadataGroupUid(Long aDfSfMetadataGroupUid){
    return dfSfMetadataGroupUid;
  }
  ...
  public Long getUid() {
    return this.dfSfMetadataGroupUid;
  }
