...
/**
 *
 * <p>Title: RubellaCreateLoad</p>
 * <p>Description: This is a load action class for create investigation for the Rubella condition.</p>
...
public class RubellaCreateLoad
    extends BaseCreateLoad
{

    static final LogUtils logger = new LogUtils(RubellaCreateLoad.class.getName());

    public RubellaCreateLoad()
    {
    }
    /**
    ...
    */
			  ...
			  throws IOException, ServletException
    {
    	...
    	try {
    		...
    		if(sCurrentTask.equals("CreateInvestigation2") || sCurrentTask.equals("CreateInvestigation3") || sCurrentTask.equals("CreateInvestigation4") || sCurrentTask.equals("CreateInvestigation9"))
    		{
    			...
    			request.setAttribute("RUB117", labMap.get("INV178"));
    		...
    		if( sCurrentTask.equals("CreateInvestigation10")|| sCurrentTask.equals("CreateInvestigation11")&& NBSContext.retrieve(request.getSession(),"DSDocumentUID")!=null){
    			...
    			rubellaInvestigationUtil.convertPublicHealthCaseToRequest(investigationProxyVO, request);
    			rubellaInvestigationUtil.convertObservationsToRequest(investigationProxyVO, request);
    		...
    		logger.error("Exception in Rubella Create Load: " + e.getMessage());
    		e.printStackTrace();
    		throw new ServletException("Error while Rubella Create Load : "+e.getMessage());
    	}
	...
	String path = "/error";
	if (investigationFormCd.equals("INV_FORM_RUB") && viewContactTracing){
	    path = "/diseaseform/nip/rubella/investigation_rubella_create?CurrentTask=" + sCurrentTask +
		   "&ContextAction=" + sContextAction;
	    RubellaInvestigationUtil rubellaInvestigationUtil = new RubellaInvestigationUtil();
	    rubellaInvestigationUtil.getVaccinationSummaryRecords(mprUid, request);
	}else if (investigationFormCd.equals("INV_FORM_RUB") && !viewContactTracing){
	    path = "/diseaseform/nip/rubella/investigation_rubella_create_No_Contact?CurrentTask=" + sCurrentTask +
		   "&ContextAction=" + sContextAction;
	    RubellaInvestigationUtil rubellaInvestigationUtil = new RubellaInvestigationUtil();
	    rubellaInvestigationUtil.getVaccinationSummaryRecords(mprUid, request);
	}
