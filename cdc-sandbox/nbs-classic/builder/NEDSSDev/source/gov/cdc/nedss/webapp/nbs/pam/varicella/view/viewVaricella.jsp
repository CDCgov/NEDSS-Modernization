...
<html lang="en">
    <head>
        ...
        <SCRIPT Language="JavaScript" Src='/nbs/dwr/interface/JPamForm.js'/>
		...
		function checkPamDelete(){
    	 ...
    	 function printForm() {
			...
			document.forms[0].action ="/nbs/PamVarAction.do?method=printLoad";
    	 }
      ...
      function controlDeathWSOnView(resultSpanRowId)
      {
      	var valueDisplayed = '<nedss:view name="PamForm" property="pamClientVO.answer(INV145)" codeSetNm="${PamForm.formFieldMap.INV145.codeSetNm}"/>';
      	if (valueDisplayed == "Yes") {
      ...
      */
      function showPrintFriendlyPage()
      {
          ...
          var URL = "/nbs/PamVarAction.do?method=viewLoad&mode=print";
          var dialogFeatures = "dialogWidth:760px;dialogHeight:500px;status:no;unadorned:yes;scroll:yes;scrollbars:yes;help:no;resizable:yes;max:1;min:1";
    ...
    if (printMode.equals("print")) { %>
        <body class onload="startCountdown();checkPamDelete();cleanupPatientRacesViewDisplay(); controlDeathWSOnView('resultSpanRowId');checkLoadNotif();disablePrintLinks();" onunload="return closePrinterFriendlyWindow();" style="overflow-x:hidden">
        <% } else if(addPermissionString.equals("false") && manageAssoPerm.equals("false") ){ %> 
        <body class onload="startCountdown();checkPamDelete();cleanupPatientRacesViewDisplay();selectTabOnSubmit(); controlDeathWSOnView('resultSpanRowId');checkLoadNotif();">
                    ...
                    <logic:equal name="BaseForm" property="actionMode" value="Preview">
	                    <div style="text-align:right; width:100%;"> 
	                        <span class="boldTenBlack">
									<a id="manageLink" href="javascript:history.back();">Back to Manage Varicella LDFs</a>                        
	                        </span>  
	                    </div>
					</logic:equal>
					<div  id="notifTR" style="display:none;">
	                 <div style="border:2px solid green; width:100%;" align="center"> 
				...
				<!--	<% if ((String)request.getAttribute("pamShareConfMsg") != null) { %>
                    ...
                    <layout:tabs width="100%" styleClass="tabsContainer">
                        ...
                        <layout:tab key="Varicella">
                            <jsp:include page="viewVaricella_Tab1_Layout.jsp"/>
                        </layout:tab>
