...
<tr><td>
			...
			<xsl:choose>  
				<xsl:when test="$SectionVisible= 'T'">
					<xsl:text disable-output-escaping="yes"><![CDATA[<nedss:container id='<%= sectionNames[sectionIndex].replaceAll(" ", "").concat("_2") %>' name="<%= sectionNames[sectionIndex++] %>" isHidden="F" classType="sect">]]></xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text disable-output-escaping="yes"><![CDATA[<nedss:container id='<%= sectionNames[sectionIndex].replaceAll(" ", "").concat("_2") %>' name="<%= sectionNames[sectionIndex++] %>" isHidden="T" classType="sect">]]></xsl:text>
				</xsl:otherwise>
			</xsl:choose>   
				...
				<xsl:choose>  
					<xsl:when test="$SectionAllowBatchEntry= 'Y'"> 
						<xsl:if test="$hasHIVQuestions = 'Y'">
							<xsl:text disable-output-escaping="yes"><![CDATA[<logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="securityMap2.hasHIVPermissions" value="T">]]></xsl:text>
						</xsl:if>     
		...
		<tr><td>.</td>
		 <td  width="100%"> 
		        <div class="infoBox errors" style="display: none;visibility: none;" id="]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2errorMessages">]]></xsl:text>
		 	<xsl:text disable-output-escaping="yes"><![CDATA[<b> <a name="]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2errorMessages_errorMessagesHref"></a> Please fix the following errors:</b> <br/>]]></xsl:text>
		 	<xsl:text disable-output-escaping="yes"><![CDATA[</div>
		 
        		
		<table role="presentation"  class="dtTable" align="center" >
		  <thead >
		    <tr> <%String subSecNm = "]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"; String batchrec[][]= null;   Iterator mapIt = map2.entrySet().iterator();
		    while(mapIt .hasNext())
		    {
		   ...
		   <tbody id="questionbody]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2">
		      <tr id="pattern]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" class="odd" style="display:none">
		      <td style="width:3%;text-align:center;">
			<input id="view]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked2(this.id,']]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View"></td>
		          <% for(int i=0;batchrec!=null && i<batchrec.length;i++){%>  
		     ...
		     <tbody id="questionbody]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2">
		      <tr id="nopattern]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" class="odd" style="display:">
		...
		<xsl:if test="TextQuestion">
			...
			<xsl:comment>processing ReadOnly Textbox Text Question</xsl:comment>            
                		...
                		<xsl:text disable-output-escaping="yes"><![CDATA[<span title="]]></xsl:text><xsl:value-of select="TextQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[" id="]]></xsl:text><xsl:value-of select="TextQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L">]]></xsl:text>
                		<xsl:value-of select="TextQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
                		</td>
                		<td>
                		<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="TextQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[S_2"/>]]></xsl:text>
   ...
   <xsl:text disable-output-escaping="yes"><![CDATA[<html:text name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[]]></xsl:text><xsl:if test="$thisDisabled= 'disabled'"><xsl:text disable-output-escaping="yes"><![CDATA[" disabled="true]]></xsl:text></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.answer(]]></xsl:text><xsl:value-of select="TextQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[)"  maxlength="]]></xsl:text><xsl:value-of select="TextQuestion/MaxLength"/><xsl:text disable-output-escaping="yes"><![CDATA[" title="]]></xsl:text><xsl:value-of select="TextQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[" styleId="]]></xsl:text><xsl:value-of select="TextQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" onkeyup="unhideBatchImg(']]></xsl:text><xsl:value-of select="$SubSectionId"/><xsl:text disable-output-escaping="yes"><![CDATA[');]]></xsl:text><xsl:if test="TextQuestion/OnKeyUp"><xsl:value-of select="TextQuestion/OnKeyUp"/></xsl:if><xsl:if test="TextQuestion/OnKeyDown"><xsl:text disable-output-escaping="yes"><![CDATA[" onkeydown="]]></xsl:text><xsl:value-of select="TextQuestion/OnKeyDown"/></xsl:if><xsl:if test="TextQuestion/OnBlur"><xsl:text disable-output-escaping="yes"><![CDATA[" onblur="]]></xsl:text><xsl:value-of select="TextQuestion/OnBlur"/></xsl:if><xsl:if test="TextQuestion/FieldStyleClass"><xsl:text disable-output-escaping="yes"><![CDATA[" styleClass="]]></xsl:text><xsl:value-of select="TextQuestion/FieldStyleClass"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA["/>]]></xsl:text>	
		...
		<xsl:if test="CodedQuestion">
					...
					<xsl:when test="$thisVisible= 'F'">
						...
						<xsl:value-of select="CodedQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
					 	...
					 	<xsl:text disable-output-escaping="yes"><![CDATA[onchange="]]></xsl:text><xsl:if test="$SectionAllowBatchEntry= 'Y'"><xsl:text disable-output-escaping="yes"><![CDATA[unhideBatchImg(']]></xsl:text><xsl:value-of select="$SubSectionId"/><xsl:text disable-output-escaping="yes"><![CDATA[');]]></xsl:text></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[displaySelectedOptions(this, ']]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2-selectedValues')]]></xsl:text><xsl:if test="CodedQuestion/OnChange"><xsl:text disable-output-escaping="yes"><![CDATA[;]]></xsl:text><xsl:value-of select="CodedQuestion/OnChange"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[" >]]></xsl:text>
		 			 	...
		 			 	<xsl:text disable-output-escaping="yes"><![CDATA[ <div id="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2-selectedValues" style="margin:0.25em;">]]></xsl:text>
					   	 <b> Selected Values: </b>
					...
					<xsl:otherwise>
						...
						<tr><td class="fieldName"> 
				 		<xsl:choose>
							<xsl:when test="$thisReq= 'T'">
							<xsl:text disable-output-escaping="yes"><![CDATA[<span style="color:#CC0000">*</span>]]></xsl:text>
							<xsl:text disable-output-escaping="yes"><![CDATA[<span class="requiredInputField]]></xsl:text><xsl:if test="$SectionAllowBatchEntry= 'Y'"><xsl:value-of select="$SubSectionId"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[_2]]></xsl:text><xsl:choose><xsl:when test="$thisDisabled= 'disabled'"><xsl:text disable-output-escaping="yes"><![CDATA[ InputDisabledLabel" id="]]></xsl:text></xsl:when><xsl:otherwise><xsl:text disable-output-escaping="yes"><![CDATA[ InputFieldLabel" id="]]></xsl:text></xsl:otherwise></xsl:choose><xsl:text disable-output-escaping="yes"></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L" title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text>
						</xsl:when>
						<xsl:otherwise>
							<xsl:text disable-output-escaping="yes"><![CDATA[<span class="]]></xsl:text><xsl:choose><xsl:when test="$thisDisabled= 'disabled'"><xsl:text disable-output-escaping="yes"><![CDATA[InputDisabledLabel" id="]]></xsl:text></xsl:when><xsl:otherwise><xsl:text disable-output-escaping="yes"><![CDATA[ InputFieldLabel" id="]]></xsl:text></xsl:otherwise></xsl:choose><xsl:text disable-output-escaping="yes"></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L" title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text>
						</xsl:otherwise>
			...
			<xsl:when test="substring($thisControl,1,19) = 'ReadOnlyMultiSelect'">
                	...
                	<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[S_2" />]]></xsl:text>
                	<xsl:text disable-output-escaping="yes"><![CDATA[<nedss:view name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.answerArray(]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[)"]]></xsl:text>
                	<xsl:variable name="thisCodeset" select="CodedQuestion/ValueSetName" />
				   ...
				   <xsl:when test="substring($thisControl,1,8) = 'Checkbox'">
					...
					<xsl:when test="$thisVisible= 'F'">			   
						 	...
						 	<xsl:if test="$thisReq= 'T'">
						  	...
						  	<xsl:text disable-output-escaping="yes"><![CDATA[<span title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[" id="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L">]]></xsl:text>
						 	<xsl:value-of select="CodedQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
                     			         	</td>
                     			         	<td>
					...
					<xsl:otherwise>			   
						 	...
						 	<xsl:value-of select="CodedQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
                     			         	...
                     			         	<td>
						 	<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleId="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_0"  name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.americanIndianAlskanRace" value="1"]]></xsl:text>
							<xsl:text disable-output-escaping="yes"><![CDATA[title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA["></html:checkbox> <bean:message bundle="RVCT" key="rvct.american.indian.or.alaska.native"/>]]></xsl:text>
					         	</td>
					      	</tr>
					      	<tr>
							...
							<td>
							<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleId="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_1"  name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.asianRace" value="1"]]></xsl:text>
							<xsl:text disable-output-escaping="yes"><![CDATA[title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA["></html:checkbox>  <bean:message bundle="RVCT" key="rvct.asian"/>]]></xsl:text>
							</td>
					      	</tr>
					       	<tr>
							...
							<td>
							<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleId="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_3"  name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.hawaiianRace" value="1"]]></xsl:text>
							<xsl:text disable-output-escaping="yes"><![CDATA[title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA["></html:checkbox>  <bean:message bundle="RVCT" key="rvct.native.hawaiian.or.other.pacific.islander"/>]]></xsl:text>
							</td>
					      	</tr>
					      	<tr>
						 	...
						 	<td>
						 	<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleId="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_4"  name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.whiteRace" value="1"]]></xsl:text>
						 	<xsl:text disable-output-escaping="yes"><![CDATA[title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA["></html:checkbox>  <bean:message bundle="RVCT" key="rvct.white"/>]]></xsl:text>
						 	</td>
					      	</tr>
					      	...
					      	<xsl:choose>
								...
								<xsl:otherwise>
									...
									<td>
									<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleId="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_5"  name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.otherRace" value="1"]]></xsl:text>
									...
									<td>
									<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleId="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_6"  name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.refusedToAnswer" value="1"]]></xsl:text>
									<xsl:text disable-output-escaping="yes"><![CDATA[title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA["></html:checkbox>  <bean:message bundle="RVCT" key="rvct.refusedToAnswer"/>]]></xsl:text>
									</td>
							      	</tr>
							      	<tr>
									...
									<td>
									<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleId="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_7"  name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.notAsked" value="1"]]></xsl:text>
						 	...
						 	<td>
						 	<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleId="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_8"  name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.unKnownRace" value="1"]]></xsl:text>
						 	<xsl:text disable-output-escaping="yes"><![CDATA[title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA["></html:checkbox>  <bean:message bundle="RVCT" key="rvct.unknown"/>]]></xsl:text>
						 	</td>
					      	</tr>
							...
							<xsl:choose>
						 	<xsl:when test="$thisReq= 'T'">
						      	<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox styleClass="requiredInputField]]></xsl:text><xsl:if test="$SectionAllowBatchEntry= 'Y'"><xsl:value-of select="$SubSectionId"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[_2]]></xsl:text><xsl:if test="$thisDisabled= 'disabled'"><xsl:text disable-output-escaping="yes"><![CDATA[" disabled="true]]></xsl:text></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[" name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.answer(]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[)" value="1"]]></xsl:text>
						 	<xsl:text disable-output-escaping="yes"><![CDATA[title="]]></xsl:text><xsl:value-of select="CodedQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA["></html:checkbox>]]></xsl:text>
							</xsl:when>
							<xsl:otherwise>
						       	<xsl:text disable-output-escaping="yes"><![CDATA[<html:checkbox ]]></xsl:text><xsl:if test="$thisDisabled= 'disabled'"><xsl:text disable-output-escaping="yes"><![CDATA[ disabled="true" ]]></xsl:text></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[ name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.answer(]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[)" value="1"]]></xsl:text>
			...
			<xsl:when test="substring($thisControl,1,14) = 'ReadOnlySelect'">	
                	...
                	</xsl:text>  <xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="CodedQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" />]]></xsl:text>
                	<xsl:variable name="thisCodeset" select="CodedQuestion/ValueSetName" />
   						...
   						<xsl:when test="$thisCodeSet = 'COUNTY_CCD'">
   							<xsl:variable name="thisQuestion" select="CodedQuestion/QuestionUniqueName" />
					        	...
					        	<xsl:choose><xsl:when test="substring($thisQuestion,1,3) = 'INV'">
					 			<xsl:text disable-output-escaping="yes"><![CDATA[<html:optionsCollection property="dwrImportedCounties2" value="key" label="value" /> </html:select> ]]></xsl:text></xsl:when>
	...
	<xsl:if test="NumericQuestion">
		...
		<xsl:variable name="thisControl" select="NumericQuestion/ControlType" />
   		<xsl:choose>
			<xsl:when test="substring($thisControl,1,15) = 'ReadOnlyTextbox'">
			<xsl:comment>processing ReadOnly Numeric Question</xsl:comment>
                	<xsl:text disable-output-escaping="yes"><![CDATA[<tr><td class="fieldName">]]></xsl:text>
                	<xsl:if test="$thisReq= 'T'"><xsl:text disable-output-escaping="yes"><![CDATA[<span style="color:#CC0000">*</span>]]></xsl:text></xsl:if> 
                	...
                	<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="NumericQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[S_2"/>]]></xsl:text>
...
<xsl:text disable-output-escaping="yes"><![CDATA[<html:text name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" ]]></xsl:text><xsl:if test="$thisDisabled= 'disabled'"><xsl:text disable-output-escaping="yes"><![CDATA[disabled="true"]]></xsl:text></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[ property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.answer(]]></xsl:text><xsl:value-of select="NumericQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[)" size="]]></xsl:text><xsl:value-of select="NumericQuestion/DisplayLength"/><xsl:text disable-output-escaping="yes"><![CDATA[" maxlength="]]></xsl:text><xsl:value-of select="NumericQuestion/MaxLength"/><xsl:text disable-output-escaping="yes"><![CDATA["  title="]]></xsl:text><xsl:value-of select="NumericQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[" styleId="]]></xsl:text><xsl:value-of select="NumericQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" onkeyup="unhideBatchImg(']]></xsl:text><xsl:value-of select="$SubSectionId"/><xsl:text disable-output-escaping="yes"><![CDATA[');]]></xsl:text><xsl:if test="NumericQuestion/OnKeyUp"><xsl:value-of select="NumericQuestion/OnKeyUp"/></xsl:if><xsl:if test="NumericQuestion/OnBlur"><xsl:text disable-output-escaping="yes"><![CDATA[" onblur="]]></xsl:text><xsl:value-of select="NumericQuestion/OnBlur"/></xsl:if><xsl:if test="NumericQuestion/OnChange"><xsl:value-of select="NumericQuestion/OnChange"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[" styleClass="requiredInputField]]></xsl:text><xsl:if test="$SectionAllowBatchEntry= 'Y'"><xsl:value-of select="$SubSectionId"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[_2]]></xsl:text><xsl:if test="NumericQuestion/FieldStyleClass"><xsl:text disable-output-escaping="yes"><![CDATA[ ]]></xsl:text><xsl:value-of select="NumericQuestion/FieldStyleClass"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA["/>]]></xsl:text>				
		...
		<xsl:choose>
			...
			<!-- 	<xsl:text disable-output-escaping="yes"><![CDATA[<html:img src="calendar.gif" alt="Select a Date" ]]></xsl:text><xsl:choose><xsl:when test="$thisFuture= 'T'"><xsl:text disable-output-escaping="yes"><![CDATA[onclick="getCalDateFuture(']]></xsl:text></xsl:when><xsl:otherwise><xsl:text disable-output-escaping="yes"><![CDATA[onclick="getCalDate(']]></xsl:text></xsl:otherwise></xsl:choose><xsl:value-of select="DateQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[',']]></xsl:text><xsl:value-of select="DateQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Icon');]]></xsl:text><xsl:if test="$SectionAllowBatchEntry= 'Y'"><xsl:text disable-output-escaping="yes"><![CDATA[unhideBatchImg(']]></xsl:text><xsl:value-of select="$SubSectionId"/><xsl:text disable-output-escaping="yes"><![CDATA[');]]></xsl:text></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[return false;" styleId="]]></xsl:text><xsl:value-of select="DateQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Icon_2"></html:img>]]></xsl:text> -->
				...
				<xsl:when test="$thisDateVisible='F'">
					...
					<tr style="display:none"><td class="fieldName"> 
					<xsl:text disable-output-escaping="yes"><![CDATA[<span title="]]></xsl:text><xsl:value-of select="DateQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[" id="]]></xsl:text><xsl:value-of select="DateQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L">]]></xsl:text>
					<xsl:value-of select="DateQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> ]]></xsl:text>
               		</td>
              		<td>
                      	<xsl:text disable-output-escaping="yes"><![CDATA[<html:text name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" title="]]></xsl:text><xsl:value-of select="DateQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.answer(]]></xsl:text><xsl:value-of select="DateQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[)" maxlength="10" size="10" styleId="]]></xsl:text><xsl:value-of select="DateQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"/>]]></xsl:text>
	...
	<xsl:if test="ParticipationQuestion">
	   ...
	   <xsl:when test="$thisParType = 'PSN'">
		...
		<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2L" title="]]></xsl:text><xsl:value-of select="ParticipationQuestion/ToolTip"/><xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text>
		<xsl:value-of select="ParticipationQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[:</span> </td>]]></xsl:text>    			
       		...
       		<xsl:text disable-output-escaping="yes"><![CDATA[<logic:empty name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Uid">]]></xsl:text>
      		<xsl:text disable-output-escaping="yes"><![CDATA[<span id="clear]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2" class="none">]]></xsl:text>
       		<xsl:text disable-output-escaping="yes"><![CDATA[</logic:empty>]]></xsl:text>
       		<xsl:text disable-output-escaping="yes"><![CDATA[<logic:notEmpty name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Uid">]]></xsl:text>
      		<xsl:text disable-output-escaping="yes"><![CDATA[<span id="clear]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2">]]></xsl:text>
      		<xsl:text disable-output-escaping="yes"><![CDATA[</logic:notEmpty>]]></xsl:text>
       		<xsl:text disable-output-escaping="yes"><![CDATA[<input type="button" class="Button" style="display: none;" value="Clear/Reassign" id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[CodeClearButton_2" onclick="clearProvider(']]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[')"/>]]></xsl:text>
		<xsl:text disable-output-escaping="yes"><![CDATA[</span>]]></xsl:text> 
		<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_SearchControls" ]]></xsl:text>
		<!-- <xsl:text disable-output-escaping="yes"><![CDATA[<logic:notEmpty name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Uid">]]></xsl:text> -->
		<xsl:text disable-output-escaping="yes"><![CDATA[class="none"]]></xsl:text> 
		<!-- <xsl:text disable-output-escaping="yes"><![CDATA[</logic:notEmpty>]]></xsl:text> -->
		<xsl:text disable-output-escaping="yes"><![CDATA[><input type="button" class="Button" style="display: none;" value="Search" ]]></xsl:text>
       		<xsl:text disable-output-escaping="yes"><![CDATA[id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_Icon" onclick="getProvider(']]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[');" />&nbsp; - OR - &nbsp;]]></xsl:text>
		<xsl:choose>
		<xsl:when test="$thisReq= 'T'">
		<xsl:text disable-output-escaping="yes"><![CDATA[<html:text styleClass="requiredInputField" property="]]></xsl:text><xsl:copy-of select="$theProp"/><xsl:text disable-output-escaping="yes"><![CDATA[.answer(]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[)" styleId="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2Text" ]]></xsl:text>					
		</xsl:when>
		<xsl:otherwise>
      		...
      		<xsl:text disable-output-escaping="yes"><![CDATA[size="10" maxlength="10" onkeydown="genProviderAutocomplete(']]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Text',']]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_qec_list')" ]]></xsl:text><xsl:if test="ParticipationQuestion/OnChange"><xsl:text disable-output-escaping="yes"><![CDATA[onchange="]]></xsl:text><xsl:value-of select="ParticipationQuestion/OnChange"/><xsl:text disable-output-escaping="yes"><![CDATA[" ]]></xsl:text></xsl:if>
       		...
       		<xsl:text disable-output-escaping="yes"><![CDATA[<input type="button" class="Button" style="display: none;" value="Quick Code Lookup" ]]></xsl:text>
		...
		<xsl:text disable-output-escaping="yes"><![CDATA[<td class="fieldName" id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2S">]]></xsl:text><xsl:value-of select="ParticipationQuestion/DisplayLabel"/><xsl:text disable-output-escaping="yes"><![CDATA[ Selected: </td>]]></xsl:text>
       		<xsl:text disable-output-escaping="yes"><![CDATA[<logic:empty name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Uid">]]></xsl:text>			
		...
		<xsl:text disable-output-escaping="yes"><![CDATA[<td> <span class="test2">]]></xsl:text>
       		<xsl:text disable-output-escaping="yes"><![CDATA[</logic:notEmpty>]]></xsl:text>
		<xsl:text disable-output-escaping="yes"><![CDATA[<html:hidden property="attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Uid"/>]]></xsl:text>
		<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2">${]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[.attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[SearchResult}</span>]]></xsl:text>
		<xsl:text disable-output-escaping="yes"><![CDATA[</span> </td>]]></xsl:text>   
	      	...
	      	<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2Error"/>]]></xsl:text>
	      	<xsl:text disable-output-escaping="yes"><![CDATA[</td></tr>]]></xsl:text>
		...
		<xsl:when test="$thisParType = 'PLC'">
			...
			<!-- <xsl:text disable-output-escaping="yes"><![CDATA[</logic:notEmpty>]]></xsl:text> -->
			<xsl:text disable-output-escaping="yes"><![CDATA[><input type="button" class="Button" style="display: none;" value="Search" ]]></xsl:text>
       		<xsl:text disable-output-escaping="yes"><![CDATA[id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2_Icon" onclick="getHangoutPlace(']]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[');" />&nbsp; - OR - &nbsp;]]></xsl:text>
			...
			<xsl:choose>
				<xsl:when test="$thisReq= 'T'">
					<xsl:text disable-output-escaping="yes"><![CDATA[<html:hidden styleClass="requiredInputField]]></xsl:text><xsl:if test="$SectionAllowBatchEntry= 'Y'"><xsl:value-of select="$SubSectionId"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[_2" property="attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Disp" styleId="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"/>]]></xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text disable-output-escaping="yes"><![CDATA[<html:hidden property="attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Disp" styleId="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"/>]]></xsl:text>
				</xsl:otherwise>
			</xsl:choose>		
			<xsl:text disable-output-escaping="yes"><![CDATA[<span id="]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[Disp_2">${]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[.attributeMap2.]]></xsl:text><xsl:value-of select="ParticipationQuestion/QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[SearchResult}</span>]]></xsl:text>
		    <xsl:text disable-output-escaping="yes"><![CDATA[</span> </td>]]></xsl:text>    			
            <xsl:text disable-output-escaping="yes"><![CDATA[</tr>]]></xsl:text>
      ...
      <xsl:choose>  
       <xsl:when test="$SectionAllowBatchEntry= 'Y'">       
           ...
           <xsl:text disable-output-escaping="yes"><![CDATA[  
			...
			<input type="button" value="     Add     "  style="display: none;"  disabled="disabled" onclick="if (pg]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[BatchAddFunction()) writeQuestion(']]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2','pattern]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2','questionbody]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2')"/>&nbsp;&nbsp;
			&nbsp;
			</td>
			</tr>
			<%} else {%>
			<tr id="AddButtonToggle]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2">
			<td colspan="2" align="right">
			<input type="button" value="     Add     " style="display: none;" onclick="if (pg]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[BatchAddFunction()) writeQuestion(']]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2','pattern]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2','questionbody]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2')"/>&nbsp;&nbsp;
			&nbsp;
			</td>
			</tr>
                   <%} %>
			<tr id="UpdateButtonToggle]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2"
        style="display:none">
			<td colspan="2" align="right">
			<input type="button" value="   Update   "  style="display: none;"  onclick="if (pg]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[BatchAddFunction()) writeQuestion(']]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2','pattern]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2','questionbody]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2')"/>&nbsp;		&nbsp;
			&nbsp;
			</td>
			</tr>
     ...
     style="display:none">
			<td colspan="2" align="right">
			<input type="button" value="  Add New  " style="display: none;"  onclick="clearClicked(']]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2')"/>&nbsp;	&nbsp;&nbsp;
