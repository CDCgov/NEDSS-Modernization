...
/**
 *
 * <p>Title: RubellaEditSubmit</p>
 * <p>Description: This is a submit action class for edit investigation for the Rubella condition.</p>
...
public class RubellaEditSubmit extends BaseEditSubmit
{


  //For logging
  static final LogUtils logger = new LogUtils(RubellaEditSubmit.class.getName());
  static String strLock = "lock";

   public RubellaEditSubmit()
   {
   }
   /**
   ...
   private void editHandler(ActionMapping mapping,
										     ...
										     NEDSSAppConcurrentDataException
    {
	  ...
	  try {
		  ...
		  logger.error("Exception in Rubella Edit Submit: " + e.getMessage());
		  e.printStackTrace();
		  throw new ServletException("Error while Rubella Edit Submit : "+e.getMessage());
	  }
