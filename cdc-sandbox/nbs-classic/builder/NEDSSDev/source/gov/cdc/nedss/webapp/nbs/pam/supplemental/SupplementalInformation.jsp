...
<tr> <td>
	...
	<div class="view" id="<%= tabId %>" style="text-align:center;">   
	    ...
	    %>
	      <body class onload="startCountdown();checkPamDelete();cleanupPatientRacesViewDisplay();selectTabOnSubmit(); controlDeathWSOnView('resultSpanRowId');checkLoadNotif();disablePrintLinks();" onunload="return closePrinterFriendlyWindow();">
         <%}%>
                ...
                <tr>
                    <td style="padding:0.5em;">
                        <display:table id="notesDTTable" name="nbsNotes" class="dtTable" defaultsort="4" defaultorder="ascending">
                         <display:setProperty name="export.pdf.filename" value="NbsNotes.pdf"/>		
	                ...
	                <td style="padding:0.5em;">
                        ...
                        <logic:notEqual name="mode" value="print">
	                         <display:table id="attachmentsDTTable" name="nbsAttachments" class="dtTable" defaultsort="4" defaultorder="ascending">
	                             <display:column class="iconField" property="deleteLink" title="Action"/>
	                             <display:column class="dateField" property="lastChgTime" title="Date Added" format="{0,date,MM/dd/yyyy}" />
	                             <display:column class="nameField" property="lastChgUserNm" title="Added By" />
        ...
        function deleteAttachment(uid) {
            ...
            if (choice) {
	            JPamForm.deleteAttachment (uid, function(data) {
	                if(data == true) {
	                    var toFind = "td_"+uid;
          ...
          function showPrintFriendlyNotes()
      {
          ...
          var URL = "/nbs/PamAction.do?method=printNotes&mode=print&pageId=pamview";
