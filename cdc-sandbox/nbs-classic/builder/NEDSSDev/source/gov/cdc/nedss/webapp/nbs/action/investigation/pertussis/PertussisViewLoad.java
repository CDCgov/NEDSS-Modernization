...
/**
 * <p>Title: PertussisViewLoad</p>
 * <p>Description: This is a Load action class for view investigation for all the Pertussis conditions.</p>
...
public class PertussisViewLoad
    extends BaseViewLoad
{

    //For logging
    static final LogUtils logger = new LogUtils(PertussisViewLoad.class.getName());

     /**
       * This is constructor
       *
       */
    public PertussisViewLoad()
    {
    }
	...
	else
	{
            ...
            {
              logger.error("Error in Pertussis View Load is " + ex.toString());
              ex.printStackTrace();
	...
	{
		logger.error("Error in PertussisViewLoad is: "+e.getMessage());
		e.printStackTrace();
    ...
    private ActionForward getForwardPage(String sCurrentTask,
					 String sContextAction , boolean viewContactTracing, boolean addContactTracing,boolean manageCTPerm, String contactCaseUrl,String viewFileUrl)
	...
	String addpermString = new Boolean(addContactTracing).toString();
          ...
          if (sContextAction.equalsIgnoreCase("PrintPage") && viewContactTracing)
            ...
            path = "/diseaseform/nip/pertussis/investigation_pertussis_view?CurrentTask=" +
              sCurrentTask +
              "&ContextAction=" + sContextAction+"&addPerm=" + addpermString+"&manageCTPerm=" + manageCTPerm+ "&contactCaseUrl=" + contactCaseUrl+"&viewFileUrl=" + viewFileUrl;
