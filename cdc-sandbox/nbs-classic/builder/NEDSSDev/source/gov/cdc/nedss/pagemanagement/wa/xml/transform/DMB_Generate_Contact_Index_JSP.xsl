...
<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes"/>   
    ...
    <xsl:template match="Page" xml:space="preserve">
       <xsl:comment> ### DMB: BEGIN JSP CONTACT PAGE GENERATE ###--</xsl:comment>
    <html lang="en">
    <head>
    ...
    <xsl:text disable-output-escaping="yes"><![CDATA[<SCRIPT Language="JavaScript" Src="/nbs/dwr/interface/JCTContactForm.js"></SCRIPT>]]></xsl:text>  
    <xsl:text disable-output-escaping="yes"><![CDATA[<script language="JavaScript" src="batch.js"></script>]]></xsl:text> 
