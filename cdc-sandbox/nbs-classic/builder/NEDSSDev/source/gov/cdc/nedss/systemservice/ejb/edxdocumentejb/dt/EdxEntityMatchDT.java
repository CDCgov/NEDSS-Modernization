...
public class EdxEntityMatchDT extends AbstractVO implements RootDTInterface {
	...
	public Long getEdxEntityMatchUid() {
		return edxEntityMatchUid;
	}

	public void setEdxEntityMatchUid(Long edxEntityMatchUid) {
		this.edxEntityMatchUid = edxEntityMatchUid;
	}
	...
	public String toString() {
		...
		try {
			...
			Field[] f = EdxEntityMatchDT.class.getDeclaredFields();
