...
<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes"/>   
    ...
    <xsl:text disable-output-escaping="yes"><![CDATA[<SCRIPT Language="JavaScript" Src="/nbs/dwr/interface/JPageSubForm.js"></SCRIPT>]]></xsl:text>  
...
<xsl:text disable-output-escaping="yes"><![CDATA[ 
  ...
  <xsl:text disable-output-escaping="yes"><![CDATA[      
	...
	<%}}%>
	   ...
	   <logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="businessObjectType" value="LAB">
...
%> 
 <logic:notEqual name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA["  property="businessObjectType" value="ISO">
	 <logic:notEqual name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA["  property="businessObjectType" value="SUS">

	 <logic:notEqual name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA["  property="businessObjectType" value="LAB">
  ...
  <logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA["  property="businessObjectType" value="ISO">
  <body class="popup" onload="startCountdown();autocompTxtValuesForJSP();pageCreateLoad('${PageForm.attributeMap.selectEltIdsArray}');
   ...
   <logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA["  property="businessObjectType" value="SUS">
    ...
    pgCheckOnloadOtherEntryAllowedFields();pgCheckDynamicRulesOnLoad();pgCheckForFieldsToHighlightOnEdit();pgPopulateCounties();addRolePresentationToTabsAndSections();populateDrugTestData();populateCodedResultDataSusc(); populateResultMethodDataSusc();onloadBlockParent();" onunload="unloadSubForms(true, event);">
		...
		<html:hidden name="PageForm" property="pageClientVO.answer(DEM165_W)" styleId="DEM165_W_Hidden"/>
            ...
            <html:form action="/PageAction.do"> 
                <!-- Page title -->
            <logic:notEqual name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA["  property="genericType" value="GENERIC_NO_POPUP_BUSINESS_OBJECT_TYPE">
            ...
            <!-- Body div -->
            <div id="bd">
            	<logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="genericType" value="GENERIC_NO_POPUP_BUSINESS_OBJECT_TYPE">
					 ...
					 <%@ include file="/jsp/topbuttonbarFullScreenWidth.jsp" %>
                       ...
                       <%@ include file="/jsp/feedbackMessagesBar.jsp" %>
                        ...
                        <logic:equal name="]]></xsl:text><xsl:copy-of select="$theForm"/><xsl:text disable-output-escaping="yes"><![CDATA[" property="businessObjectType" value="VAC">
