...
<%--                 var id = '<%= request.getParameter("identifier")!=null? HTMLEncoder.encodeHtml(String.valueOf(request.getParameter("identifier"))):null%>'; --%>
                ...
                document.forms[0].action ="/nbs/SingleSelectLinkPB.do?method=drugTestSearchSubmit&identifier="+id;
    ...
    <td valign="top">
    	<div class="popupTitle">
            Search for Drug Test
        </div>
        
        <div class="popupButtonBar">
            <input type="button" id="Submit" name="aSubmit" value="Submit" onclick="return findDrugTest();"/>
        ...
        <html:form action="/LabTestLoincLink.do">
       	<nedss:container id="subsec0" classType="subSect" displayImg="false">
        	<tr>
	        	<td class="fieldName" id="testName"><span title="Please enter all or part of an test name">Drug Name:</span></td>
	            <td>				 
	       ...
	       <tr>
				...
				<td> 
					...
					<table role="presentation">
						<tr>
						<td>
							<html:radio title="Short list, includes generic names of tests" name="labResultedTestForm" property="searchCriteria(SEARCHLIST)" styleId="searchList" value="LOCAL" >Short list, includes generic names of tests</html:radio>
						</td>
						</tr>
						<tr>
						<td>
							<html:radio title="Long list, provides detailed names of tests" name="labResultedTestForm" property="searchCriteria(SEARCHLIST)" styleId="searchList" value="LOINC" >Long list, provides detailed names of tests</html:radio>
						</td>
						</tr>
						<tr>
						<!--<tr>
    ...
    <td valign="bottom"> 
        <div class="popupButtonBar">
	        <input type="button" id="Submit" name="Submit" value="Submit" onclick="return findDrugTest();"/>
	        <input type="button" name="Cancel" value="Cancel" onclick="return closePopup();" />
	    </div>
	</td>
    </tr> 
