...
<html lang="en">
    ...
    <title>Organism Search Results</title>
    <%} else {%>
	                ...
	                <nedss:container id="section1" name="Search Results" classType="sect" 
	                        ...
	                        <tr>
	                           <td align="center">              
	                               <display:table name="resultedTestList" class="dtTable" pagesize="20"  id="parent" requestURI="">
	                                  ...
	                                  <display:column property="labTestDescription" title="Organism Name" class="dstag"/>
	                    ...
	                    <table role="presentation" width="100%" border="0" cellspacing="0">
	                        <tr>
	                           <td align="center">              
	                               <display:table name="resultedTestList" class="dtTable" pagesize="20"  id="parent" requestURI="">
	                                  <display:column property="recordStatusCd" title="<p style='display:none'>Record Status Cd</p" class="dstag"/> 
