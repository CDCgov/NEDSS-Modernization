...
function testDisplayOrderCheck(){
        ...
        var element  = getElementByIdOrByName("ldfi[i].displayOrderNbr");
...
function testDisplayWidthCheck(){
        ...
        var element  = getElementByIdOrByName("ldfi[i].fieldSize");
	var tdErrorCell = getTdErrorCell(element ) ;
  ...
  {
        var element  = getElementByIdOrByName("ldfi[i].labelTxt");
	var tdErrorCell = getTdErrorCell(element ) ;
		...
		if(isLong(element.value, maxLength) == true) {
			...
			errorText = "Label must be less than or equal to 300 characters. Please correct the data and try again.";
  ...
  var element  = getElementByIdOrByName("ldfi[i].dataType");
  var tdErrorCell = getTdErrorCell(element ) ;
  ...
  var element  = getElementByIdOrByName("ldfi[i].codeSetNm");
  var dataType = getElementByIdOrByName("ldfi[i].dataType");
