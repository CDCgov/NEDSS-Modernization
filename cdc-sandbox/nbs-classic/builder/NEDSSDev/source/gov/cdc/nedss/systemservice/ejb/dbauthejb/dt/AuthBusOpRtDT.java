...
/**
 *@Name:  AuthBusOpRtDT.java
*@Description: Refacored code
* @Company: 	SAIC
* @author	Pradeep K Sharma
* @version	4.4.1
* @OriginalName:  SecureBusinessOperationRightDT.java
 * Description: Specifies operations that can be performed on attached business object
 *  i.e. View operation on object Investigation, Edit operation on patient, etc.
...
public class AuthBusOpRtDT  extends AbstractVO implements RootDTInterface {
	
	private static final long serialVersionUID = 1L;
	private Long authBusOpRtUid;
	private Long authBusOpTypeUid;
	private Long authBusObjRtUid;
	private String busOpUserRt;
	private String busOpGuestRt;
	...
	public Long getAuthBusOpRtUid() {
		return authBusOpRtUid;
	}
	public void setAuthBusOpRtUid(Long authBusOpRtUid) {
		this.authBusOpRtUid = authBusOpRtUid;
	}
	...
	public String getBusOpUserRt() {
		return busOpUserRt;
	}
	public void setBusOpUserRt(String busOpUserRt) {
		this.busOpUserRt = busOpUserRt;
	}
	public String getBusOpGuestRt() {
		return busOpGuestRt;
	}
	public void setBusOpGuestRt(String busOpGuestRt) {
		this.busOpGuestRt = busOpGuestRt;
	}
	...
	public String toString() {
		...
		try {
			...
			Field[] f = AuthBusOpRtDT.class.getDeclaredFields();
