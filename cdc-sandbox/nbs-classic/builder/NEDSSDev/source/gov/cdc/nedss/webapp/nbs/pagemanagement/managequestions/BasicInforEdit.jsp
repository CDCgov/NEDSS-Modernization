...
<tr>
    ...
    <td>
        ...
        <logic:notEqual name="manageQuestionsForm" property="selection.referencedInd" value="<%= NEDSSConstants.TRUE %>">
            <html:text title="Unique Name" property="selection.questionNm" size="25" maxlength="50" styleId="questionNm" />
        </logic:notEqual>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <html:textarea title="Description" rows="6" cols="60" property="selection.description" styleId="desc" />      
    </td>
</tr>
...
<tr>      
    ...
    <td>
        ...
        <!-- for non-referenced question -->
        <logic:notEqual name="manageQuestionsForm" property="selection.referencedInd" value="<%= NEDSSConstants.TRUE %>">
            <html:select  title="Data Type" property="selection.dataType" styleId="dataType"
...
<tr class="questionTypeRelatedField codedQuestionType">
    ...
    <td>
        <html:select title="Default Value" property="selection.defaultValue" styleId="defaultValueCoded" onchange="javascript:resetHiddenValue();">
...
<tr class="questionTypeRelatedField dateQuestionType">
    ...
    <td>
        <html:radio title="Mask Yes" styleId="yesFutureEntry" name="manageQuestionsForm" property="selection.futureDateIndCd"  value="<%= NEDSSConstants.TRUE %>"/> Yes
        &nbsp;<html:radio title="Mask No" styleId="noFutureEntry" name="manageQuestionsForm" property="selection.futureDateIndCd"  value="<%= NEDSSConstants.FALSE %>"/> No
    </td>                          
</tr>
...
<tr class="questionTypeRelatedField numericQuestionType">
    ...
    <td id ="questionIdcr">
        <html:text title="Field Length" property="selection.fieldLength" size="20" maxlength="20" styleId="fieldLenNum" />      
    </td>
</tr>
<tr class="questionTypeRelatedField numericQuestionType">
    <td class="fieldName"> 
...
<tr class="questionTypeRelatedField literalUnitType">
    ...
    <td>
       <html:text title="Literal Units Value" property="selection.unitValue" size="15" maxlength="50" styleId="literalUnits" />  
    </td>
</tr>
...
<tr class="questionTypeRelatedField textQuestionType">
    ...
    <td>
        <html:select title="Mask" property="selection.mask" styleId = "maskT">
...
<tr class="questionTypeRelatedField textQuestionType">
    ...
    <td id ="questionIdcr">
        <html:text title="Field Length" property="selection.fieldLength" size="20" maxlength="20" styleId="fieldLenTxt"  onkeyup="isNumericCharacterEntered(this);"/>      
    </td>
</tr>  
<tr class="questionTypeRelatedField textQuestionType">
    <td class="fieldName"> 
