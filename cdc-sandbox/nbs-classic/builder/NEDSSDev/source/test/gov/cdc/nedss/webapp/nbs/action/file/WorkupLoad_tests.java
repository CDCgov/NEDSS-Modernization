...
@SuppressStaticInitializationFor ({"gov.cdc.nedss.webapp.nbs.action.ldf.BaseLdf","gov.cdc.nedss.webapp.nbs.helper.CachedDropDowns","gov.cdc.nedss.webapp.nbs.action.file.WorkupLoad",
...
@PrepareForTest({WorkupLoad.class,NBSContext.class,LogUtils.class,PropertyUtil.class,NEDSSConstants.class})
@PowerMockIgnore("javax.management.*")
public class WorkupLoad_tests {
	...
	@Before
	 public void initMocks() throws Exception {
		 ...
		 Whitebox.setInternalState(PropertyUtil.class,"instance", propertyUtil);
		  Whitebox.setInternalState(WorkupLoad.class, "logger", logger);
	 ...
	 public void getLabReportsDisplayList_test() throws Exception {
		 ...
		 List<PersonReportsSummaryDT> summaryLabReportList =Whitebox.invokeMethod(new WorkupLoad(), "getLabReportsDisplayList", oParams1);
