...
SELECT DISTINCT
       ...
       'NBS' AS SENDING_SYSTEM_CD
FROM NBS_SRTE.STATE_COUNTY_CODE_VALUE A
UNION
SELECT DISTINCT
...
SELECT DISTINCT
       ...
       'NBS' AS SENDING_SYSTEM_CD
FROM NBS_SRTE.CONDITION_CODE A
     INNER JOIN NBS_SRTE.CODESET C ON A.CONDITION_CODESET_NM = C.CODE_SET_NM
     INNER JOIN NBS_ODSE.NBS_ui_metadata B ON B.CODE_SET_GROUP_ID = C.CODE_SET_GROUP_ID
...
UNION
SELECT DISTINCT
       UPPER(from_code) AS ANS_FROM_CODE,
...
UNION
SELECT DISTINCT
       UPPER(to_code) AS ANS_FROM_CODE,
       to_code_system_cd AS ANS_FROM_CODE_SYSTEM_CD,
       to_code_desc_txt AS ANS_FROM_CODE_SYSTEM_DESC_TXT,
       from_code_desc_txt AS ANS_FROM_DISPLAY_NM,
       from_code AS ANS_TO_CODE,
       to_code_system_cd AS ANS_TO_CODE_SYSTEM_CD,
       to_code_desc_txt AS ANS_TO_CODE_SYSTEM_DESC_TXT,
       to_code_desc_txt AS ANS_TO_DISPLAY_NM,
       'YES' AS CODE_TRANSLATION_REQUIRED,
...
SELECT DISTINCT
       ...
       'NBS' AS SENDING_SYSTEM_CD from dual
UNION
SELECT DISTINCT
