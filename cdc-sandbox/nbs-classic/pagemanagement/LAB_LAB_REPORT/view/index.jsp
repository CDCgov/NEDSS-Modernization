<?xml version="1.0" encoding="UTF-8"?>
	...
	<logic:equal name="PageForm" property="businessObjectType" value="ISO">
	...
	<logic:equal name="PageForm" property="businessObjectType" value="SUS">
		  function deleteSubForm() {
...
pgDisableElement('NBS128');
        ...
        function ruleHideUnhNBS4556419()
{
 var foo = [];
...
pgSubSectionShown('NBS_UI_10');
 } else { 
pgSubSectionHidden('NBS_UI_10');
 }
 var foo_2 = [];
...
pgSubSectionShown('NBS_UI_10_2');
 } else { 
pgSubSectionHidden('NBS_UI_10_2');
 }   
}
      
        function ruleHideUnhNBS4556420()
{
 var foo = [];
$j('#NBS455 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
if(foo=='' && $j('#NBS455').html()!=null){foo[0]=$j('#NBS455').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Electronic')==true)){
pgSubSectionShown('NBS_UI_23');
 } else { 
pgSubSectionHidden('NBS_UI_23');
 }
 var foo_2 = [];
$j('#NBS455_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
...
if(foo_2=='' && $j('#NBS455_2').html()!=null){foo_2[0]=$j('#NBS455_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Electronic')==true)){
pgSubSectionShown('NBS_UI_23_2');
 } else { 
pgSubSectionHidden('NBS_UI_23_2');
 }   
}
      
        function ruleHideUnhNBS4556421()
{
 var foo = [];
$j('#NBS455 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
if(foo=='' && $j('#NBS455').html()!=null){foo[0]=$j('#NBS455').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Electronic')==true)){
pgUnhideElement('NBS463');
pgUnhideElement('NBS_LAB269');
pgUnhideElement('NBS462');
pgUnhideElement('NBS_LAB262');
pgUnhideElement('NBS_LAB196');
 } else { 
pgHideElement('NBS463');
pgHideElement('NBS_LAB269');
pgHideElement('NBS462');
pgHideElement('NBS_LAB262');
pgHideElement('NBS_LAB196');
 }
 var foo_2 = [];
$j('#NBS455_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
...
if(foo_2=='' && $j('#NBS455_2').html()!=null){foo_2[0]=$j('#NBS455_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Electronic')==true)){
pgUnhideElement('NBS463_2');
pgUnhideElement('NBS_LAB269_2');
pgUnhideElement('NBS462_2');
pgUnhideElement('NBS_LAB262_2');
pgUnhideElement('NBS_LAB196_2');
 } else { 
pgHideElement('NBS463_2');
pgHideElement('NBS_LAB269_2');
pgHideElement('NBS462_2');
pgHideElement('NBS_LAB262_2');
pgHideElement('NBS_LAB196_2');
 }   
}
      
        function ruleHideUnhNBS4576422()
{
 var foo = [];
$j('#NBS457 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#NBS457').html()!=null){foo[0]=$j('#NBS457').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Electronic')==true)){
pgUnhideElement('NBS_LAB217');
pgUnhideElement('NBS_LAB118');
pgUnhideElement('NBS_LAB121');
pgUnhideElement('NBS_LAB279');
pgUnhideElement('NBS_LAB293');
 } else { 
pgHideElement('NBS_LAB217');
pgHideElement('NBS_LAB118');
pgHideElement('NBS_LAB121');
pgHideElement('NBS_LAB279');
pgHideElement('NBS_LAB293');
 }
 var foo_2 = [];
$j('#NBS457_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#NBS457_2').html()!=null){foo_2[0]=$j('#NBS457_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Electronic')==true)){
pgUnhideElement('NBS_LAB217_2');
pgUnhideElement('NBS_LAB118_2');
pgUnhideElement('NBS_LAB121_2');
pgUnhideElement('NBS_LAB279_2');
pgUnhideElement('NBS_LAB293_2');
 } else { 
pgHideElement('NBS_LAB217_2');
pgHideElement('NBS_LAB118_2');
pgHideElement('NBS_LAB121_2');
pgHideElement('NBS_LAB279_2');
pgHideElement('NBS_LAB293_2');
 }   
}
      
        function ruleHideUnhNBS4556423()
{
 var foo = [];
$j('#NBS455 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
if(foo=='' && $j('#NBS455').html()!=null){foo[0]=$j('#NBS455').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Electronic')==true)){
pgSubSectionShown('NBS_UI_21');
pgSubSectionShown('NBS_UI_30');
 } else { 
pgSubSectionHidden('NBS_UI_21');
pgSubSectionHidden('NBS_UI_30');
 }
 var foo_2 = [];
$j('#NBS455_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
...
if(foo_2=='' && $j('#NBS455_2').html()!=null){foo_2[0]=$j('#NBS455_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Electronic')==true)){
pgSubSectionShown('NBS_UI_21 _2');
pgSubSectionShown('NBS_UI_30_2');
 } else { 
pgSubSectionHidden('NBS_UI_21 _2');
pgSubSectionHidden('NBS_UI_30_2');
 }   
}
      
        function ruleHideUnhNBS4556424()
{
 var foo = [];
$j('#NBS455 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
if(foo=='' && $j('#NBS455').html()!=null){foo[0]=$j('#NBS455').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Electronic')==true)){
pgSubSectionHidden('NBS_UI_29');
 } else { 
pgSubSectionShown('NBS_UI_29');
 }
 var foo_2 = [];
$j('#NBS455_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
...
if(foo_2=='' && $j('#NBS455_2').html()!=null){foo_2[0]=$j('#NBS455_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Electronic')==true)){
pgSubSectionHidden('NBS_UI_29_2');
 } else { 
pgSubSectionShown('NBS_UI_29_2');
 }   
}
      
        function ruleHideUnhNBS4556425()
{
 var foo = [];
$j('#NBS455 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
if(foo=='' && $j('#NBS455').html()!=null){foo[0]=$j('#NBS455').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Electronic')==true)){
pgHideElement('DEM104');
pgHideElement('DEM102');
pgHideElement('DEM105');
pgHideElement('DEM107');
 } else { 
pgUnhideElement('DEM104');
pgUnhideElement('DEM102');
pgUnhideElement('DEM105');
pgUnhideElement('DEM107');
 }
 var foo_2 = [];
$j('#NBS455_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
...
if(foo_2=='' && $j('#NBS455_2').html()!=null){foo_2[0]=$j('#NBS455_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Electronic')==true)){
pgHideElement('DEM104_2');
pgHideElement('DEM102_2');
pgHideElement('DEM105_2');
pgHideElement('DEM107_2');
 } else { 
pgUnhideElement('DEM104_2');
pgUnhideElement('DEM102_2');
pgUnhideElement('DEM105_2');
pgUnhideElement('DEM107_2');
 }   
}
      
        function ruleHideUnhNBS4576426()
{
 var foo = [];
$j('#NBS457 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
if(foo=='' && $j('#NBS457').html()!=null){foo[0]=$j('#NBS457').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Electronic')==true)){
pgHideElement('NBS_LAB329');
 } else { 
pgUnhideElement('NBS_LAB329');
 }
 var foo_2 = [];
$j('#NBS457_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
...
if(foo_2=='' && $j('#NBS457_2').html()!=null){foo_2[0]=$j('#NBS457_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Electronic'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Electronic')==true)){
pgHideElement('NBS_LAB329_2');
 } else { 
pgUnhideElement('NBS_LAB329_2');
 }   
}
       ...
       function pgCheckDynamicRulesHideUnhideOnLoad() {
            ...
            var allfunctions = "ruleEnDisDEM1276416();ruleEnDisDEM1136417();ruleEnDisINV1786418();ruleHideUnhNBS4556419();ruleHideUnhNBS4556420();ruleHideUnhNBS4556421();ruleHideUnhNBS4576422();ruleHideUnhNBS4556423();ruleHideUnhNBS4556424();ruleHideUnhNBS4556425();ruleHideUnhNBS4576426();";
...
var form = getCorrectForm();
	...
	<logic:equal name="PageForm" property="businessObjectType" value="LAB">
...
<%}}%>
	...
	$j($j(document.getElementsByClassName("nedssNavTable")).find("tbody > tr:even").get(0)).css("background-color","#003470");
       ...
       <!-- === batch subsection add edit check functions (if any) follow ===-->
        ...
        function pgRESULTED_TEST_CONTAINERBatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('RESULTED_TEST_CONTAINER');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('RESULTED_TEST_CONTAINERerrorMessages', errorLabels); return false;}
		$j('#RESULTED_TEST_CONTAINERerrorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_21BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_21');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_21errorMessages', errorLabels); return false;}
		$j('#NBS_UI_21errorMessages').css("display", "none");
		return true;
		}
    ...
    String tabId = "";   
      ...
      String [] sectionNames  = {"Patient Information","Order Information","Test Results","Lab Report Comments","Other Information"};
     ;
  ...
  <% String printMode = (request.getAttribute("mode") == null) ? "" : ((String)request.getAttribute("mode"));
    ...
    <logic:notEqual name="PageForm" property="businessObjectType" value="ISO">
    <logic:notEqual name="PageForm"  property="businessObjectType" value="SUS">			
       <logic:notEqual name="PageForm" property="businessObjectType" value="LAB">			
    ...
    <% } %>
	    ...
	    <logic:notEqual name="PageForm" property="genericType" value="GENERIC_NO_POPUP_BUSINESS_OBJECT_TYPE">
	            <div class="popupTitle"> ${BaseForm.pageTitle} </div>
		</logic:notEqual>

         <!-- Top button bar -->
         
		<logic:equal name="PageForm" property="genericType" value="GENERIC_NO_POPUP_BUSINESS_OBJECT_TYPE">
			...
			<div class="popupButtonBar">
				<logic:equal name="PageForm" property="securityMap(editGenericPermission)" value="true">
					...
					<logic:notEqual name="PageForm" property="businessObjectType" value="VAC">
						<logic:equal name="PageForm" property="businessObjectType" value="ISO">
					  	<logic:notEqual name="PageForm" property="actionModeParent" value="View">
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
        ...
        <jsp:include page="viewPatient.jsp"/>
         ...
         <layout:tab key="Lab Report">     
        <jsp:include page="viewLabReport.jsp"/>
        </layout:tab>  
