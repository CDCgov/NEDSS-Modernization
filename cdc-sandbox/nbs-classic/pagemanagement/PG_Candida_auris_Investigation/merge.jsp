...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM113)" styleId="DEM113" title="Patient's current sex." onchange="ruleEnDisDEM1138775();ruleHideUnhINV1788782();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM127)" styleId="DEM127" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1278772();">
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_38" name="Industry and Occupation" isHidden="F" classType="subSect"  addedClass="batchSubSection">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV128)" styleId="INV128" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1288770();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1328776();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV178)" styleId="INV178" title="Assesses whether or not the patient is pregnant." onchange="ruleHideUnhINV1788782();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV145)" styleId="INV145" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1458771();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV150)" styleId="INV150" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1508773();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV152)" styleId="INV152" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1528774();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV502)" styleId="INV502" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_UI_NBS_INV_GENV2_UI_4');ruleEnDisINV5028780();getDWRStatesByCountry(this, 'INV503');">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NOT120)" styleId="NOT120" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1208781();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(TRAVEL38)" styleId="TRAVEL38" title="Did the patient travel internationally in the year prior to the date of specimen collection?" onchange="ruleEnDisTRAVEL388784();ruleEnDis90366_68785();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(90366_6)" styleId="90366_6" title="This data element is used to capture if the patient received overnight healthcare outside of the United States in the year prior to the date of specimen collection." onchange="ruleEnDis90366_68785();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV740)" styleId="INV740" title="Was laboratory testing done to confirm the diagnosis?" onchange="ruleEnDisINV7408786();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS674)" maxlength="25" title="Please enter the performing lab specimen ID number for this lab test." styleId="NBS674" onkeyup="unhideBatchImg('NBS_UI_37');"/>
</td> </tr>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(FDD_Q_1141)" maxlength="25" title="State laboratory specimen identification number." styleId="FDD_Q_1141" onkeyup="unhideBatchImg('NBS_UI_37');"/>
</td> </tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(LAB165)" styleId="LAB165" title="If specimen type is unspecified swab, please provide anatomical site of swab." onchange="unhideBatchImg('NBS_UI_37');enableOrDisableOther('LAB165');">
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS482)" maxlength="50" title="Specify the test method (Text) for the type of test performed for this case (e.g., test brand or software, or type of PCR)." styleId="NBS482" onkeyup="unhideBatchImg('NBS_UI_37');"/>
</td> </tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(90041_5)" styleId="90041_5" title="Indicate the physical location type of the patient when the specimen was collected." onchange="enableOrDisableOther('90041_5');">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(89202_6)" styleId="89202_6" title="County of facility where specimen was collected" onchange="enableOrDisableOther('89202_6');">
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(INV1110_1)" maxlength="30" title="If patient was previously counted as a colonization/screening case (clinical C. auris only) or a CP-CRE case, please provide the related case ID(s)." styleId="INV1110_1"/>
</td> </tr>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(INV1110_2)" maxlength="30" title="If patient was previously counted as a colonization/screening case (clinical C. auris only) or a CP-CRE case, please provide the related case ID(s)." styleId="INV1110_2"/>
</td> </tr>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(INV1110_3)" maxlength="30" title="If patient was previously counted as a colonization/screening case (clinical C. auris only) or a CP-CRE case, please provide the related case ID(s)." styleId="INV1110_3"/>
</td> </tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV1270)" styleId="INV1270" title="Does the patient have a history of infection or colonization with another MDRO?" onchange="ruleEnDisINV12708783();enableOrDisableOther('INV831');">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV636)" styleId="INV636" title="Did the patient have a stay in a long-term care facility in the 90 days before specimen collection date?" onchange="ruleEnDisINV6368787();enableOrDisableOther('INV1120');">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
