...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_39_2" name="Occupation and Industry Information" isHidden="F" classType="subSect" >
...
<tr>
<td class="fieldName">
<span title="Did the patient have Erythema chronica migrans?" id="271807003_2L" >
...
<tr>
<td class="fieldName">
<span title="Did the patient have Atrioventricular block?" id="233917008_2L" >
Atrioventricular block:</span></td><td>
<span id="233917008_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(233917008)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="Did the patient have Lyme arthritis?" id="3723001_2L" >
...
<tr>
<td class="fieldName">
<span title="Did the patient have Bells palsy?" id="193093009_2L" >
Bells palsy:</span></td><td>
<span id="193093009_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(193093009)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="Did the patient have Other Cranial neuritis?" id="48780006_2L" >
Other Cranial neuritis:</span></td><td>
<span id="48780006_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(48780006)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="Did the patient have Radiculoneuropathy (Nerve root disorder)?" id="72274001_2L" >
Radiculoneuropathy:</span></td><td>
<span id="72274001_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(72274001)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="Did the patient have Lymphocytic Meningitis?" id="44201003_2L" >
...
<tr>
<td class="fieldName">
<span title="Did the patient have Encephalomyelitis?" id="62950007_2L" >
Encephalomyelitis:</span></td><td>
<span id="62950007_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(62950007)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="Did the patient receive antibiotics treatment for this infection?" id="255633001_2L" >
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_45_2" name="Antibiotics Treatment Information" isHidden="F" classType="subSect" >
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td width="5%">.</td>
<td   width="90%">
...
<td class="fieldName">
<span style="color:#CC0000">*</span>
<span title="What antibiotic was prescribed to the patient for this infection?" id="29303_5_2L" >
...
<tr><td class="fieldName">
<span title="What antibiotic was prescribed to the patient for this infection?" id="29303_5_2_OthL">Other Medication Administered:</span></td>
<td> <span id="29303_5_2_Oth" /> <nedss:view name="PageForm" property="pageClientVO2.answer(29303_5Oth)"/></td></tr>

<!--processing Date Question-->
<tr><td class="fieldName">
<span title="Date the treatment was prescribed" id="INV924_2L">Treatment Start Date:</span>
</td><td>
<span id="INV924_2"/>
...
<!--processing Numeric Question-->
<tr><td class="fieldName">
<span id="67453_1_2L" title="Prescribed duration (in days) of antibiotic treatment">
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_48_2" name="Interpretative Lab Data Repeating  Block" isHidden="F" classType="subSect" >
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td width="5%">.</td>
<td   width="90%">
...
<td style="width:3%;text-align:center;"><input id="view" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked2(this.id,'NBS_UI_48_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View">
<% for(int i=0;batchrec!=null && i<batchrec.length;i++){%>
<% String validdisplay =batchrec[i][0]; %>
<%    if(batchrec[i][2] != null && batchrec[i][2].equals("Y"))  {%>
<td width="<%=batchrec[i][4]%>%" align="left">
...
<tbody id="noquestionbodyNBS_UI_48_2">
<tr id="nopatternNBS_UI_48_2" class="odd" style="display:none">
<td colspan="<%=batchrec.length+1%>"> <span>&nbsp; No Data has been entered.
</span>
</td>
</tr>
...
<tr>
<td class="fieldName">
<span title="Epidemiologic interpretation of the results of the test(s) performed for this case. This is a qualitative test result.  (e.g., positive, negative, not done)" id="INV291_2L" >
...
<!--Other allowed for this Coded Question-->
<tr><td class="fieldName">
<span title="Epidemiologic interpretation of the results of the test(s) performed for this case. This is a qualitative test result.  (e.g., positive, negative, not done)" id="INV291_2_OthL">Other Test Result:</span></td>
...
<!--Other allowed for this Coded Question-->
<tr><td class="fieldName">
<span title="If Other Arbovirus PCR (Not serum / CSF) was selected as test type, specify the specimen type. List of specimens that are used for Arboviral lab tests include Serum, CSF, Amniotic Fluid, Urine, Semen, Cord blood, etc." id="667469_2_OthL">Other Specimen Type:</span></td>
<td> <span id="667469_2_Oth" /> <nedss:view name="PageForm" property="pageClientVO2.answer(667469Oth)"/></td></tr>

<!--processing Date Question-->
<tr><td class="fieldName">
<span title="Date of collection of laboratory specimen used for diagnosis of health event reported in this case report." id="LAB163_2L">Specimen Collection Date:</span>
</td><td>
<span id="LAB163_2"/>
...
<tr>
<td class="fieldName">
<span title="Antibody to B. burgdorferi higher in CSF than in serum?" id="NBS497_2L" >
Antibody to B. burgdorferi higher in CSF than in serum?:</span></td><td>
<span id="NBS497_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(NBS497)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="CSF tested for antibodies to B. burgdorferi" id="NBS498_2L" >
CSF tested for antibodies to B. burgdorferi?:</span></td><td>
<span id="NBS498_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(NBS498)"
codeSetNm="YNU"/>
</td> </tr>
