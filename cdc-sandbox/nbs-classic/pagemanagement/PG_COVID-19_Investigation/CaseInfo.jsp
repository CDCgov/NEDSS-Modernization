...
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS547)" size="50" maxlength="50" title="CDC-Assigned Case ID" styleId="NBS547"/>
</td> </tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS548)" styleId="NBS548" title="What is the current processing status of this person?" onchange="ruleEnDisNBS5488859();pgSelectNextFocus(this);">
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS552)" size="50" maxlength="50" title="If the PUI or case was first identified through and EpiX notification of travelers, enter the Division of Global Migration and Quarantine ID." styleId="NBS552"/>
</td> </tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS550)" maxlength="10" size="10" styleId="NBS550" onkeyup="DateMask(this,null,event)" title="Date of first positive specimen collection"/>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(309904001)" styleId="309904001" title="Was the patient admitted to an intensive care unit (ICU)?" onchange="ruleEnDis3099040018860();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS679)" maxlength="10" size="10" styleId="NBS679" onkeyup="DateMask(this,null,event)" title="Enter the date of ICU admission."/>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS680)" maxlength="10" size="10" styleId="NBS680" onkeyup="DateMask(this,null,event)" title="Enter the date of ICU discharge."/>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV145)" styleId="INV145" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1458833();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV150)" styleId="INV150" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1508835();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV152)" styleId="INV152" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1528836();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV502)" styleId="INV502" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_UI_NBS_INV_GENV2_UI_4');ruleEnDisINV5028842();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NOT120)" styleId="NOT120" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1208843();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
