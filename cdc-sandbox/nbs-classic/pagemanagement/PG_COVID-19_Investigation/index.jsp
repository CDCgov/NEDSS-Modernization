...
pgDisableElement('INV575');
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1378839();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158840();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158841();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
	...
	<!-- === batch subsection add edit check functions (if any) follow ===-->
     	function pgNBS_UI_GA35001BatchAddFunction()
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_GA35001');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_GA35001errorMessages', errorLabels); return false;}
		$j('#NBS_UI_GA35001errorMessages').css("display", "none");
		return true;
		}
        ...
        function pgNBS_UI_GA35002BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_GA35002');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_GA35002errorMessages', errorLabels); return false;}
		$j('#NBS_UI_GA35002errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_GA21011BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_GA21011');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_GA21011errorMessages', errorLabels); return false;}
		$j('#NBS_UI_GA21011errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_GA23001BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_GA23001');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_GA23001errorMessages', errorLabels); return false;}
		$j('#NBS_UI_GA23001errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_GA23000BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_GA23000');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_GA23000errorMessages', errorLabels); return false;}
		$j('#NBS_UI_GA23000errorMessages').css("display", "none");
		return true;
		}
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
      		...
      		<jsp:include page="CaseInfo.jsp"/>
      		 ...
      		 <layout:tab key="Risk and Exposures">     
      		<jsp:include page="RiskandExposures.jsp"/>
             	</layout:tab>               	
      		 ...
      		 <layout:tab key="Clinical">     
      		<jsp:include page="Clinical.jsp"/>
             	</layout:tab>               	
      		 ...
      		 <layout:tab key="Interpretive Lab">     
      		<jsp:include page="InterpretiveLab.jsp"/>
             	</layout:tab>               	
