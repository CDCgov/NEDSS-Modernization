...
pgSubSectionDisabled('NBS_UI_44');
       ...
       function pgCheckDynamicRulesHideUnhideOnLoad() {
            ...
            var allfunctions = "ruleEnDisINV1288789();ruleEnDisINV1458790();ruleEnDisDEM1278791();ruleEnDisINV1508792();ruleEnDisINV1528793();ruleEnDisDEM1138794();ruleEnDisINV5028799();ruleHideUnhNOT1208800();ruleHideUnhINV1788801();ruleEnDisTRAVEL388802();ruleEnDis90366_68803();ruleEnDisINV7408804();ruleEnDisINV11098805();";
    ...
    <% } %>
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
        ...
        <jsp:include page="viewCP-CRE.jsp"/>
        </layout:tab>  
