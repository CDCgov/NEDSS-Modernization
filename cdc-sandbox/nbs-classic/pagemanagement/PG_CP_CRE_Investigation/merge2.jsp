...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM113)" styleId="DEM113_2" title="Patient's current sex." onchange="ruleEnDisDEM1138794();ruleHideUnhINV1788801();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM127)" styleId="DEM127_2" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1278791();pgSelectNextFocus(this);">
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_38_2" name="Industry and Occupation Information" isHidden="F" classType="subSect"  addedClass="batchSubSection">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV178)" styleId="INV178_2" title="Assesses whether or not the patient is pregnant." onchange="ruleHideUnhINV1788801();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV145)" styleId="INV145_2" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1458790();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV150)" styleId="INV150_2" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1508792();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV152)" styleId="INV152_2" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1528793();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV502)" styleId="INV502_2" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_UI_NBS_INV_GENV2_UI_4');ruleEnDisINV5028799();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NOT120)" styleId="NOT120_2" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1208800();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="TRAVEL38_2L" title="Did the patient travel internationally in the past 1 year from the date of specimen collection?">
Did the patient travel internationally?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(TRAVEL38)" styleId="TRAVEL38_2" title="Did the patient travel internationally in the past 1 year from the date of specimen collection?" onchange="ruleEnDisTRAVEL388802();ruleEnDis90366_68803();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="TRAVEL05_2L" title="List any international destinations of recent travel">
International Destination(s):</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(TRAVEL05)" styleId="TRAVEL05_2" title="List any international destinations of recent travel"
multiple="true" size="4"
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="90366_6_2L" title="This data element is used to capture if the patient received healthcare outside of the United States in the year prior to the date of specimen collection.">
Received Healthcare Outside the USA:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(90366_6)" styleId="90366_6_2" title="This data element is used to capture if the patient received healthcare outside of the United States in the year prior to the date of specimen collection." onchange="ruleEnDis90366_68803();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="91514_0_2L" title="This data element is used to capture if the patient received healthcare outside of the United States in the year prior to the date of specimen collection.">
Countries in which healthcare was received:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(91514_0)" styleId="91514_0_2" title="This data element is used to capture if the patient received healthcare outside of the United States in the year prior to the date of specimen collection."
multiple="true" size="4"
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV740)" styleId="INV740_2" title="Was laboratory testing done to confirm the diagnosis?" onchange="ruleEnDisINV7408804();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_37_2" name="Laboratory Testing Information" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="NBS674_2L" title="Unique isolate or specimen identifier; ID assigned by the local laboratory. Isolate ID is preferred, but if unknown specimen ID is acceptable.">
Performing Lab Specimen or Isolate ID:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(NBS674)"  maxlength="25" title="Unique isolate or specimen identifier; ID assigned by the local laboratory. Isolate ID is preferred, but if unknown specimen ID is acceptable." styleId="NBS674_2" onkeyup="unhideBatchImg('NBS_UI_37');"/>
</td> </tr>

<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="FDD_Q_1141_2L" title="Lab isolate identifier from public health lab for mechanism testing">
State Lab Isolate ID:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(FDD_Q_1141)"  maxlength="25" title="Lab isolate identifier from public health lab for mechanism testing" styleId="FDD_Q_1141_2" onkeyup="unhideBatchImg('NBS_UI_37');"/>
</td> </tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_37 InputFieldLabel" id="667469_2L" title="This indicates the type of specimen tested.">
Specimen Type:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(667469)" styleId="667469_2" title="This indicates the type of specimen tested." onchange="unhideBatchImg('NBS_UI_37');">
<nedss:optionsCollection property="codedValue(SPECIMEN_CP_CRE)" value="key" label="value" /> </html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_37 InputFieldLabel" id="INV290_2L" title="Epidemiologic interpretation of the type of test(s) performed for this case.">
Test Type:</span>
</td>
<td>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_37 InputFieldLabel" id="INV291_2L" title="Result of diagnostic test">
Test Result:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV291)" styleId="INV291_2" title="Result of diagnostic test" onchange="unhideBatchImg('NBS_UI_37');">
...
<tr><td class="fieldName">
<span style="color:#CC0000">*</span>
<span class="requiredInputFieldNBS_UI_37_2 InputFieldLabel" id="LAB278_2L" title="Species identified through testing">
Organism Name:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LAB278)" styleId="LAB278_2" title="Species identified through testing" onchange="unhideBatchImg('NBS_UI_37');enableOrDisableOther('LAB278');pgSelectNextFocus(this);">
...
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(LAB278Oth)" size="40" maxlength="40" title="Other Species identified through testing" onkeyup="unhideBatchImg('NBS_UI_37')" styleId="LAB278_2Oth"/></td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_37 InputFieldLabel" id="85069_3_2L" title="Type of diagnostic test(s) performed for this subject: Complete a minimum of 1 repeat for a case. It is preferable to send a phenotypic and a molecular test for a case.">
Test Method:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(85069_3)" styleId="85069_3_2" title="Type of diagnostic test(s) performed for this subject: Complete a minimum of 1 repeat for a case. It is preferable to send a phenotypic and a molecular test for a case." onchange="unhideBatchImg('NBS_UI_37');enableOrDisableOther('85069_3');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(LAB_TEST_METHOD_CP_CRE)" value="key" label="value" /> </html:select>
</td></tr>
<!--Other entry allowed for this Coded Question-->
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="Type of diagnostic test(s) performed for this subject: Complete a minimum of 1 repeat for a case. It is preferable to send a phenotypic and a molecular test for a case." id="85069_3_2OthL">Other Test Method:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(85069_3Oth)" size="40" maxlength="40" title="Other Type of diagnostic test(s) performed for this subject: Complete a minimum of 1 repeat for a case. It is preferable to send a phenotypic and a molecular test for a case." onkeyup="unhideBatchImg('NBS_UI_37')" styleId="85069_3_2Oth"/></td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_37 InputFieldLabel" id="48018_6_2L" title="Gene identifier">
Gene Identifier:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(48018_6)" styleId="48018_6_2" title="Gene identifier" onchange="unhideBatchImg('NBS_UI_37');enableOrDisableOther('48018_6');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(GENE_NAME_CP_CRE)" value="key" label="value" /> </html:select>
</td></tr>
<!--Other entry allowed for this Coded Question-->
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="Gene identifier" id="48018_6_2OthL">Other Gene Identifier:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(48018_6Oth)" size="40" maxlength="40" title="Other Gene identifier" onkeyup="unhideBatchImg('NBS_UI_37')" styleId="48018_6_2Oth"/></td></tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
}
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(89202_6)" styleId="89202_6_2" title="County of facility where specimen was collected">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV1109_2L" title="Clinical CP-CRE Only: Was patient previously counted as a colonization/screening case?">
Previously counted as a colonization/screening case?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV1109)" styleId="INV1109_2" title="Clinical CP-CRE Only: Was patient previously counted as a colonization/screening case?" onchange="ruleEnDisINV11098805();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="INV1110_1_2L" title="If patient was previously counted as a colonization/screening case (clinical CP-CRE only), please provide the related case ID(s)">
Previously Reported State Case Number 1:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(INV1110_1)" maxlength="30" title="If patient was previously counted as a colonization/screening case (clinical CP-CRE only), please provide the related case ID(s)" styleId="INV1110_1"/>
</td> </tr>

<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="INV1110_2_2L" title="If patient was previously counted as a colonization/screening case (clinical CP-CRE only), please provide the related case ID(s)">
Previously Reported State Case Number 2:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(INV1110_2)" maxlength="30" title="If patient was previously counted as a colonization/screening case (clinical CP-CRE only), please provide the related case ID(s)" styleId="INV1110_2"/>
</td> </tr>

<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="INV1110_3_2L" title="If patient was previously counted as a colonization/screening case (clinical CP-CRE only), please provide the related case ID(s)">
Previously Reported State Case Number 3:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(INV1110_3)" maxlength="30" title="If patient was previously counted as a colonization/screening case (clinical CP-CRE only), please provide the related case ID(s)" styleId="INV1110_3"/>
</td> </tr>
