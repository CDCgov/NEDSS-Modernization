...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS143)" styleId="NBS143" title="For field follow-up, is patient eligible for notification of exposure?" onchange="ruleEnDisNBS1437888();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS168)" styleId="NBS168" title="Do you expect the patient to come in for examination?" onchange="ruleHideUnhNBS1687884();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS192)" styleId="NBS192" title="Indicate the status of interviewing the patient of this investigation." onchange="stdFixedRulePatientInterviewStatusEntry();pgSelectNextFocus(this);">
