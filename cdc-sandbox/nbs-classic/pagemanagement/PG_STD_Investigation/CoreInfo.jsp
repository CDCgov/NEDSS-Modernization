...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV178)" styleId="INV178" title="Assesses whether or not the patient is pregnant." onchange="ruleEnDisINV1787869();ruleRequireIfINV1787870();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS216)" styleId="NBS216" title="Was the patient pregnant at the initial exam for the condition?" onchange="ruleEnDisNBS2167861();ruleRequireIfNBS2167862();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS218)" styleId="NBS218" title="Was the patient pregnant at the time of interview for the condition." onchange="ruleEnDisNBS2187863();ruleRequireIfNBS2187864();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD114)" styleId="STD114" title="Used injection drugs within the past 12 months?" onchange="ruleEnDisSTD1147900();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNRD)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS233)" styleId="NBS233" title="No drug use within the past 12 months?" onchange="ruleEnDisNBS2337898();ruleEnDisNBS2407899();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PHVS_YNRD_CDC)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS240)" styleId="NBS240" title="Other drug use within the past 12 months?" onchange="ruleEnDisNBS2407899();stdOtherDrugEntry();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PHVS_YNRD_CDC)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS242)" styleId="NBS242" title="Places to Meet Partners" onchange="ruleHideUnhNBS2427885();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS244)" styleId="NBS244" title="Places to Have Sex" onchange="ruleHideUnhNBS2447886();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS223)" styleId="NBS223" title="Female partners claimed in the last 12 months?" onchange="ruleEnDisNBS2237874();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS225)" styleId="NBS225" title="Male partners claimed in the last 12 months?" onchange="ruleEnDisNBS2257875();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS227)" styleId="NBS227" title="Transgender partners claimed in the last 12 months?" onchange="ruleEnDisNBS2277876();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS129)" styleId="NBS129" title="Female sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1297871();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS131)" styleId="NBS131" title="Male sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1317872();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS133)" styleId="NBS133" title="Transgender sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1337873();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS275)" styleId="NBS275" title="Have  non-treponemal or treponemal syphilis tests been performed?" onchange="ruleEnDisNBS2757910();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV290)" styleId="INV290" title="Epidemiologic interpretation of the type of test(s) performed for this case." onchange="unhideBatchImg('NBS_INV_STD_UI_71');ruleEnDisINV2907904();ruleEnDisINV2907903();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD117)" styleId="STD117" title="Does the patient have a history of ever having had an STD prior to the condition reported in this case report?" onchange="ruleHideUnhSTD1177887();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS254)" styleId="NBS254" title="Previously tested for 900?" onchange="ruleEnDisNBS2547889();ruleEnDisSTD1067891();ruleRequireIfSTD1067892();ruleRequireIfNBS2547890();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNRUD)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD106)" styleId="STD106" title="Enter the self-reported or documented HIV test result at time of notification.  This should be the most recent test." onchange="ruleEnDisSTD1067891();ruleRequireIfSTD1067892();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS260)" styleId="NBS260" title="Referred for 900 test?" onchange="ruleEnDisNBS2607893();ruleEnDisNBS2627895();ruleRequireIfNBS2627896();;ruleEnDisNBS4477911();ruleRequireIfNBS2607894();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS262)" styleId="NBS262" title="900 test performed at this event?" onchange="ruleEnDisNBS2627895();;ruleEnDisNBS4477911();ruleRequireIfNBS2627896();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS447)" styleId="NBS447" title="Indicate if a client received a syphilis test in conjunction with an HIV test during partner services activities." onchange="ruleEnDisNBS4477911();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS266)" styleId="NBS266" title="Referred to 900 medical care/evaluation/treatment." onchange="ruleEnDisNBS2667897();ruleEnDisNBS2677912();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS267)" styleId="NBS267" title="If referred, did patient keep 1st appointment?" onchange="ruleEnDisNBS2677912();pgSelectNextFocus(this);">
