...
codeSetNm="NBS_INTERVIEW_TYPE_STDHIV"/>
</td> </tr>
...
codeSetNm="NBS_INTVW_LOC_STDHIV"/>
</td> </tr>

<!--processing Coded Question-->
<tr>
<td class="fieldName" valign="top">
<span title="Indicate whether or not contacts were named during this interview." id="STD301L" >
Were contacts named at this interview?:</span></td><td>
<span id="STD301" />
<nedss:view name="PageForm" property="pageClientVO.answer(STD301)"
codeSetNm="YN"/>
</td> </tr>

<!--processing Static Comment-->
<tr><td colspan="2" align="left">&nbsp;&nbsp;Please complete the section below if this interview record is linked to an HIV/AIDS investigation.</td></tr>
...
<td>
<nedss:view name="PageForm" property="pageClientVO.answer(NBS442)"/>
...
<tr>
<td class="fieldName" valign="top">
<span title="The setting in which HIV prevention services are provided. Select the site type that best represents the setting and/or primary type of services offered." id="IXS109L" >
900 Site Type:</span></td><td>
<span id="IXS109" />
<nedss:view name="PageForm" property="pageClientVO.answer(IXS109)"
codeSetNm="NBS_SITE_TYPE_HIV"/>
</td> </tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<tr>
<td class="fieldName" valign="top">
<span title="Document if the patient belongs to locally identified epidemiological groups.  Interventions may be performed for these groups." id="IXS110L" >
Interventions:</span></td><td>
<span id="IXS110" />
<nedss:view name="PageForm" property="pageClientVO.answer(IXS110)"
codeSetNm="NBS_INTERVENTION_HIV"/>
</td> </tr>
</logic:equal>
...
<tr>
<td class="fieldName" valign="top">
<span title="Indicate whether or not the patient was in medical care at the time of the interview event." id="NBS445L" >
Care Status at Interview:</span></td><td>
<span id="NBS445" />
<nedss:view name="PageForm" property="pageClientVO.answer(NBS445)"
