...
pgDisableElement('INV842');
  ...
  function ruleHideUnhINV5757421()
{
 var foo = [];
...
pgHideElement('INV901_2');
  ...
  function ruleHideUnhNOT1207422()
{
 var foo = [];
...
pgHideElement('NOT120SPEC_2');
  ...
  function ruleHideUnhLP38332_07423()
{
 var foo = [];
...
pgHideElement('INV841_2');
  ...
  function ruleHideUnhMTH1617424()
{
 var foo = [];
$j('#MTH161 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#MTH161').html()!=null){foo[0]=$j('#MTH161').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('MTH109');
 } else { 
pgHideElement('MTH109');
 }
 var foo_2 = [];
$j('#MTH161_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#MTH161_2').html()!=null){foo_2[0]=$j('#MTH161_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('MTH109_2');
 } else { 
pgHideElement('MTH109_2');
 }   
}
      
  function ruleHideUnhMTH1627425()
{
 var foo = [];
$j('#MTH162 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#MTH162').html()!=null){foo[0]=$j('#MTH162').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('N',foo) > -1) || ($j.inArray('No'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'No')==true) || ($j.inArray('UNK',foo) > -1) || ($j.inArray(' Unknown'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,' Unknown')==true)){
pgUnhideElement('MTH163');
 } else { 
pgHideElement('MTH163');
 }
 var foo_2 = [];
$j('#MTH162_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#MTH162_2').html()!=null){foo_2[0]=$j('#MTH162_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('N',foo_2) > -1) || ($j.inArray('No'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'No')==true) || ($j.inArray('UNK',foo_2) > -1) || ($j.inArray(' Unknown'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,' Unknown')==true)){
pgUnhideElement('MTH163_2');
 } else { 
pgHideElement('MTH163_2');
 }   
}
      
  function ruleHideUnhMTH1577426()
{
 var foo = [];
$j('#MTH157 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#MTH157').html()!=null){foo[0]=$j('#MTH157').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('5',foo) > -1) || ($j.inArray('Other Race'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Other Race')==true)){
pgUnhideElement('MTH171');
 } else { 
pgHideElement('MTH171');
 }
 var foo_2 = [];
$j('#MTH157_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#MTH157_2').html()!=null){foo_2[0]=$j('#MTH157_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('5',foo_2) > -1) || ($j.inArray('Other Race'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Other Race')==true)){
pgUnhideElement('MTH171_2');
 } else { 
pgHideElement('MTH171_2');
 }   
}
      
  function ruleHideUnhVAC1437427()
{
 var foo = [];
$j('#VAC143 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#VAC143').html()!=null){foo[0]=$j('#VAC143').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('VAC144');
 } else { 
pgHideElement('VAC144');
 }
 var foo_2 = [];
$j('#VAC143_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#VAC143_2').html()!=null){foo_2[0]=$j('#VAC143_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('VAC144_2');
 } else { 
pgHideElement('VAC144_2');
 }   
}
      
  function ruleHideUnhVAC1267428()
{
 var foo = [];
...
pgHideElement('VAC132_2');
  ...
  function ruleHideUnhVAC1267429()
{
 var foo = [];
$j('#VAC126 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
if(foo=='' && $j('#VAC126').html()!=null){foo[0]=$j('#VAC126').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgSubSectionShown('NBS_INV_HEPBP_7');
 } else { 
pgSubSectionHidden('NBS_INV_HEPBP_7');
 }
 var foo_2 = [];
$j('#VAC126_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
...
if(foo_2=='' && $j('#VAC126_2').html()!=null){foo_2[0]=$j('#VAC126_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgSubSectionShown('NBS_INV_HEPBP_7_2');
 } else { 
pgSubSectionHidden('NBS_INV_HEPBP_7_2');
 }   
}
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1377414();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1157415();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1157416();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisINV1287407();ruleEnDisINV1457408();ruleEnDisDEM1277409();ruleEnDisINV1507410();ruleEnDisINV1527411();ruleEnDisDEM1137412();ruleEnDisINV5027417();ruleEnDisINV1787418();ruleEnDisINV5767419();ruleEnDisINV8877420();ruleHideUnhINV5757421();ruleHideUnhNOT1207422();ruleHideUnhLP38332_07423();ruleHideUnhMTH1617424();ruleHideUnhMTH1627425();ruleHideUnhMTH1577426();ruleHideUnhVAC1437427();ruleHideUnhVAC1267428();ruleHideUnhVAC1267429();
	...
	<!-- === batch subsection add edit check functions (if any) follow ===-->
        ...
        function pgNBS_INV_HEPBP_7BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_INV_HEPBP_7');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_INV_HEPBP_7errorMessages', errorLabels); return false;}
		$j('#NBS_INV_HEPBP_7errorMessages').css("display", "none");
		return true;
		}
