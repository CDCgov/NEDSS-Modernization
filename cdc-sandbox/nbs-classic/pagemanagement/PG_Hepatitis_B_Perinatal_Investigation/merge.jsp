...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM113)" styleId="DEM113" title="Patient's current sex." onchange="ruleEnDisDEM1137412();ruleEnDisINV1787418();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM127)" styleId="DEM127" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1277409();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV150)" styleId="INV150" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1507410();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV152)" styleId="INV152" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1527411();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV502)" styleId="INV502" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_INV_HEP_UI_2');ruleEnDisINV5027417();getDWRStatesByCountry(this, 'INV503');">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NOT120)" styleId="NOT120" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1207422();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV576)" styleId="INV576" title="Was the patient symptomatic for the illness of interest?" onchange="ruleEnDisINV5767419();ruleDCompINV1377414();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV128)" styleId="INV128" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1287407();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1327413();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV178)" styleId="INV178" title="Assesses whether or not the patient is pregnant." onchange="ruleEnDisINV1787418();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV145)" styleId="INV145" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457408();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV887)" styleId="INV887" title="Indicate whether the patient has diabetes" onchange="ruleEnDisINV8877420();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(LP38332_0)" styleId="LP38332_0" title="Hepatitis C virus Ab result" onchange="ruleHideUnhLP38332_07423();">
<nedss:optionsCollection property="codedValue(PNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(MTH171)" maxlength="100" title="If other race is selected for the mother, please specify" styleId="MTH171"/>
</td> </tr>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(MTH170)"  maxlength="100" title="If mother's ethnicity is other, specify" styleId="MTH170"/>
</td> </tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(MTH161)" styleId="MTH161" title="Was the patient's mother born outside of the United States?" onchange="ruleHideUnhMTH1617424();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(MTH162)" styleId="MTH162" title="Was the mother confirmed positive for the illness being reported prior to or at the time of delivery?" onchange="ruleHideUnhMTH1627425();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(MTH164)" maxlength="10" size="10" styleId="MTH164" title="Enter the date of the mother's earliest postive test result" onkeyup="DateMask(this,null,event)"/>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(VAC126)" styleId="VAC126" title="Has the child ever received a vaccination for Hepatitis B?" onchange="ruleHideUnhVAC1267429();ruleHideUnhVAC1267428();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td style="width:3%;text-align:center;">
<input id="viewNBS_INV_HEPBP_7" onkeypress="viewClicked(this.id,'NBS_INV_HEPBP_7');return false"" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked(this.id,'NBS_INV_HEPBP_7');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View">
</td><td style="width:3%;text-align:center;">
<input id="editNBS_INV_HEPBP_7" onkeypress="editClicked(this.id,'NBS_INV_HEPBP_7');return false"" type="image" src="page_white_edit.gif" tabIndex="0" onclick="editClicked(this.id,'NBS_INV_HEPBP_7');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit" alt="Edit">
</td><td style="width:3%;text-align:center;">
<input id="deleteNBS_INV_HEPBP_7" onkeypress="deleteClicked(this.id,'NBS_INV_HEPBP_7','patternNBS_INV_HEPBP_7','questionbodyNBS_INV_HEPBP_7');return false"" type="image" src="cross.gif" tabIndex="0" onclick="deleteClicked(this.id,'NBS_INV_HEPBP_7','patternNBS_INV_HEPBP_7','questionbodyNBS_INV_HEPBP_7');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete" alt="Delete">	</td>
<% for(int i=0;batchrec!=null && i<batchrec.length;i++){%>
<% String validdisplay =batchrec[i][0]; %>
<%    if(batchrec[i][4] != null && batchrec[i][2].equals("Y"))  {%>
<% String per = batchrec[i][4];
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(VAC103)" maxlength="10" size="10" styleId="VAC103" title="Enter the date the vaccine was administered" onkeyup="unhideBatchImg('NBS_INV_HEPBP_7');DateMask(this,null,event)" styleClass="NBS_INV_HEPBP_7"/>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(VAC143)" styleId="VAC143" title="Has the patient ever received immune globulin for this condition?" onchange="ruleHideUnhVAC1437427();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(VAC144)" maxlength="10" size="10" styleId="VAC144" title="Date the child received the dose of HBIG." onkeyup="DateMask(this,null,event)"/>
