...
pgDisableElement('INV503');
  ...
  function ruleHideUnhNOT1208602()
{
 var foo = [];
...
pgHideElement('NOT120SPEC_2');
  ...
  function ruleHideUnhINV1788603()
{
 var foo = [];
...
pgSubSectionEnabled('NBS_UI_42');
 } else { 
pgSubSectionDisabled('NBS_UI_44');
pgSubSectionDisabled('NBS_UI_42');
 }   
}
      
  function ruleEnDisINV7408606()
{
 var foo = [];
$j('#INV740 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('LAB515');
pgEnableElement('INV164');
 } else { 
pgDisableElement('LAB515');
pgDisableElement('INV164');
 }   
}
      
  function ruleHideUnhINV5598607()
{
 var foo = [];
$j('#INV559 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#INV559').html()!=null){foo[0]=$j('#INV559').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgSubSectionShown('NBS_UI_54');
 } else { 
pgSubSectionHidden('NBS_UI_54');
 }
 var foo_2 = [];
$j('#INV559_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#INV559_2').html()!=null){foo_2[0]=$j('#INV559_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgSubSectionShown('NBS_UI_54_2');
 } else { 
pgSubSectionHidden('NBS_UI_54_2');
 }   
}
      
  function ruleEnDisINV9078608()
{
 var foo = [];
$j('#INV907 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
...
pgDisableElement('NBS350');
  ...
  function ruleEnDisNBS3548609()
{
 var foo = [];
$j('#NBS354 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('NBS355');
 } else { 
pgDisableElement('NBS355');
 }   
}
      
  function ruleHideUnhNBS3548610()
{
 var foo = [];
$j('#NBS354 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#NBS354').html()!=null){foo[0]=$j('#NBS354').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgSubSectionShown('NBS_UI_57');
 } else { 
pgSubSectionHidden('NBS_UI_57');
 }
 var foo_2 = [];
$j('#NBS354_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#NBS354_2').html()!=null){foo_2[0]=$j('#NBS354_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgSubSectionShown('NBS_UI_57_2');
 } else { 
pgSubSectionHidden('NBS_UI_57_2');
 }   
}
      
  function ruleEnDisINV1788611()
{
 var foo = [];
$j('#INV178 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgDisableElement('NBS364');
 } else { 
pgEnableElement('NBS364');
 }   
}
      
  function ruleEnDisVAC1268612()
{
 var foo = [];
...
pgDisableElement('VAC140');
  ...
  function ruleEnDisNBS3408613()
{
 var foo = [];
$j('#NBS340 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('81308009');
pgEnableElement('91175000');
pgEnableElement('NBS343');
pgEnableElement('INV923');
 } else { 
pgDisableElement('81308009');
pgDisableElement('91175000');
pgDisableElement('NBS343');
pgDisableElement('INV923');
 }   
}
      
  function ruleEnDisINV5768614()
{
 var foo = [];
$j('#INV576 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('49727002');
pgEnableElement('1023001');
pgEnableElement('3415004');
pgEnableElement('43025008');
pgEnableElement('424580008');
pgEnableElement('60537006');
pgEnableElement('NBS338');
 } else { 
pgDisableElement('49727002');
pgDisableElement('1023001');
pgDisableElement('3415004');
pgDisableElement('43025008');
pgDisableElement('424580008');
pgDisableElement('60537006');
pgDisableElement('NBS338');
 }   
}
      
  function ruleHideUnh497270028615()
{
 var foo = [];
$j('#49727002 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#49727002').html()!=null){foo[0]=$j('#49727002').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('INV902');
pgUnhideElement('NBS349');
pgUnhideElement('INV550');
pgUnhideElement('INV555');
pgUnhideElement('INV557');
 } else { 
pgHideElement('INV902');
pgHideElement('NBS349');
pgHideElement('INV550');
pgHideElement('INV555');
pgHideElement('INV557');
 }
 var foo_2 = [];
$j('#49727002_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#49727002_2').html()!=null){foo_2[0]=$j('#49727002_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('INV902_2');
pgUnhideElement('NBS349_2');
pgUnhideElement('INV550_2');
pgUnhideElement('INV555_2');
pgUnhideElement('INV557_2');
 } else { 
pgHideElement('INV902_2');
pgHideElement('NBS349_2');
pgHideElement('INV550_2');
pgHideElement('INV555_2');
pgHideElement('INV557_2');
 }   
}
      
  function ruleEnDisNBS3648616()
{
 var foo = [];
$j('#NBS364 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('NBS347');
pgEnableElement('MTH172');
pgEnableElement('MTH111');
pgEnableElement('NBS346');
pgEnableElement('DEM228');
pgEnableElement('NBS345');
 } else { 
pgDisableElement('NBS347');
pgDisableElement('MTH172');
pgDisableElement('MTH111');
pgDisableElement('NBS346');
pgDisableElement('DEM228');
pgDisableElement('NBS345');
 }   
}
      
  function ruleEnDisMTH1728617()
{
 var foo = [];
$j('#MTH172 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('MTH174');
pgEnableElement('MTH173');
 } else { 
pgDisableElement('MTH174');
pgDisableElement('MTH173');
 }   
}
      
  function ruleHideUnhNBS3438618()
{
 var foo = [];
$j('#NBS343 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#NBS343').html()!=null){foo[0]=$j('#NBS343').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('NBS343_OTH');
 } else { 
pgHideElement('NBS343_OTH');
 }
 var foo_2 = [];
$j('#NBS343_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#NBS343_2').html()!=null){foo_2[0]=$j('#NBS343_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('NBS343_OTH_2');
 } else { 
pgHideElement('NBS343_OTH_2');
 }   
}
      
  function ruleHideUnhNBS3388619()
{
 var foo = [];
$j('#NBS338 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#NBS338').html()!=null){foo[0]=$j('#NBS338').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('NBS338_OTH');
 } else { 
pgHideElement('NBS338_OTH');
 }
 var foo_2 = [];
$j('#NBS338_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#NBS338_2').html()!=null){foo_2[0]=$j('#NBS338_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('NBS338_OTH_2');
 } else { 
pgHideElement('NBS338_OTH_2');
 }   
}
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1378598();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158599();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158600();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisINV1288591();ruleEnDisINV1458592();ruleEnDisDEM1278593();ruleEnDisINV1508594();ruleEnDisINV1528595();ruleEnDisDEM1138596();ruleEnDisINV5028601();ruleHideUnhNOT1208602();ruleHideUnhINV1788603();ruleEnDisVAC1488604();ruleEnDisINV7408605();ruleEnDisINV7408606();ruleHideUnhINV5598607();ruleEnDisINV9078608();ruleEnDisNBS3548609();ruleHideUnhNBS3548610();ruleEnDisINV1788611();ruleEnDisVAC1268612();ruleEnDisNBS3408613();ruleEnDisINV5768614();ruleHideUnh497270028615();ruleEnDisNBS3648616();ruleEnDisMTH1728617();ruleHideUnhNBS3438618();ruleHideUnhNBS3388619();
          
       return;
      }

	<!-- === batch subsection add edit check functions (if any) follow ===-->
     	function pgNBS_UI_45BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_45');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_45errorMessages', errorLabels); return false;}
		$j('#NBS_UI_45errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_INV_GENV2_UI_4BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_INV_GENV2_UI_4');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_INV_GENV2_UI_4errorMessages', errorLabels); return false;}
		$j('#NBS_INV_GENV2_UI_4errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_64BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_64');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_64errorMessages', errorLabels); return false;}
		$j('#NBS_UI_64errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_65BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_65');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_65errorMessages', errorLabels); return false;}
		$j('#NBS_UI_65errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_54BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_54');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_54errorMessages', errorLabels); return false;}
		$j('#NBS_UI_54errorMessages').css("display", "none");
		return true;
		}
        ...
        function pgNBS_UI_42BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_42');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_42errorMessages', errorLabels); return false;}
		$j('#NBS_UI_42errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_57BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_57');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_57errorMessages', errorLabels); return false;}
		$j('#NBS_UI_57errorMessages').css("display", "none");
		return true;
		}
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
      		...
      		<jsp:include page="CaseInfo.jsp"/>
      		 ...
      		 <layout:tab key="Pertussis">     
      		<jsp:include page="Pertussis.jsp"/>
             	</layout:tab>               	
