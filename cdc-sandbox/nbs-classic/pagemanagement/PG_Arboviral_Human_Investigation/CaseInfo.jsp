...
int sectionIndex = 0;
String sectionId = "";
String [] sectionNames  = {"Investigation Information","Reporting Information","Clinical","Pregnancy and Birth Information","Laboratory Findings","Signs and Symptoms","Epidemiologic","General Comments"};
;
%>
<tr><td>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV128)" styleId="INV128" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1287363();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1327369();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(ARB001)" styleId="ARB001" title="Type of arbovirus the case was infected with." onchange="ruleEnDisARB0017376();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(ARB002)" styleId="ARB002" title="Clinical Syndrome is the type of clinical presentation the case had." onchange="ruleEnDisARB0027374();pgSelectNextFocus(this);">
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(ARB002_OTH)" size="30" maxlength="30" title="Specify other clinical syndrome the case had." styleId="ARB002_OTH"/>
</td> </tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(ARB050)" styleId="ARB050" title="Type of clinical presentation the case had." onchange="ruleEnDisARB0507375();pgSelectNextFocus(this);">
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(ARB050_OTH)" size="30" maxlength="30" title="Specify other clinical syndrome secondary the case had." styleId="ARB050_OTH"/>
</td> </tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV145)" styleId="INV145" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457364();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<input id="viewNBS_INV_ARBO_UI_4" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked(this.id,'NBS_INV_ARBO_UI_4');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View">
</td><td style="width:3%;text-align:center;">
<input id="editNBS_INV_ARBO_UI_4" type="image" src="page_white_edit.gif" tabIndex="0" onclick="editClicked(this.id,'NBS_INV_ARBO_UI_4');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit" alt="Edit">
</td><td style="width:3%;text-align:center;">
<input id="deleteNBS_INV_ARBO_UI_4" type="image" src="cross.gif" tabIndex="0" onclick="deleteClicked(this.id,'NBS_INV_ARBO_UI_4','patternNBS_INV_ARBO_UI_4','questionbodyNBS_INV_ARBO_UI_4');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete" alt="Delete">	</td>
<% for(int i=0;i<batchrec.length;i++){%>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(338822)" maxlength="10" size="10" styleId="338822" onkeyup="unhideBatchImg('NBS_INV_ARBO_UI_4');DateMask(this,null,event)" styleClass="NBS_INV_ARBO_UI_4" title="Date the specimen was collected."/>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV150)" styleId="INV150" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1507366();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV152)" styleId="INV152" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1527367();pgSelectNextFocus(this);">
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(ARB014)" maxlength="10" size="10" styleId="ARB014" onkeyup="DateMask(this,null,event)" title="Date of blood donation"/>
