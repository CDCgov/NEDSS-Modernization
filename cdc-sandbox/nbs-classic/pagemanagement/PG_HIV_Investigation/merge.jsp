...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM113)" styleId="DEM113" title="Patient's current sex." onchange="ruleEnDisDEM1137944();ruleEnDisDEM1137941();ruleEnDisINV1787933();ruleRequireIfINV1787934();ruleEnDisINV1787933();ruleRequireIfINV1787934();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM127)" styleId="DEM127" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1277915();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS209)" styleId="NBS209" title="Indicate if the patient is institutionalized (i.e., in jail, in a group home, in a mental health facility, etc.)" onchange="ruleHideUnhNBS2097946();ruleRequireIfNBS2097924();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM155)" styleId="DEM155" title="Indicates if the patient is hispanic or not." onchange="ruleEnDisDEM1557943();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS111)" styleId="NBS111" title="The Initiating Agency which sent the OOJ Contact Report." onchange="ruleEnDisNBS1117931();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV128)" styleId="INV128" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1287913();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1327918();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV145)" styleId="INV145" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457914();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV150)" styleId="INV150" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1507916();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV152)" styleId="INV152" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1527917();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV502)" styleId="INV502" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS11002');ruleEnDisINV5027945();getDWRStatesByCountry(this, 'INV503');">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS136)" styleId="NBS136" title="The disease diagnosis of the patient." onchange="ruleEnDisNBS1367975();ruleEnDisNBS1367974();ruleEnDisNBS1367973();ruleEnDisNBS1367972();ruleEnDisNBS1367971();ruleEnDisNBS1367968();ruleEnDisSTD1027967();ruleEnDisSTD1027967();enableOrDisableOther('102957003');enableOrDisableOther('102957003');ruleEnDisSTD1027967();enableOrDisableOther('102957003');enableOrDisableOther('102957003');stdDiagnosisRelatedFields();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NOT120)" styleId="NOT120" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1207947();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD102)" styleId="STD102" title="Neurological Involvement?" onchange="ruleEnDisSTD1027967();enableOrDisableOther('102957003');enableOrDisableOther('102957003');">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS143)" styleId="NBS143" title="For field follow-up, is patient eligible for notification of exposure?" onchange="ruleEnDisNBS1437952();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS168)" styleId="NBS168" title="Do you expect the patient to come in for examination?" onchange="ruleHideUnhNBS1687948();">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS192)" styleId="NBS192" title="Indicate the status of interviewing the patient of this investigation." onchange="ruleEnDisNBS1927962();ruleEnDisNBS2767963();stdFixedRulePatientInterviewStatusEntry();">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="NBS276L" title="Provide reason for not being able to locate the 900 case patient for interview.">
Reason Unable to Locate 900 Case:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS276)" styleId="NBS276" title="Provide reason for not being able to locate the 900 case patient for interview." onchange="ruleEnDisNBS2767963();">
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="NBS277L" title="Describe other reason for not being able to locate the 900 case patient for interview.">
Other Reason, Specify:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS277)" maxlength="50" title="Describe other reason for not being able to locate the 900 case patient for interview." styleId="NBS277"/>
</td> </tr>
</logic:equal>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV178)" styleId="INV178" title="Assesses whether or not the patient is pregnant." onchange="ruleEnDisINV1787933();ruleRequireIfINV1787934();">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS216)" styleId="NBS216" title="Was the patient pregnant at the initial exam for the condition?" onchange="ruleEnDisNBS2167925();ruleRequireIfNBS2167926();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS218)" styleId="NBS218" title="Was the patient pregnant at the time of interview for the condition." onchange="ruleEnDisNBS2187927();ruleRequireIfNBS2187928();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD114)" styleId="STD114" title="Used injection drugs within the past 12 months?" onchange="ruleEnDisSTD1147966();">
<nedss:optionsCollection property="codedValue(YNRD)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS233)" styleId="NBS233" title="No drug use within the past 12 months?" onchange="ruleEnDisNBS2337964();ruleEnDisNBS2407965();">
<nedss:optionsCollection property="codedValue(PHVS_YNRD_CDC)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS240)" styleId="NBS240" title="Other drug use within the past 12 months?" onchange="ruleEnDisNBS2407965();stdOtherDrugEntry();">
<nedss:optionsCollection property="codedValue(PHVS_YNRD_CDC)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS242)" styleId="NBS242" title="Places to Meet Partners" onchange="ruleHideUnhNBS2427949();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS244)" styleId="NBS244" title="Places to Have Sex" onchange="ruleHideUnhNBS2447950();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS223)" styleId="NBS223" title="Female partners claimed in the last 12 months?" onchange="ruleEnDisNBS2237938();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS225)" styleId="NBS225" title="Male partners claimed in the last 12 months?" onchange="ruleEnDisNBS2257939();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS227)" styleId="NBS227" title="Transgender partners claimed in the last 12 months?" onchange="ruleEnDisNBS2277940();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS129)" styleId="NBS129" title="Female sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1297935();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS131)" styleId="NBS131" title="Male sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1317936();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS133)" styleId="NBS133" title="Transgender sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1337937();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS275)" styleId="NBS275" title="Have  non-treponemal or treponemal syphilis tests been performed?" onchange="ruleEnDisNBS2757978();">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV290)" styleId="INV290" title="Epidemiologic interpretation of the type of test(s) performed for this case." onchange="unhideBatchImg('NBS_INV_STD_UI_71');ruleEnDisINV2907970();ruleEnDisINV2907969();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD117)" styleId="STD117" title="Does the patient have a history of ever having had an STD prior to the condition reported in this case report?" onchange="ruleHideUnhSTD1177951();">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS254)" styleId="NBS254" title="Previously tested for 900?" onchange="ruleEnDisNBS2547953();ruleEnDisSTD1067955();ruleRequireIfSTD1067956();ruleRequireIfNBS2547954();">
<nedss:optionsCollection property="codedValue(YNRUD)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD106)" styleId="STD106" title="Enter the self-reported or documented HIV test result at time of notification.  This should be the most recent test." onchange="ruleEnDisSTD1067955();ruleRequireIfSTD1067956();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS260)" styleId="NBS260" title="Referred for 900 test?" onchange="ruleEnDisNBS2607957();ruleEnDisNBS2627959();ruleRequireIfNBS2627960();;ruleEnDisNBS4477976();ruleRequireIfNBS2607958();">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS262)" styleId="NBS262" title="900 test performed at this event?" onchange="ruleEnDisNBS2627959();;ruleEnDisNBS4477976();ruleRequireIfNBS2627960();">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS447)" styleId="NBS447" title="Indicate if a client received a syphilis test in conjunction with an HIV test during partner services activities." onchange="ruleEnDisNBS4477976();">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS266)" styleId="NBS266" title="Referred to 900 medical care/evaluation/treatment." onchange="ruleEnDisNBS2667961();ruleEnDisNBS2677977();">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS267)" styleId="NBS267" title="If referred, did patient keep 1st appointment?" onchange="ruleEnDisNBS2677977();">
