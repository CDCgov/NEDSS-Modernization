...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM113)" styleId="DEM113_2" title="Patient's current sex." onchange="ruleEnDisDEM1137944();ruleEnDisDEM1137941();ruleEnDisINV1787933();ruleRequireIfINV1787934();ruleEnDisINV1787933();ruleRequireIfINV1787934();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM127)" styleId="DEM127_2" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1277915();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS209)" styleId="NBS209_2" title="Indicate if the patient is institutionalized (i.e., in jail, in a group home, in a mental health facility, etc.)" onchange="ruleHideUnhNBS2097946();ruleRequireIfNBS2097924();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM155)" styleId="DEM155_2" title="Indicates if the patient is hispanic or not." onchange="ruleEnDisDEM1557943();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS111)" styleId="NBS111_2" title="The Initiating Agency which sent the OOJ Contact Report." onchange="ruleEnDisNBS1117931();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV145)" styleId="INV145_2" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457914();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV150)" styleId="INV150_2" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1507916();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV152)" styleId="INV152_2" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1527917();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV502)" styleId="INV502_2" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS11002');ruleEnDisINV5027945();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS136)" styleId="NBS136_2" title="The disease diagnosis of the patient." onchange="ruleEnDisNBS1367975();ruleEnDisNBS1367974();ruleEnDisNBS1367973();ruleEnDisNBS1367972();ruleEnDisNBS1367971();ruleEnDisNBS1367968();ruleEnDisSTD1027967();ruleEnDisSTD1027967();enableOrDisableOther('102957003');enableOrDisableOther('102957003');ruleEnDisSTD1027967();enableOrDisableOther('102957003');enableOrDisableOther('102957003');stdDiagnosisRelatedFields();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NOT120)" styleId="NOT120_2" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1207947();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(STD102)" styleId="STD102_2" title="Neurological Involvement?" onchange="ruleEnDisSTD1027967();enableOrDisableOther('102957003');enableOrDisableOther('102957003');pgSelectNextFocus(this);">
...
<nedss:optionsCollection property="codedValue(PRVDR_DIAGNOSIS_HIV)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS143)" styleId="NBS143_2" title="For field follow-up, is patient eligible for notification of exposure?" onchange="ruleEnDisNBS1437952();pgSelectNextFocus(this);">
...
<nedss:optionsCollection property="codedValue(NOTIFICATION_ACTUAL_METHOD_HIV)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS168)" styleId="NBS168_2" title="Do you expect the patient to come in for examination?" onchange="ruleHideUnhNBS1687948();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<nedss:optionsCollection property="codedValue(FIELD_FOLLOWUP_DISPOSITION_HIV)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS192)" styleId="NBS192_2" title="Indicate the status of interviewing the patient of this investigation." onchange="ruleEnDisNBS1927962();ruleEnDisNBS2767963();stdFixedRulePatientInterviewStatusEntry();pgSelectNextFocus(this);">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="NBS276_2L" title="Provide reason for not being able to locate the 900 case patient for interview.">
Reason Unable to Locate 900 Case:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS276)" styleId="NBS276_2" title="Provide reason for not being able to locate the 900 case patient for interview." onchange="ruleEnDisNBS2767963();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(HIV_REASON_NOT_LOCATE)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap2.hasHIVPermissions" value="T">
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="NBS277_2L" title="Describe other reason for not being able to locate the 900 case patient for interview.">
Other Reason, Specify:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(NBS277)" maxlength="50" title="Describe other reason for not being able to locate the 900 case patient for interview." styleId="NBS277"/>
</td> </tr>
</logic:equal>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV178)" styleId="INV178_2" title="Assesses whether or not the patient is pregnant." onchange="ruleEnDisINV1787933();ruleRequireIfINV1787934();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS216)" styleId="NBS216_2" title="Was the patient pregnant at the initial exam for the condition?" onchange="ruleEnDisNBS2167925();ruleRequireIfNBS2167926();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS218)" styleId="NBS218_2" title="Was the patient pregnant at the time of interview for the condition." onchange="ruleEnDisNBS2187927();ruleRequireIfNBS2187928();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(STD114)" styleId="STD114_2" title="Used injection drugs within the past 12 months?" onchange="ruleEnDisSTD1147966();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNRD)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS233)" styleId="NBS233_2" title="No drug use within the past 12 months?" onchange="ruleEnDisNBS2337964();ruleEnDisNBS2407965();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PHVS_YNRD_CDC)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS240)" styleId="NBS240_2" title="Other drug use within the past 12 months?" onchange="ruleEnDisNBS2407965();stdOtherDrugEntry();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PHVS_YNRD_CDC)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS242)" styleId="NBS242_2" title="Places to Meet Partners" onchange="ruleHideUnhNBS2427949();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS244)" styleId="NBS244_2" title="Places to Have Sex" onchange="ruleHideUnhNBS2447950();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS223)" styleId="NBS223_2" title="Female partners claimed in the last 12 months?" onchange="ruleEnDisNBS2237938();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS225)" styleId="NBS225_2" title="Male partners claimed in the last 12 months?" onchange="ruleEnDisNBS2257939();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS227)" styleId="NBS227_2" title="Transgender partners claimed in the last 12 months?" onchange="ruleEnDisNBS2277940();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS129)" styleId="NBS129_2" title="Female sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1297935();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS131)" styleId="NBS131_2" title="Male sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1317936();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS133)" styleId="NBS133_2" title="Transgender sex/needle-sharing interview period partners claimed?" onchange="ruleEnDisNBS1337937();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS275)" styleId="NBS275_2" title="Have  non-treponemal or treponemal syphilis tests been performed?" onchange="ruleEnDisNBS2757978();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV290)" styleId="INV290_2" title="Epidemiologic interpretation of the type of test(s) performed for this case." onchange="unhideBatchImg('NBS_INV_STD_UI_71');ruleEnDisINV2907970();ruleEnDisINV2907969();pgSelectNextFocus(this);">
...
multiple="true" size="4"
onchange="unhideBatchImg('NBS_INV_STD_UI_61');displaySelectedOptions(this, 'STD121_2-selectedValues');ruleEnDisSTD1217942()" >
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(STD117)" styleId="STD117_2" title="Does the patient have a history of ever having had an STD prior to the condition reported in this case report?" onchange="ruleHideUnhSTD1177951();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNUR)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS254)" styleId="NBS254_2" title="Previously tested for 900?" onchange="ruleEnDisNBS2547953();ruleEnDisSTD1067955();ruleRequireIfSTD1067956();ruleRequireIfNBS2547954();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNRUD)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap2.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(STD106)" styleId="STD106_2" title="Enter the self-reported or documented HIV test result at time of notification.  This should be the most recent test." onchange="ruleEnDisSTD1067955();ruleRequireIfSTD1067956();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS260)" styleId="NBS260_2" title="Referred for 900 test?" onchange="ruleEnDisNBS2607957();ruleEnDisNBS2627959();ruleRequireIfNBS2627960();;ruleEnDisNBS4477976();ruleRequireIfNBS2607958();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap2.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS262)" styleId="NBS262_2" title="900 test performed at this event?" onchange="ruleEnDisNBS2627959();;ruleEnDisNBS4477976();ruleRequireIfNBS2627960();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS447)" styleId="NBS447_2" title="Indicate if a client received a syphilis test in conjunction with an HIV test during partner services activities." onchange="ruleEnDisNBS4477976();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS266)" styleId="NBS266_2" title="Referred to 900 medical care/evaluation/treatment." onchange="ruleEnDisNBS2667961();ruleEnDisNBS2677977();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap2.hasHIVPermissions" value="T">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS267)" styleId="NBS267_2" title="If referred, did patient keep 1st appointment?" onchange="ruleEnDisNBS2677977();pgSelectNextFocus(this);">
