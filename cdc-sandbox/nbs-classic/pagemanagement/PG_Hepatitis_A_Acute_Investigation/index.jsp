...
pgDisableElement('INV137');
  ...
  function ruleEnDisTRAVEL307500()
{
 var foo = [];
$j('#TRAVEL30 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('TRAVEL31');
pgEnableElement('TRAVEL16');
 } else { 
pgDisableElement('TRAVEL31');
pgDisableElement('TRAVEL16');
 }   
}
      
  function ruleEnDisTRAVEL327501()
{
 var foo = [];
$j('#TRAVEL32 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('TRAVEL33');
 } else { 
pgDisableElement('TRAVEL33');
 }   
}
      
  function ruleEnDisINV8877502()
{
 var foo = [];
...
pgDisableElement('INV842');
  ...
  function ruleEnDisINV6187503()
{
 var foo = [];
$j('#INV618 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('INV613');
pgEnableElement('INV609');
pgEnableElement('INV610');
pgEnableElement('INV612');
pgEnableElement('INV611');
 } else { 
pgDisableElement('INV613');
pgDisableElement('INV609');
pgDisableElement('INV610');
pgDisableElement('INV612');
pgDisableElement('INV611');
 }   
}
      
  function ruleHideUnhINV6027504()
{
 var foo = [];
...
pgSubSectionShown('NBS_INV_HEPA_UI_4');
 } else { 
pgSubSectionHidden('NBS_INV_HEPA_UI_4');
 }
 var foo_2 = [];
...
pgSubSectionShown('NBS_INV_HEPA_UI_4_2');
 } else { 
pgSubSectionHidden('NBS_INV_HEPA_UI_4_2');
 }   
}
      
  function ruleHideUnhVAC1267505()
{
 var foo = [];
...
pgHideElement('VAC142b_2');
  ...
  function ruleHideUnhINV5757506()
{
 var foo = [];
...
pgHideElement('INV901_2');
  ...
  function ruleHideUnhNOT1207507()
{
 var foo = [];
...
pgHideElement('NOT120SPEC_2');
  ...
  function ruleHideUnhLP38332_07508()
{
 var foo = [];
...
pgHideElement('INV841_2');
  ...
  function ruleHideUnhINV603_67509()
{
 var foo = [];
...
pgHideElement('INV897_2');
  ...
  function ruleHideUnhVAC1437510()
{
 var foo = [];
...
pgHideElement('VAC144_2');
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1377494();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1157495();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1157496();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisINV1287487();ruleEnDisINV1457488();ruleEnDisDEM1277489();ruleEnDisINV1507490();ruleEnDisINV1527491();ruleEnDisDEM1137492();ruleEnDisINV5027497();ruleEnDisINV1787498();ruleEnDisINV5767499();ruleEnDisTRAVEL307500();ruleEnDisTRAVEL327501();ruleEnDisINV8877502();ruleEnDisINV6187503();ruleHideUnhINV6027504();ruleHideUnhVAC1267505();ruleHideUnhINV5757506();ruleHideUnhNOT1207507();ruleHideUnhLP38332_07508();ruleHideUnhINV603_67509();ruleHideUnhVAC1437510();
