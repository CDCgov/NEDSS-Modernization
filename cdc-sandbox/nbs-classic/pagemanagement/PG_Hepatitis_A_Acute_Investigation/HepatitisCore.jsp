...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV576)" styleId="INV576" title="Was the patient symptomatic for the illness of interest?" onchange="ruleEnDisINV5767499();ruleDCompINV1377494();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV128)" styleId="INV128" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1287487();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1327493();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV178)" styleId="INV178" title="Assesses whether or not the patient is pregnant." onchange="ruleEnDisINV1787498();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV145)" styleId="INV145" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457488();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV887)" styleId="INV887" title="Indicate whether the patient has diabetes" onchange="ruleEnDisINV8877502();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr><td colspan="2" align="left"><span id="NBS_INV_HEPA_UI_15L"><hr/></span> </td></tr>
...
<!--processing Static Line Separator-->
<tr><td colspan="2" align="left"><span id="NBS_INV_HEPA_UI_16L"><hr/></span> </td></tr>
...
<!--processing Static Line Separator-->
<tr><td colspan="2" align="left"><span id="NBS_INV_HEPA_UI_17L"><hr/></span> </td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(LP38332_0)" styleId="LP38332_0" title="Hepatitis C virus Ab result" onchange="ruleHideUnhLP38332_07508();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Static Line Separator-->
<tr><td colspan="2" align="left"><span id="NBS_INV_HEPA_UI_18L"><hr/></span> </td></tr>
