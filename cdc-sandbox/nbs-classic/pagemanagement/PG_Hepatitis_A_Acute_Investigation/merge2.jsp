...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM113)" styleId="DEM113_2" title="Patient's current sex." onchange="ruleEnDisDEM1137492();ruleEnDisINV1787498();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM127)" styleId="DEM127_2" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1277489();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV150)" styleId="INV150_2" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1507490();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV152)" styleId="INV152_2" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1527491();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV502)" styleId="INV502_2" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_INV_HEP_UI_2');ruleEnDisINV5027497();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NOT120)" styleId="NOT120_2" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1207507();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
multiple="true" size="4"
onchange="displaySelectedOptions(this, 'INV575_2-selectedValues');ruleHideUnhINV5757506()" >
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV576)" styleId="INV576_2" title="Was the patient symptomatic for the illness of interest?" onchange="ruleEnDisINV5767499();ruleDCompINV1377494();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV178)" styleId="INV178_2" title="Assesses whether or not the patient is pregnant." onchange="ruleEnDisINV1787498();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV145)" styleId="INV145_2" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457488();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV887)" styleId="INV887_2" title="Indicate whether the patient has diabetes" onchange="ruleEnDisINV8877502();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="LP38316_3_2L" title="Total antibody to Hepatitis A virus">
total anti-HAV Result:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LP38316_3)" styleId="LP38316_3_2" title="Total antibody to Hepatitis A virus">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="LP38318_9_2L" title="IgM antibody to Hepatitis A virus">
IgM anti-HAV Result:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LP38318_9)" styleId="LP38318_9_2" title="IgM antibody to Hepatitis A virus">
<nedss:optionsCollection property="codedValue(PNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LP38332_0)" styleId="LP38332_0_2" title="Hepatitis C virus Ab result" onchange="ruleHideUnhLP38332_07508();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV217_2L" title="If this case has a diagnosis of Hepatitis A that has not been serologically confirmed, is there an epidemiologic link between this pataient and a laboratory-confirmed heptatitis A case?">
Is there an epidemiologic link between this patient and a laboratory-confirmed case of Hepatitis A?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV217)" styleId="INV217_2" title="If this case has a diagnosis of Hepatitis A that has not been serologically confirmed, is there an epidemiologic link between this pataient and a laboratory-confirmed heptatitis A case?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV602_2L" title="During the 2-6 weeks prior to the onset of symptoms, was the subject a contact of a person with confirmed or suspected hepatitis A virus infection?">
During the 2-6 weeks prior to onset, was patient a contact of a confirmed or suspected case?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV602)" styleId="INV602_2" title="During the 2-6 weeks prior to the onset of symptoms, was the subject a contact of a person with confirmed or suspected hepatitis A virus infection?" onchange="ruleHideUnhINV6027504();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV603_2_2L" title="If the patient was a contact of a confirmed or suspected case, was the contact a child cared for by this patient?">
Child Cared For By This Patient (Contact Type):</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV603_2)" styleId="INV603_2_2" title="If the patient was a contact of a confirmed or suspected case, was the contact a child cared for by this patient?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV603_1_2L" title="If the patient was a contact of a confirmed or suspected case, was the contact a babysitter of this patient?">
Babysitter of This Patient (Contact Type):</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV603_1)" styleId="INV603_1_2" title="If the patient was a contact of a confirmed or suspected case, was the contact a babysitter of this patient?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV603_4_2L" title="If the patient was a contact of a confirmed or suspected case, was the contact a playmate?">
Playmate (Contact Type):</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV603_4)" styleId="INV603_4_2" title="If the patient was a contact of a confirmed or suspected case, was the contact a playmate?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV603_6)" styleId="INV603_6_2" title="If the patient was a contact of a confirmed or suspected case, was the contact type other?" onchange="ruleHideUnhINV603_67509();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV615_2L" title="During the 2-6 weeks prior to the onset of symptoms, was the patient a child or employee in daycare center, nursery, or preschool?">
A Child or Employee in a Day Care Center/Nursery/Preschool:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV615)" styleId="INV615_2" title="During the 2-6 weeks prior to the onset of symptoms, was the patient a child or employee in daycare center, nursery, or preschool?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV616_2L" title="During the 2-6 weeks prior to the onset of symptoms, was the patient a household contact of a child or employee in a daycare center, nursery, or preschool?">
A Household Contact of a Child or Employee in a Day Care/Nursery/Preschool:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV616)" styleId="INV616_2" title="During the 2-6 weeks prior to the onset of symptoms, was the patient a household contact of a child or employee in a daycare center, nursery, or preschool?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV896_2L" title="If the patient was a child or employee or  a household contact of a child or employee in a child care facility, was there an identified hepatitis case in the childcare facility?">
If yes for either of these, was there an identified hepatitis case in the child care facility?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV896)" styleId="INV896_2" title="If the patient was a child or employee or  a household contact of a child or employee in a child care facility, was there an identified hepatitis case in the childcare facility?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV605_2L" title="During the time period prior to the onset of symptoms, number of male sex partners the person had.">
How many male sex partners did the patient have?:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(INV605)" size="4" maxlength="4"  title="During the time period prior to the onset of symptoms, number of male sex partners the person had." styleId="INV605_2" onkeyup="isNumericCharacterEntered(this)"/>
</td></tr>

<!--processing Numeric Question-->
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV606_2L" title="During the time period prior to the onset of symptoms, number of female sex partners the person had.">
How many female sex partners did the patient have?:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(INV606)" size="4" maxlength="4"  title="During the time period prior to the onset of symptoms, number of female sex partners the person had." styleId="INV606_2" onkeyup="isNumericCharacterEntered(this)"/>
</td></tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV607_2L" title="During the time period prior to the onset of symptoms, did the subject inject drugs?">
Did the patient inject drugs?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV607)" styleId="INV607_2" title="During the time period prior to the onset of symptoms, did the subject inject drugs?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="TRAVEL30_2L" title="During the 2-6 weeks prior to the onset of symptoms, did the subject travel or live outside the U.S.A. or Canada?">
In the 2-6 weeks prior to onset, did the patient travel or live outside of the US or Canada?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(TRAVEL30)" styleId="TRAVEL30_2" title="During the 2-6 weeks prior to the onset of symptoms, did the subject travel or live outside the U.S.A. or Canada?" onchange="ruleEnDisTRAVEL307500();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="TRAVEL31_2L" title="The country(s) to which the subject traveled or lived (outside the U.S.A. or Canada) prior to symptom onset.">
If the patient traveled, where (select all that apply)?:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(TRAVEL31)" styleId="TRAVEL31_2" title="The country(s) to which the subject traveled or lived (outside the U.S.A. or Canada) prior to symptom onset."
multiple="true" size="4"
onchange="displaySelectedOptions(this, 'TRAVEL31_2-selectedValues')" >
<nedss:optionsCollection property="codedValue(PHVS_BIRTHCOUNTRY_CDC)" value="key" label="value" /> </html:select>
<div id="TRAVEL31_2-selectedValues" style="margin:0.25em;">
<b> Selected Values: </b>
</div>
</div></td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="TRAVEL16_2L" title="Principal Reason for Travel">
Principal Reason for Travel:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(TRAVEL16)" styleId="TRAVEL16_2" title="Principal Reason for Travel">
<nedss:optionsCollection property="codedValue(PHVS_TRAVELREASON_HEPATITISA)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="TRAVEL32_2L" title="During the 3 months prior to the onset of symptoms, did anyone in the subject's household travel outside the U.S.A. or Canada?">
During 3 months prior to onset, did anyone in patient's household travel outside of US or Canada?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(TRAVEL32)" styleId="TRAVEL32_2" title="During the 3 months prior to the onset of symptoms, did anyone in the subject's household travel outside the U.S.A. or Canada?" onchange="ruleEnDisTRAVEL327501();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="TRAVEL33_2L" title="The country(s) to which anyone in the subject's household traveled (outside the U.S.A. or Canada) prior to symptom onset.">
If someone in patient's household traveled, where (select all that apply)?:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(TRAVEL33)" styleId="TRAVEL33_2" title="The country(s) to which anyone in the subject's household traveled (outside the U.S.A. or Canada) prior to symptom onset."
multiple="true" size="4"
onchange="displaySelectedOptions(this, 'TRAVEL33_2-selectedValues')" >
<nedss:optionsCollection property="codedValue(PHVS_BIRTHCOUNTRY_CDC)" value="key" label="value" /> </html:select>
<div id="TRAVEL33_2-selectedValues" style="margin:0.25em;">
<b> Selected Values: </b>
</div>
</div></td></tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV618_2L" title="Is the subject suspected as being part of a common-source outbreak?">
Is the patient suspected as being part of a common-source outbreak?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV618)" styleId="INV618_2" title="Is the subject suspected as being part of a common-source outbreak?" onchange="ruleEnDisINV6187503();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV609_2L" title="If outbreak assoicated, was the patient associated with a foodborne outbreak that is associated with an infected food handler?">
Was the outbreak Foodborne - Associated with Infected Food Handler?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV609)" styleId="INV609_2" title="If outbreak assoicated, was the patient associated with a foodborne outbreak that is associated with an infected food handler?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV610_2L" title="If the patient is associated with an outbreak, is the patient associated with a foodborne outbreak that is not associated with an infected food handler?">
Was the outbreak Foodborne - NOT Associated With an Infected Food Handler?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV610)" styleId="INV610_2" title="If the patient is associated with an outbreak, is the patient associated with a foodborne outbreak that is not associated with an infected food handler?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="INV611_2L" title="Food item with which the foodborne outbreak is associated.">
Specify Food Item:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(INV611)" maxlength="100" title="Food item with which the foodborne outbreak is associated." styleId="INV611"/>
</td> </tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV612_2L" title="If assoicated with an outbreak, was the patient associated with a waterborne outbreak?">
Was the outbreak waterborne?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV612)" styleId="INV612_2" title="If assoicated with an outbreak, was the patient associated with a waterborne outbreak?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV613_2L" title="If associated with an outbreak, is patient associated with an outbreak that does not have an identifed source?">
Was the oubreak source not identified?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV613)" styleId="INV613_2" title="If associated with an outbreak, is patient associated with an outbreak that does not have an identifed source?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV621_2L" title="During the 2 weeks prior to the onset of symptoms or while ill, was the subject employed as a food handler?">
Was the patient employed as a food handler during the TWO WEEKS prior to onset or while ill?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV621)" styleId="INV621_2" title="During the 2 weeks prior to the onset of symptoms or while ill, was the subject employed as a food handler?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="VAC126_2L" title="Did patient ever receive a hepatitis-containing vaccine? If this is a hepatitis A investigation, answer this question regarding hepatitis A-containing vaccine. If it is a hepatitis B investigation, answer this question regarding hepatitis B-containing vaccine.">
Did patient ever receive a hepatitis A-containing vaccine?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(VAC126)" styleId="VAC126_2" title="Did patient ever receive a hepatitis-containing vaccine? If this is a hepatitis A investigation, answer this question regarding hepatitis A-containing vaccine. If it is a hepatitis B investigation, answer this question regarding hepatitis B-containing vaccine." onchange="ruleHideUnhVAC1267505();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="VAC143_2L" title="Has the patient ever received immune globulin for this condition?">
Has the patient ever received immune globulin?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(VAC143)" styleId="VAC143_2" title="Has the patient ever received immune globulin for this condition?" onchange="ruleHideUnhVAC1437510();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="VAC144_2L" title="Date the patient received the last dose of immune globulin. For example, if the patient received the last dose in 2012, enter 01/01/2012. To convey an unknown date, enter 00/00/0000.">
When was the last dose of IG received?:</span>
</td>
<td>
<html:text name="PageForm" title="Date the patient received the last dose of immune globulin. For example, if the patient received the last dose in 2012, enter 01/01/2012. To convey an unknown date, enter 00/00/0000."  property="pageClientVO2.answer(VAC144)" maxlength="10" size="10" styleId="VAC144_2" onkeyup="DateMask(this,null,event)"/>
</td> </tr>
</nedss:container>
</nedss:container>
</div> </td></tr>
