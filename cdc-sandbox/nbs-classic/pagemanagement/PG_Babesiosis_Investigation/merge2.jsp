...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM113)" styleId="DEM113_2" title="Patient's current sex." onchange="ruleEnDisDEM1138303();ruleHideUnhINV1788310();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM127)" styleId="DEM127_2" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1278300();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV128)" styleId="INV128_2" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1288298();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1328304();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV178)" styleId="INV178_2" title="Assesses whether or not the patient is pregnant." onchange="ruleHideUnhINV1788310();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV145)" styleId="INV145_2" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1458299();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV150)" styleId="INV150_2" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1508301();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV152)" styleId="INV152_2" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1528302();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV502)" styleId="INV502_2" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_UI_NBS_INV_GENV2_UI_4');ruleEnDisINV5028308();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NOT120)" styleId="NOT120_2" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1208309();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV576_2L" title="Did the patient experience any clinical manifestation related to babesiosis?">
Was the patient symptomatic?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV576)" styleId="INV576_2" title="Did the patient experience any clinical manifestation related to babesiosis?" onchange="ruleEnDisINV5768313();ruleHideUnh3866610068316();ruleHideUnhNBS3388327();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(386661006)" styleId="386661006_2" title="Did the patient have a fever?" onchange="ruleHideUnh3866610068316();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV202_2L" title="What was the patient's highest measured temperature?">
Highest Measured Temperature:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(INV202)" size="10" maxlength="10"  title="What was the patient's highest measured temperature?" styleId="INV202_2" onkeyup="isTemperatureCharEntered(this)" onblur="isTemperatureEntered(this);pgCheckFieldMinMax(this,30,110)" styleClass="relatedUnitsField"/>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="302215000_2L" title="Did the patient have thrombocytopenic disorder?">
Thrombocytopenia:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(302215000)" styleId="302215000_2" title="Did the patient have thrombocytopenic disorder?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="43724002_2L" title="Did the patient have chills?">
Chills:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(43724002)" styleId="43724002_2" title="Did the patient have chills?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="57676002_2L" title="Did the patient have a arthralgia or joint pain?">
Arthralgia/Joint Pain:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(57676002)" styleId="57676002_2" title="Did the patient have a arthralgia or joint pain?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="415690000_2L" title="Did the patient experience sweating?">
Sweating:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(415690000)" styleId="415690000_2" title="Did the patient experience sweating?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS338)" styleId="NBS338_2" title="Indication of whether the patient had other symptom(s) not otherwise specified?" onchange="ruleHideUnhNBS3388327();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="67187_5_2L" title="Complications of Babesiosis">
Type of Complications:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(67187_5)" styleId="67187_5_2" title="Complications of Babesiosis"
multiple="true" size="4"
...
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="Complications of Babesiosis" id="67187_5_2OthL">Other Type of Complications:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(67187_5Oth)" size="40" maxlength="40" title="Other Complications of Babesiosis" styleId="67187_5_2Oth"/></td></tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="300564004_2L" title="Patient being without a spleen or without a functional spleen">
Is the patient asplenic?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(300564004)" styleId="300564004_2" title="Patient being without a spleen or without a functional spleen" onchange="ruleEnDis3005640048311();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="82760_0_2L" title="Splenectomy Date">
Splenectomy Date:</span>
</td>
<td>
<html:text name="PageForm" title="Splenectomy Date"  property="pageClientVO2.answer(82760_0)" maxlength="10" size="10" styleId="82760_0_2" onkeyup="DateMask(this,null,event)"/>
</td> </tr>

<!--processing TextArea-->
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="82759_2_2L" title="Why was the patient's spleen removed?">
Why was the patient's spleen removed?:</span>
</td>
<td>
<html:textarea style="WIDTH: 500px; HEIGHT: 100px; background-color:white; color:black; border:currentColor;" name="PageForm" property="pageClientVO2.answer(82759_2)" styleId ="82759_2_2" onkeyup="checkTextAreaLength(this, 199)" title="Why was the patient's spleen removed?"/>
</td> </tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="161413004_2L" title="Did the patient have a history of babesiosis?">
Did the patient have a history of babesiosis?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(161413004)" styleId="161413004_2" title="Did the patient have a history of babesiosis?" onchange="ruleEnDis1614130048312();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_70_2" name="Date of Previous Illness" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="82758_4_2L" title="Date of previous babesiosis diagnosis">
Date of Previous Babesiosis Diagnosis:</span>
</td>
<td>
<html:text name="PageForm" title="Date of previous babesiosis diagnosis"  property="pageClientVO2.answer(82758_4)" maxlength="10" size="10" styleId="82758_4_2" onkeyup="unhideBatchImg('NBS_UI_70');DateMask(this,null,event)" styleClass="NBS_UI_70"/>
</td> </tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="VAR126_2L" title="At the time of diagnosis, was the patient immunocompromised?">
Immunocompromised at time of diagnosis:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(VAR126)" styleId="VAR126_2" title="At the time of diagnosis, was the patient immunocompromised?" onchange="ruleEnDisVAR1268314();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="VAR127_2L" title="If the patient was immunocompromised, what was the associated condition or treatment?">
Condition and/or Treatment:</span>
</td>
<td>
<html:textarea style="WIDTH: 500px; HEIGHT: 100px; background-color:white; color:black; border:currentColor;" name="PageForm" property="pageClientVO2.answer(VAR127)" styleId ="VAR127_2" onkeyup="checkTextAreaLength(this, 199)" title="If the patient was immunocompromised, what was the associated condition or treatment?"/>
</td> </tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="ARB008_2L" title="In the month before symptom onset or diagnosis (use earlier date), did the patient receive an organ transplant">
In the month before symptoms onset or diagnosis, did the patient receive an organ transplant?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(ARB008)" styleId="ARB008_2" title="In the month before symptom onset or diagnosis (use earlier date), did the patient receive an organ transplant">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="255633001_2L" title="Did the patient receive antimicrobial treatment for this infection?">
Did the patient receive antimicrobial treatment for this infection?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(255633001)" styleId="255633001_2" title="Did the patient receive antimicrobial treatment for this infection?" onchange="ruleEnDis2556330018317();enableOrDisableOther('29303_5');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="29303_5_2L" title="Treatment drugs used for babesiosis">
Medications Received:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(29303_5)" styleId="29303_5_2" title="Treatment drugs used for babesiosis"
multiple="true" size="4"
onchange="displaySelectedOptions(this, '29303_5_2-selectedValues');enableOrDisableOther('29303_5')" >
<nedss:optionsCollection property="codedValue(PHVS_MEDICATIONTREATMENT_BABESIOSIS)" value="key" label="value" /> </html:select>
<div id="29303_5_2-selectedValues" style="margin:0.25em;">
<b> Selected Values: </b>
</div>
</div></td></tr>
<!--Other entry allowed for this Coded Question-->
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="Treatment drugs used for babesiosis" id="29303_5_2OthL">Other Medications Received:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(29303_5Oth)" size="40" maxlength="40" title="Other Treatment drugs used for babesiosis" styleId="29303_5_2Oth"/></td></tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="ARB006_2L" title="In the year before symptom onset or diagnosis (use earlier date), did the patient receive a blood transfusion?">
In the year before symptom onset or diagnosis, did the patient receive a blood transfusion?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(ARB006)" styleId="ARB006_2" title="In the year before symptom onset or diagnosis (use earlier date), did the patient receive a blood transfusion?" onchange="ruleEnDisARB0068329();ruleEnDisARB0068325();ruleEnDis4189120058318();ruleEnDis4189120058318();enableOrDisableOther('933_2');enableOrDisableOther('933_2');ruleEnDis4189120058318();enableOrDisableOther('933_2');enableOrDisableOther('933_2');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="418912005_2L" title="Was the patient's infection transfusion associated?">
Was the patient's infection transfusion associated?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(418912005)" styleId="418912005_2" title="Was the patient's infection transfusion associated?" onchange="ruleEnDis4189120058318();enableOrDisableOther('933_2');enableOrDisableOther('933_2');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="933_2_2L" title="If a transfused blood product was implicated in an investigation, specify which types of product">
Type of transfused blood product implicated:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(933_2)" styleId="933_2_2" title="If a transfused blood product was implicated in an investigation, specify which types of product"
multiple="true" size="4"
...
<!--Other entry allowed for this Coded Question-->
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="If a transfused blood product was implicated in an investigation, specify which types of product" id="933_2_2OthL">Other Type of transfused blood product implicated:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(933_2Oth)" size="40" maxlength="40" title="Other If a transfused blood product was implicated in an investigation, specify which types of product" styleId="933_2_2Oth"/></td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_63_2" name="Blood Transfusion Information" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
<div class="infoBox errors" style="display: none;visibility: none;" id="NBS_UI_63_2errorMessages">
<b> <a name="NBS_UI_63_2errorMessages_errorMessagesHref"></a> Please fix the following errors:</b> <br/>
</div>
<table role="presentation"  class="dtTable" align="center" >
<thead >
...
<td style="width:3%;text-align:center;">
<input id="viewNBS_UI_63_2" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked2(this.id,'NBS_UI_63_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View"></td>
<% for(int i=0;batchrec!=null && i<batchrec.length;i++){%>
<% String validdisplay =batchrec[i][0]; %>
<%    if(batchrec[i][4] != null && batchrec[i][2].equals("Y"))  {%>
<% String per = batchrec[i][4];
...
<tbody id="questionbodyNBS_UI_63_2">
<tr id="nopatternNBS_UI_63_2" class="odd" style="display:">
<td colspan="<%=batchrec.length+1%>"> <span>&nbsp; No Data has been entered.
</span>
</td>
</tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="14687_8_2L" title="Date(s) of blood transfusion(s)">
Blood Transfusion Date:</span>
</td>
<td>
<html:text name="PageForm" title="Date(s) of blood transfusion(s)"  property="pageClientVO2.answer(14687_8)" maxlength="10" size="10" styleId="14687_8_2" onkeyup="unhideBatchImg('NBS_UI_63');DateMask(this,null,event)" styleClass="NBS_UI_63"/>
</td> </tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<td colspan="2" align="right">
<input type="button" value="     Add     "  style="display: none;"  disabled="disabled" onclick="if (pgNBS_UI_63BatchAddFunction()) writeQuestion('NBS_UI_63_2','patternNBS_UI_63_2','questionbodyNBS_UI_63_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} else {%>
<tr id="AddButtonToggleNBS_UI_63_2">
<td colspan="2" align="right">
<input type="button" value="     Add     " style="display: none;" onclick="if (pgNBS_UI_63BatchAddFunction()) writeQuestion('NBS_UI_63_2','patternNBS_UI_63_2','questionbodyNBS_UI_63_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} %>
<tr id="UpdateButtonToggleNBS_UI_63_2"
style="display:none">
<td colspan="2" align="right">
<input type="button" value="   Update   "  style="display: none;"  onclick="if (pgNBS_UI_63BatchAddFunction()) writeQuestion('NBS_UI_63_2','patternNBS_UI_63_2','questionbodyNBS_UI_63_2')"/>&nbsp;		&nbsp;
&nbsp;
</td>
</tr>
...
style="display:none">
<td colspan="2" align="right">
<input type="button" value="  Add New  " style="display: none;"  onclick="clearClicked('NBS_UI_63_2')"/>&nbsp;	&nbsp;&nbsp;
</td>
</tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="ARB005_2L" title="In the year before symptom onset or diagnosis (use earlier date), did the patient donate blood?">
In the year before symptom onset or diagnosis, did the patient donate blood?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(ARB005)" styleId="ARB005_2" title="In the year before symptom onset or diagnosis (use earlier date), did the patient donate blood?" onchange="ruleEnDisARB0058328();ruleEnDisARB0058326();ruleEnDisARB0138319();ruleEnDisARB0138319();enableOrDisableOther('INV964');enableOrDisableOther('INV964');ruleEnDisARB0138319();enableOrDisableOther('INV964');enableOrDisableOther('INV964');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="ARB013_2L" title="Was the patient a blood donor identified during a transfusion investigation (i.e., had positive Babesia test results and was linked to an infected recipient)?">
Was the patient a blood donor identified during a transfusion investigation?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(ARB013)" styleId="ARB013_2" title="Was the patient a blood donor identified during a transfusion investigation (i.e., had positive Babesia test results and was linked to an infected recipient)?" onchange="ruleEnDisARB0138319();enableOrDisableOther('INV964');enableOrDisableOther('INV964');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_75_2" name="Blood Donation Information" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
<div class="infoBox errors" style="display: none;visibility: none;" id="NBS_UI_75_2errorMessages">
<b> <a name="NBS_UI_75_2errorMessages_errorMessagesHref"></a> Please fix the following errors:</b> <br/>
</div>
<table role="presentation"  class="dtTable" align="center" >
<thead >
...
<td style="width:3%;text-align:center;">
<input id="viewNBS_UI_75_2" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked2(this.id,'NBS_UI_75_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View"></td>
<% for(int i=0;batchrec!=null && i<batchrec.length;i++){%>
<% String validdisplay =batchrec[i][0]; %>
<%    if(batchrec[i][4] != null && batchrec[i][2].equals("Y"))  {%>
<% String per = batchrec[i][4];
...
<tbody id="questionbodyNBS_UI_75_2">
<tr id="nopatternNBS_UI_75_2" class="odd" style="display:">
<td colspan="<%=batchrec.length+1%>"> <span>&nbsp; No Data has been entered.
</span>
</td>
</tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="82756_8_2L" title="Blood Donation Date">
Blood Donation Date:</span>
</td>
<td>
<html:text name="PageForm" title="Blood Donation Date"  property="pageClientVO2.answer(82756_8)" maxlength="10" size="10" styleId="82756_8_2" onkeyup="unhideBatchImg('NBS_UI_75');DateMask(this,null,event)" styleClass="NBS_UI_75"/>
</td> </tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<td colspan="2" align="right">
<input type="button" value="     Add     "  style="display: none;"  disabled="disabled" onclick="if (pgNBS_UI_75BatchAddFunction()) writeQuestion('NBS_UI_75_2','patternNBS_UI_75_2','questionbodyNBS_UI_75_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} else {%>
<tr id="AddButtonToggleNBS_UI_75_2">
<td colspan="2" align="right">
<input type="button" value="     Add     " style="display: none;" onclick="if (pgNBS_UI_75BatchAddFunction()) writeQuestion('NBS_UI_75_2','patternNBS_UI_75_2','questionbodyNBS_UI_75_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} %>
<tr id="UpdateButtonToggleNBS_UI_75_2"
style="display:none">
<td colspan="2" align="right">
<input type="button" value="   Update   "  style="display: none;"  onclick="if (pgNBS_UI_75BatchAddFunction()) writeQuestion('NBS_UI_75_2','patternNBS_UI_75_2','questionbodyNBS_UI_75_2')"/>&nbsp;		&nbsp;
&nbsp;
</td>
</tr>
...
style="display:none">
<td colspan="2" align="right">
<input type="button" value="  Add New  " style="display: none;"  onclick="clearClicked('NBS_UI_75_2')"/>&nbsp;	&nbsp;&nbsp;
</td>
</tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="82762_6_2L" title="In the eight weeks before symptom onset or diagnosis (use earlier date), did the patient engage in outdoor activities?">
Did the patient engage in outdoor activities?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(82762_6)" styleId="82762_6_2" title="In the eight weeks before symptom onset or diagnosis (use earlier date), did the patient engage in outdoor activities?" onchange="ruleEnDis82762_68320();enableOrDisableOther('82763_4');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="82763_4_2L" title="Which outdoor activities did the patient engage in?">
Outdoor activities:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(82763_4)" styleId="82763_4_2" title="Which outdoor activities did the patient engage in?"
multiple="true" size="4"
onchange="displaySelectedOptions(this, '82763_4_2-selectedValues');enableOrDisableOther('82763_4')" >
<nedss:optionsCollection property="codedValue(PHVS_OUTDOORACTIVITIES_CDC)" value="key" label="value" /> </html:select>
<div id="82763_4_2-selectedValues" style="margin:0.25em;">
<b> Selected Values: </b>
</div>
</div></td></tr>
<!--Other entry allowed for this Coded Question-->
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="Which outdoor activities did the patient engage in?" id="82763_4_2OthL">Other Outdoor activities:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(82763_4Oth)" size="40" maxlength="40" title="Other Which outdoor activities did the patient engage in?" styleId="82763_4_2Oth"/></td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="272500005_2L" title="In the eight weeks before symptom onset or diagnosis (use earlier date), did the patient spend time outdoors in or near wooded or brushy areas?">
Did the patient spend time near wooded areas?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(272500005)" styleId="272500005_2" title="In the eight weeks before symptom onset or diagnosis (use earlier date), did the patient spend time outdoors in or near wooded or brushy areas?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(95898004)" styleId="95898004_2" title="In the eight weeks before symptom onset or diagnosis (use earlier date), did the patient notice any tick bites?" onchange="ruleEnDis958980048321();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_57_2" name="Tick Bite Information" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="82755_0_2L" title="If patient noticed tick bite, what was the geographic location?">
Geographic Location of Tick Bite:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(82755_0)"  maxlength="25" title="If patient noticed tick bite, what was the geographic location?" styleId="82755_0_2" onkeyup="unhideBatchImg('NBS_UI_57');"/>
</td> </tr>

<!--processing Date Question-->
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="45347_2_2L" title="If patient noticed tick bite, when did the bite occur?">
Date of Tick Bite:</span>
</td>
<td>
<html:text name="PageForm" title="If patient noticed tick bite, when did the bite occur?"  property="pageClientVO2.answer(45347_2)" maxlength="10" size="10" styleId="45347_2_2" onkeyup="unhideBatchImg('NBS_UI_57');DateMask(this,null,event)" styleClass="NBS_UI_57"/>
</td> </tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="TRAVEL02_2L" title="In the eight weeks before symptom onset or diagnosis (use earlier date), did the patient travel out of their county, state, or country of residence?">
In 8 weeks prior to illness, did patient travel outside his/her county/state/country of residence?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(TRAVEL02)" styleId="TRAVEL02_2" title="In the eight weeks before symptom onset or diagnosis (use earlier date), did the patient travel out of their county, state, or country of residence?" onchange="ruleEnDisTRAVEL028322();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_59_2" name="Travel History Information" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
<div class="infoBox errors" style="display: none;visibility: none;" id="NBS_UI_59_2errorMessages">
<b> <a name="NBS_UI_59_2errorMessages_errorMessagesHref"></a> Please fix the following errors:</b> <br/>
</div>
<table role="presentation"  class="dtTable" align="center" >
<thead >
...
<td style="width:3%;text-align:center;">
<input id="viewNBS_UI_59_2" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked2(this.id,'NBS_UI_59_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View"></td>
<% for(int i=0;batchrec!=null && i<batchrec.length;i++){%>
<% String validdisplay =batchrec[i][0]; %>
<%    if(batchrec[i][4] != null && batchrec[i][2].equals("Y"))  {%>
<% String per = batchrec[i][4];
...
<tbody id="questionbodyNBS_UI_59_2">
<tr id="nopatternNBS_UI_59_2" class="odd" style="display:">
<td colspan="<%=batchrec.length+1%>"> <span>&nbsp; No Data has been entered.
</span>
</td>
</tr>
...
<tr><td class="fieldName">
<span style="color:#CC0000">*</span>
<span class="requiredInputFieldNBS_UI_59_2 InputFieldLabel" id="NBS454_2L" title="Domestic vs International Travel">
Was the travel domestic or international?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS454)" styleId="NBS454_2" title="Domestic vs International Travel" onchange="unhideBatchImg('NBS_UI_59');ruleEnDisNBS4548324();ruleEnDisNBS4548323();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PHVSFB_DOMINTNL)" value="key" label="value" /> </html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_59 InputFieldLabel" id="TRAVEL05_2L" title="List any international destinations of recent travel">
Country of Travel:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(TRAVEL05)" styleId="TRAVEL05_2" title="List any international destinations of recent travel" onchange="unhideBatchImg('NBS_UI_59');">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_59 InputFieldLabel" id="82754_3_2L" title="Domestic destination, states traveled">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_59 InputFieldLabel" id="82753_5_2L" title="Which intrastate counties did the patient travel?">
County of Travel:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(82753_5)" styleId="82753_5_2" title="Which intrastate counties did the patient travel?" onchange="unhideBatchImg('NBS_UI_59');">
<nedss:optionsCollection property="codedValue(PHVS_COUNTY_FIPS_6-4)" value="key" label="value" /> </html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_59 InputFieldLabel" id="NBS453_2L" title="Choose the mode of travel">
Travel Mode:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS453)" styleId="NBS453_2" title="Choose the mode of travel" onchange="unhideBatchImg('NBS_UI_59');">
<nedss:optionsCollection property="codedValue(PHVS_TRAVELMODE_CDC)" value="key" label="value" /> </html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_59 InputFieldLabel" id="TRAVEL16_2L" title="Principal Reason for Travel">
Principal Reason for Travel:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(TRAVEL16)" styleId="TRAVEL16_2" title="Principal Reason for Travel" onchange="unhideBatchImg('NBS_UI_59');">
...
<td>
<html:text name="PageForm" title="If the patient traveled, when did they arrive to their travel destination?"  property="pageClientVO2.answer(TRAVEL06)" maxlength="10" size="10" styleId="TRAVEL06_2" onkeyup="unhideBatchImg('NBS_UI_59');DateMask(this,null,event)" styleClass="NBS_UI_59"/>
</td> </tr>
...
<td>
<html:text name="PageForm" title="If the patient traveled, when did they depart from their travel destination?"  property="pageClientVO2.answer(TRAVEL07)" maxlength="10" size="10" styleId="TRAVEL07_2" onkeyup="unhideBatchImg('NBS_UI_59');DateMask(this,null,event)" styleClass="NBS_UI_59"/>
</td> </tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(82310_4)" size="3" maxlength="3"  title="Duration of Stay" styleId="82310_4_2" onkeyup="unhideBatchImg('NBS_UI_59');isNumericCharacterEntered(this)" styleClass="relatedUnitsFieldNBS_UI_59"/>
<html:select name="PageForm" property="pageClientVO2.answer(82310_4Unit)" styleId="82310_4UNIT_2" onchange="unhideBatchImg('NBS_UI_59')">
...
<td colspan="2" align="right">
<input type="button" value="     Add     "  style="display: none;"  disabled="disabled" onclick="if (pgNBS_UI_59BatchAddFunction()) writeQuestion('NBS_UI_59_2','patternNBS_UI_59_2','questionbodyNBS_UI_59_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} else {%>
<tr id="AddButtonToggleNBS_UI_59_2">
<td colspan="2" align="right">
<input type="button" value="     Add     " style="display: none;" onclick="if (pgNBS_UI_59BatchAddFunction()) writeQuestion('NBS_UI_59_2','patternNBS_UI_59_2','questionbodyNBS_UI_59_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} %>
<tr id="UpdateButtonToggleNBS_UI_59_2"
style="display:none">
<td colspan="2" align="right">
<input type="button" value="   Update   "  style="display: none;"  onclick="if (pgNBS_UI_59BatchAddFunction()) writeQuestion('NBS_UI_59_2','patternNBS_UI_59_2','questionbodyNBS_UI_59_2')"/>&nbsp;		&nbsp;
&nbsp;
</td>
</tr>
...
style="display:none">
<td colspan="2" align="right">
<input type="button" value="  Add New  " style="display: none;"  onclick="clearClicked('NBS_UI_59_2')"/>&nbsp;	&nbsp;&nbsp;
</td>
</tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="82751_9_2L" title="Was the patient an infant born to a mother who had babesiosis or Babesia infection during pregnancy?">
Was the patient an infant born to a mother who had babesiosis or Babesia infection during pregnancy?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(82751_9)" styleId="82751_9_2" title="Was the patient an infant born to a mother who had babesiosis or Babesia infection during pregnancy?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="MTH162_2L" title="Did the patient's mother test positive for babesiosis or Babesia infection before or at the time of delivery?">
Did the patient's mother test positive for Babesia before/at the time of delivery?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(MTH162)" styleId="MTH162_2" title="Did the patient's mother test positive for babesiosis or Babesia infection before or at the time of delivery?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="MTH163_2L" title="Did the patient's mother test positive for babesiosis or Babesia infection after delivery?">
Did the patient's mother test positive for Babesia infection after delivery?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(MTH163)" styleId="MTH163_2" title="Did the patient's mother test positive for babesiosis or Babesia infection after delivery?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="MTH164_2L" title="Date of mother's earliest positive test result">
Date of mother's earliest positive test result:</span>
</td>
<td>
<html:text name="PageForm" title="Date of mother's earliest positive test result"  property="pageClientVO2.answer(MTH164)" maxlength="10" size="10" styleId="MTH164_2" onkeyup="DateMask(this,null,event)"/>
</td> </tr>
</nedss:container>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV740)" styleId="INV740_2" title="Was laboratory testing done to confirm the diagnosis?" onchange="ruleEnDisINV7408315();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_43 InputFieldLabel" id="INV291_2L" title="For each test performed, provide result">
Test Result:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV291)" styleId="INV291_2" title="For each test performed, provide result" onchange="unhideBatchImg('NBS_UI_43');">
<nedss:optionsCollection property="codedValue(PHVS_LAB_TEST_INTERP)" value="key" label="value" /> </html:select>
</td></tr>

<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="LAB628_2L" title="Provide titer (if applicable)">
Test Result Quantitative:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(LAB628)"  maxlength="10" title="Provide titer (if applicable)" styleId="LAB628_2" onkeyup="unhideBatchImg('NBS_UI_43');"/>
</td> </tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_43 InputFieldLabel" id="LAB278_2L" title="Babesia species identified">
Organism Name:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LAB278)" styleId="LAB278_2" title="Babesia species identified" onchange="unhideBatchImg('NBS_UI_43');enableOrDisableOther('LAB278');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PHVS_LABRESULT_BABESIOSIS)" value="key" label="value" /> </html:select>
</td></tr>
<!--Other entry allowed for this Coded Question-->
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="Babesia species identified" id="LAB278_2OthL">Other Organism Name:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(LAB278Oth)" size="40" maxlength="40" title="Other Babesia species identified" onkeyup="unhideBatchImg('NBS_UI_43')" styleId="LAB278_2Oth"/></td></tr>

<!--processing Date Question-->
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="LAB163_2L" title="Date laboratory specimen was collected">
Specimen Collection Date:</span>
</td>
<td>
<html:text name="PageForm" title="Date laboratory specimen was collected"  property="pageClientVO2.answer(LAB163)" maxlength="10" size="10" styleId="LAB163_2" onkeyup="unhideBatchImg('NBS_UI_43');DateMask(this,null,event)" styleClass="NBS_UI_43"/>
</td> </tr>

<!--processing Numeric Question-->
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="53556_7_2L" title="Estimated number of infected erythrocytes expressed as a percentage of the total erythrocytes">
Estimated percentage of infected erythrocytes:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(53556_7)" size="10" maxlength="10"  title="Estimated number of infected erythrocytes expressed as a percentage of the total erythrocytes" styleId="53556_7_2" onkeyup="unhideBatchImg('NBS_UI_43');isTemperatureCharEntered(this)" onblur="isTemperatureEntered(this);pgCheckFieldMinMax(this,0,100)"/>
</td></tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
