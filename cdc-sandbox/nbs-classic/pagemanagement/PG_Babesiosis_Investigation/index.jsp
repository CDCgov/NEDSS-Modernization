...
pgDisableElement('INV503');
  ...
  function ruleHideUnhNOT1208309()
{
 var foo = [];
...
pgHideElement('NOT120SPEC_2');
  ...
  function ruleHideUnhINV1788310()
{
 var foo = [];
...
pgHideElement('INV579_2');
  ...
  function ruleEnDis3005640048311()
{
 var foo = [];
$j('#300564004 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('82760_0');
pgEnableElement('82759_2');
 } else { 
pgDisableElement('82760_0');
pgDisableElement('82759_2');
 }   
}
      
  function ruleEnDis1614130048312()
{
 var foo = [];
$j('#161413004 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('82758_4');
 } else { 
pgDisableElement('82758_4');
 }   
}
      
  function ruleEnDisINV5768313()
{
 var foo = [];
...
pgSubSectionDisabled('NBS_UI_43');
  ...
  function ruleHideUnh3866610068316()
{
 var foo = [];
...
pgHideElement('INV202_2');
  ...
  function ruleEnDis2556330018317()
{
 var foo = [];
$j('#255633001 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('29303_5');
 } else { 
pgDisableElement('29303_5');
 }   
}
      
  function ruleEnDis4189120058318()
{
 var foo = [];
...
pgDisableElement('933_2');
  ...
  function ruleEnDisARB0138319()
{
 var foo = [];
$j('#ARB013 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
...
pgDisableElement('INV964');
  ...
  function ruleEnDis82762_68320()
{
 var foo = [];
$j('#82762_6 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('82763_4');
 } else { 
pgDisableElement('82763_4');
 }   
}
      
  function ruleEnDis958980048321()
{
 var foo = [];
$j('#95898004 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_57');
 } else { 
pgSubSectionDisabled('NBS_UI_57');
 }   
}
      
  function ruleEnDisTRAVEL028322()
{
 var foo = [];
$j('#TRAVEL02 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_59');
 } else { 
pgSubSectionDisabled('NBS_UI_59');
 }   
}
      
  function ruleEnDisNBS4548323()
{
 var foo = [];
...
pgEnableElement('TRAVEL05');
  ...
  function ruleEnDisARB0068325()
{
 var foo = [];
$j('#ARB006 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_63');
 } else { 
pgSubSectionDisabled('NBS_UI_63');
 }   
}
      
  function ruleEnDisARB0058326()
{
 var foo = [];
$j('#ARB005 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_75');
 } else { 
pgSubSectionDisabled('NBS_UI_75');
 }   
}
      
  function ruleHideUnhNBS3388327()
{
 var foo = [];
...
$j('#ARB005 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('ARB013');
 } else { 
pgDisableElement('ARB013');
 }   
}
      
  function ruleEnDisARB0068329()
{
 var foo = [];
$j('#ARB006 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('418912005');
 } else { 
pgDisableElement('418912005');
 }   
}
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1378305();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158306();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158307();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisINV1288298();ruleEnDisINV1458299();ruleEnDisDEM1278300();ruleEnDisINV1508301();ruleEnDisINV1528302();ruleEnDisDEM1138303();ruleEnDisINV5028308();ruleHideUnhNOT1208309();ruleHideUnhINV1788310();ruleEnDis3005640048311();ruleEnDis1614130048312();ruleEnDisINV5768313();ruleEnDisVAR1268314();ruleEnDisINV7408315();ruleHideUnh3866610068316();ruleEnDis2556330018317();ruleEnDis4189120058318();ruleEnDisARB0138319();ruleEnDis82762_68320();ruleEnDis958980048321();ruleEnDisTRAVEL028322();ruleEnDisNBS4548323();ruleEnDisNBS4548324();ruleEnDisARB0068325();ruleEnDisARB0058326();ruleHideUnhNBS3388327();ruleEnDisARB0058328();ruleEnDisARB0068329();
	...
	<!-- === batch subsection add edit check functions (if any) follow ===-->
        ...
        function pgNBS_UI_70BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_70');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_70errorMessages', errorLabels); return false;}
		$j('#NBS_UI_70errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_63BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_63');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_63errorMessages', errorLabels); return false;}
		$j('#NBS_UI_63errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_75BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_75');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_75errorMessages', errorLabels); return false;}
		$j('#NBS_UI_75errorMessages').css("display", "none");
		return true;
		}
        ...
        function pgNBS_UI_59BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_59');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_59errorMessages', errorLabels); return false;}
		$j('#NBS_UI_59errorMessages').css("display", "none");
		return true;
		}
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
      		...
      		<jsp:include page="CaseInfo.jsp"/>
      		 ...
      		 <layout:tab key="Babesiosis">     
      		<jsp:include page="Babesiosis.jsp"/>
             	</layout:tab>               	
