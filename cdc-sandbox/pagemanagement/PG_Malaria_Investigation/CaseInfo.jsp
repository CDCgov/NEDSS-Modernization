...
int sectionIndex = 0;
String sectionId = "";
String [] sectionNames  = {"Investigation Information","Reporting Information","Clinical","Epidemiologic","Case Information","General Comments"};
;
%>
<tr><td>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV128)" styleId="INV128" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1288515();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;pgSelectNextFocus(this);">
...
<tr><td colspan="2" align="left"><span id="NBS_UI_78L">&nbsp;&nbsp;The questions in this subsection are hidden and used only for LEGACY porting purposes. The repeating block should be used for hospitalization information for Malaria</span> </td></tr>
...
<input id="viewNBS_UI_68" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked(this.id,'NBS_UI_68');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View">
</td><td style="width:3%;text-align:center;">
<input id="editNBS_UI_68" type="image" src="page_white_edit.gif" tabIndex="0" onclick="editClicked(this.id,'NBS_UI_68');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit" alt="Edit">
</td><td style="width:3%;text-align:center;">
<input id="deleteNBS_UI_68" type="image" src="cross.gif" tabIndex="0" onclick="deleteClicked(this.id,'NBS_UI_68','patternNBS_UI_68','questionbodyNBS_UI_68');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete" alt="Delete">	</td>
<% for(int i=0;i<batchrec.length;i++){%>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(58237_9)" size="50" maxlength="50" title="If admitted, what is the name of the hospital?" styleId="58237_9" onkeyup="unhideBatchImg('NBS_UI_68');"/>
</td> </tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(52455_3)" maxlength="10" size="10" styleId="52455_3" onkeyup="unhideBatchImg('NBS_UI_68');DateMask(this,null,event)" styleClass="NBS_UI_68" title="If patient was hospitalized for malaria, enter admit date."/>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(52525_3)" maxlength="10" size="10" styleId="52525_3" onkeyup="unhideBatchImg('NBS_UI_68');DateMask(this,null,event)" styleClass="NBS_UI_68" title="If patient was hospitalized for malaria, enter discharge date."/>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(46106_1)" size="25" maxlength="25" title="If patient was hospitalized, enter hospital record number" styleId="46106_1" onkeyup="unhideBatchImg('NBS_UI_68');"/>
</td> </tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV178)" styleId="INV178" title="Assesses whether or not the patient is pregnant." onchange="ruleHideUnhINV1788505();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV145)" styleId="INV145" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1458494();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV150)" styleId="INV150" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1508496();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV152)" styleId="INV152" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1528497();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV502)" styleId="INV502" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_UI_NBS_INV_GENV2_UI_4');ruleEnDisINV5028503();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NOT120)" styleId="NOT120" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1208504();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
