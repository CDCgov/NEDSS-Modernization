...
pgDisableElement('INV503');
  ...
  function ruleHideUnhNOT1208504()
{
 var foo = [];
...
pgHideElement('NOT120SPEC_2');
  ...
  function ruleHideUnhINV1788505()
{
 var foo = [];
...
pgHideElement('INV579_2');
  ...
  function ruleEnDis1829290088506()
{
 var foo = [];
$j('#182929008 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('INV931');
pgEnableElement('INV309');
 } else { 
pgDisableElement('INV931');
pgDisableElement('INV309');
 }   
}
      
  function ruleEnDisINV7408507()
{
 var foo = [];
...
$j('#82312_0 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('80989_7');
 } else { 
pgDisableElement('80989_7');
 }   
}
      
  function ruleEnDis1614130048509()
{
 var foo = [];
...
pgSubSectionDisabled('NBS_UI_44');
  ...
  function ruleEnDisLAB5158510()
{
 var foo = [];
$j('#LAB515 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_39');
 } else { 
pgSubSectionDisabled('NBS_UI_39');
 }   
}
      
  function ruleEnDisINV7408511()
{
 var foo = [];
$j('#INV740 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_79');
 } else { 
pgSubSectionDisabled('NBS_UI_79');
 }   
}
      
  function ruleEnDis3911030058512()
{
 var foo = [];
$j('#391103005 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_33');
pgSubSectionEnabled('NBS_UI_73');
pgSubSectionEnabled('NBS_UI_70');
 } else { 
pgSubSectionDisabled('NBS_UI_33');
pgSubSectionDisabled('NBS_UI_73');
pgSubSectionDisabled('NBS_UI_70');
 }   
}
      
  function ruleEnDisINV3098513()
{
 var foo = [];
$j('#INV309 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('N',foo) > -1) || ($j.inArray('No'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('INV932');
 } else { 
pgDisableElement('INV932');
 }   
}
      
  function ruleEnDisTRAVEL108514()
{
 var foo = [];
$j('#TRAVEL10 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
...
$j('#INV128 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_68');
 } else { 
pgSubSectionDisabled('NBS_UI_68');
 }   
}
      
  function ruleEnDisTRAVEL108516()
{
 var foo = [];
$j('#TRAVEL10 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('TRAVEL15');
 } else { 
pgDisableElement('TRAVEL15');
 }   
}
      
  function ruleEnDisINV9328517()
{
 var foo = [];
$j('#INV932 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });

 if(($j.inArray('401207004',foo) > -1) || ($j.inArray('Had a side effect'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('INV921');
 } else { 
pgDisableElement('INV921');
 }   
}
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1378500();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158501();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158502();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisINV1458494();ruleEnDisDEM1278495();ruleEnDisINV1508496();ruleEnDisINV1528497();ruleEnDisDEM1138498();ruleEnDisINV5028503();ruleHideUnhNOT1208504();ruleHideUnhINV1788505();ruleEnDis1829290088506();ruleEnDisINV7408507();ruleEnDis82312_08508();ruleEnDis1614130048509();ruleEnDisLAB5158510();ruleEnDisINV7408511();ruleEnDis3911030058512();ruleEnDisINV3098513();ruleEnDisTRAVEL108514();ruleEnDisINV1288515();ruleEnDisTRAVEL108516();ruleEnDisINV9328517();
          
       return;
      }

	<!-- === batch subsection add edit check functions (if any) follow ===-->
     	function pgNBS_UI_80BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_80');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_80errorMessages', errorLabels); return false;}
		$j('#NBS_UI_80errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_68BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_68');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_68errorMessages', errorLabels); return false;}
		$j('#NBS_UI_68errorMessages').css("display", "none");
		return true;
		}
        ...
        function pgNBS_UI_79BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_79');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_79errorMessages', errorLabels); return false;}
		$j('#NBS_UI_79errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_39BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_39');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_39errorMessages', errorLabels); return false;}
		$j('#NBS_UI_39errorMessages').css("display", "none");
		return true;
		}
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
      		...
      		<jsp:include page="CaseInfo.jsp"/>
      		 ...
      		 <layout:tab key="Malaria">     
      		<jsp:include page="Malaria.jsp"/>
             	</layout:tab>               	
