...
pgDisableElement('INV503');
  ...
  function ruleHideUnhNOT1208631()
{
 var foo = [];
...
pgHideElement('NOT120SPEC_2');
  ...
  function ruleHideUnhINV1788632()
{
 var foo = [];
...
$j('#NBS340 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgEnableElement('272033007');
pgEnableElement('31646008');
pgEnableElement('237443002');
pgEnableElement('44201003');
pgEnableElement('75548002');
pgEnableElement('78580004');
pgEnableElement('NBS343');
pgEnableElement('10665004');
pgEnableElement('INV307');
 } else { 
pgDisableElement('272033007');
pgDisableElement('31646008');
pgDisableElement('237443002');
pgDisableElement('44201003');
pgDisableElement('75548002');
pgDisableElement('78580004');
pgDisableElement('NBS343');
pgDisableElement('10665004');
pgDisableElement('INV307');
 }   
}
      
  function ruleEnDisVAC1268634()
{
 var foo = [];
...
pgEnableElement('VAC129');
pgEnableElement('VAC140');
 } else { 
pgDisableElement('VAC142');
pgDisableElement('VAC129');
pgDisableElement('VAC140');
 }   
}
      
  function ruleHideUnh3866610068635()
{
 var foo = [];
$j('#386661006 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#386661006').html()!=null){foo[0]=$j('#386661006').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('INV203');
pgUnhideElement('INV202');
 } else { 
pgHideElement('INV203');
pgHideElement('INV202');
 }
 var foo_2 = [];
$j('#386661006_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#386661006_2').html()!=null){foo_2[0]=$j('#386661006_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('INV203_2');
pgUnhideElement('INV202_2');
 } else { 
pgHideElement('INV203_2');
pgHideElement('INV202_2');
 }   
}
      
  function ruleEnDisINV5768636()
{
 var foo = [];
...
pgEnableElement('274667000');
pgEnableElement('79890006');
pgEnableElement('68962001');
pgEnableElement('NBS338');
pgEnableElement('NBS342');
pgEnableElement('INV301');
pgEnableElement('NBS339');
pgEnableElement('267031002');
 } else { 
pgDisableElement('386661006');
pgDisableElement('25064002');
pgDisableElement('274667000');
pgDisableElement('79890006');
pgDisableElement('68962001');
pgDisableElement('NBS338');
pgDisableElement('NBS342');
pgDisableElement('INV301');
pgDisableElement('NBS339');
pgDisableElement('267031002');
 }   
}
      
  function ruleEnDisINV7408637()
{
 var foo = [];
$j('#INV740 :selected').each(function(i, selected){
 ...
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1)){
pgSubSectionEnabled('NBS_UI_NBS_INV_MUM_UI_16');
pgSubSectionEnabled('NBS_UI_NBS_INV_MUM_UI_17');
 } else { 
pgSubSectionDisabled('NBS_UI_NBS_INV_MUM_UI_16');
pgSubSectionDisabled('NBS_UI_NBS_INV_MUM_UI_17');
 }   
}
      
  function ruleHideUnhNBS3428638()
{
 var foo = [];
$j('#NBS342 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#NBS342').html()!=null){foo[0]=$j('#NBS342').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('INV301');
 } else { 
pgHideElement('INV301');
 }
 var foo_2 = [];
$j('#NBS342_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#NBS342_2').html()!=null){foo_2[0]=$j('#NBS342_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('INV301_2');
 } else { 
pgHideElement('INV301_2');
 }   
}
      
  function ruleHideUnh2720330078639()
{
 var foo = [];
$j('#272033007 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#272033007').html()!=null){foo[0]=$j('#272033007').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('INV307');
 } else { 
pgHideElement('INV307');
 }
 var foo_2 = [];
$j('#272033007_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#272033007_2').html()!=null){foo_2[0]=$j('#272033007_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgUnhideElement('INV307_2');
 } else { 
pgHideElement('INV307_2');
 }   
}
      
  function ruleHideUnhNBS3388640()
{
 var foo = [];
...
pgHideElement('NBS338_OTH_2');
  ...
  function ruleHideUnhNBS3438641()
{
 var foo = [];
...
pgHideElement('NBS343_OTH_2');
  ...
  function ruleHideUnhVAC1488642()
{
 var foo = [];
$j('#VAC148 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#VAC148').html()!=null){foo[0]=$j('#VAC148').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('N',foo) > -1) || ($j.inArray('No'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'No')==true)){
pgUnhideElement('VAC149');
 } else { 
pgHideElement('VAC149');
 }
 var foo_2 = [];
$j('#VAC148_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#VAC148_2').html()!=null){foo_2[0]=$j('#VAC148_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('N',foo_2) > -1) || ($j.inArray('No'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'No')==true)){
pgUnhideElement('VAC149_2');
 } else { 
pgHideElement('VAC149_2');
 }   
}
      
  function ruleEnDisINV7408643()
{
 var foo = [];
$j('#INV740 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
pgDisableElement('INV164');
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1378627();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158628();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158629();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisINV1288620();ruleEnDisINV1458621();ruleEnDisDEM1278622();ruleEnDisINV1508623();ruleEnDisINV1528624();ruleEnDisDEM1138625();ruleEnDisINV5028630();ruleHideUnhNOT1208631();ruleHideUnhINV1788632();ruleEnDisNBS3408633();ruleEnDisVAC1268634();ruleHideUnh3866610068635();ruleEnDisINV5768636();ruleEnDisINV7408637();ruleHideUnhNBS3428638();ruleHideUnh2720330078639();ruleHideUnhNBS3388640();ruleHideUnhNBS3438641();ruleHideUnhVAC1488642();ruleEnDisINV7408643();
          
       return;
      }

	<!-- === batch subsection add edit check functions (if any) follow ===-->
     	function pgNBS_UI_NBS_INV_MUM_UI_1BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_NBS_INV_MUM_UI_1');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_NBS_INV_MUM_UI_1errorMessages', errorLabels); return false;}
		$j('#NBS_UI_NBS_INV_MUM_UI_1errorMessages').css("display", "none");
		return true;
		}
        ...
        function pgNBS_UI_NBS_INV_MUM_UI_16BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_NBS_INV_MUM_UI_16');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_NBS_INV_MUM_UI_16errorMessages', errorLabels); return false;}
		$j('#NBS_UI_NBS_INV_MUM_UI_16errorMessages').css("display", "none");
		return true;
		}
        function pgNBS_UI_NBS_INV_MUM_UI_17BatchAddFunction()
     	    { 
    			var errorLabels = new Array();
    			var retVal;
    			var retRule;
        	...
        	retVal=pgCheckForErrorsOnBatchSubsection('NBS_UI_NBS_INV_MUM_UI_17');
         	if (retVal != null && retVal != undefined) { errorLabels = errorLabels.concat(retVal); } 

        
        	if (errorLabels.length > 0) {
        	displayErrors('NBS_UI_NBS_INV_MUM_UI_17errorMessages', errorLabels); return false;}
		$j('#NBS_UI_NBS_INV_MUM_UI_17errorMessages').css("display", "none");
		return true;
		}
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
      		...
      		<jsp:include page="CaseInfo.jsp"/>
      		 ...
      		 <layout:tab key="Mumps">     
      		<jsp:include page="Mumps.jsp"/>
             	</layout:tab>               	
