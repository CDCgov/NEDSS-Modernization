...
int sectionIndex = 0;
String sectionId = "";
String [] sectionNames  = {"Patient Information","Investigation Information","Reporting Information","Clinical","Epidemiologic","General Comments","Clinical Manifestations","Treatment","Laboratory","Contact Investigation","Legacy Questions Hidden"};
;
%>
<tr><td>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM113)" styleId="DEM113_2" title="Patient's current sex." onchange="ruleEnDisDEM1138649();ruleHideUnhINV1788656();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM127)" styleId="DEM127_2" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1278646();pgSelectNextFocus(this);">
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_39_2" name="Occupation and Industry Information" isHidden="F" classType="subSect"  addedClass="batchSubSection">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_39 InputFieldLabel" id="85659_1_2L" title="This data element is used to capture the CDC NIOSH standard occupation code based upon the narrative text of a subjects current occupation.">
Current Occupation Standardized:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(85659_1)" styleId="85659_1_2" title="This data element is used to capture the CDC NIOSH standard occupation code based upon the narrative text of a subjects current occupation." onchange="unhideBatchImg('NBS_UI_39');">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_39 InputFieldLabel" id="85657_5_2L" title="This data element is used to capture the CDC NIOSH standard industry code based upon the narrative text of a subjects current industry.">
Current  Industry Standardized:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(85657_5)" styleId="85657_5_2" title="This data element is used to capture the CDC NIOSH standard industry code based upon the narrative text of a subjects current industry." onchange="unhideBatchImg('NBS_UI_39');">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV128)" styleId="INV128_2" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1288644();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1328650();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV178)" styleId="INV178_2" title="Assesses whether or not the patient is pregnant." onchange="ruleHideUnhINV1788656();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV145)" styleId="INV145_2" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1458645();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV150)" styleId="INV150_2" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1508647();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV152)" styleId="INV152_2" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1528648();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV502)" styleId="INV502_2" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_UI_NBS_INV_GENV2_UI_4');ruleEnDisINV5028654();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<tr><td colspan="2" align="left">&nbsp;&nbsp;<a href="https://wwwn.cdc.gov/nndss/conditions/lyme-disease/" TARGET="_blank">Click here for the current Lyme Disease case definition</a></td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NOT120)" styleId="NOT120_2" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1208655();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_42_2" name="Manifestations" isHidden="F" classType="subSect" >

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="271807003_2L" title="Did the patient have Erythema chronica migrans?">
Erythema Migrans:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(271807003)" styleId="271807003_2" title="Did the patient have Erythema chronica migrans?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="233917008_2L" title="Did the patient have Atrioventricular block?">
Atrioventricular block:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(233917008)" styleId="233917008_2" title="Did the patient have Atrioventricular block?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="3723001_2L" title="Did the patient have Lyme arthritis?">
Arthritis:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(3723001)" styleId="3723001_2" title="Did the patient have Lyme arthritis?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="193093009_2L" title="Did the patient have Bells palsy?">
Bells palsy:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(193093009)" styleId="193093009_2" title="Did the patient have Bells palsy?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="48780006_2L" title="Did the patient have Other Cranial neuritis?">
Other Cranial neuritis:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(48780006)" styleId="48780006_2" title="Did the patient have Other Cranial neuritis?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="72274001_2L" title="Did the patient have Radiculoneuropathy (Nerve root disorder)?">
Radiculoneuropathy:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(72274001)" styleId="72274001_2" title="Did the patient have Radiculoneuropathy (Nerve root disorder)?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="44201003_2L" title="Did the patient have Lymphocytic Meningitis?">
Lymphocytic Meningitis:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(44201003)" styleId="44201003_2" title="Did the patient have Lymphocytic Meningitis?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="62950007_2L" title="Did the patient have Encephalomyelitis?">
Encephalomyelitis:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(62950007)" styleId="62950007_2" title="Did the patient have Encephalomyelitis?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS338)" styleId="NBS338_2" title="Indication of whether the patient had other symptom(s) not otherwise specified." onchange="ruleEnDisNBS3388657();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_44_2" name="Treatment" isHidden="F" classType="subSect" >

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="255633001_2L" title="Did the patient receive antibiotics treatment for this infection?">
Did the patient receive antibiotic treatment for this infection?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(255633001)" styleId="255633001_2" title="Did the patient receive antibiotics treatment for this infection?" onchange="ruleEnDis2556330018658();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_45_2" name="Antibiotics Treatment Information" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
...
<tr><td class="fieldName">
<span style="color:#CC0000">*</span>
<span class="requiredInputFieldNBS_UI_45_2 InputFieldLabel" id="29303_5_2L" title="What antibiotic was prescribed to the patient for this infection?">
Medication Administered:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(29303_5)" styleId="29303_5_2" title="What antibiotic was prescribed to the patient for this infection?" onchange="unhideBatchImg('NBS_UI_45');enableOrDisableOther('29303_5');pgSelectNextFocus(this);">
...
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="What antibiotic was prescribed to the patient for this infection?" id="29303_5_2OthL">Other Medication Administered:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(29303_5Oth)" size="40" maxlength="40" title="Other What antibiotic was prescribed to the patient for this infection?" onkeyup="unhideBatchImg('NBS_UI_45')" styleId="29303_5_2Oth"/></td></tr>

<!--processing Date Question-->
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="INV924_2L" title="Date the treatment was prescribed">
Treatment Start Date:</span>
</td>
<td>
<html:text name="PageForm" title="Date the treatment was prescribed"  property="pageClientVO2.answer(INV924)" maxlength="10" size="10" styleId="INV924_2" onkeyup="unhideBatchImg('NBS_UI_45');DateMask(this,null,event)" styleClass="NBS_UI_45"/>
</td> </tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(67453_1)" size="3" maxlength="3"  title="Prescribed duration (in days) of antibiotic treatment" styleId="67453_1_2" onkeyup="unhideBatchImg('NBS_UI_45');isNumericCharacterEntered(this)"/>
</td></tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV740)" styleId="INV740_2" title="Was laboratory testing done to confirm the diagnosis?" onchange="ruleEnDisINV7408659();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_48_2" name="Interpretative Lab Data Repeating  Block" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
<div class="infoBox errors" style="display: none;visibility: none;" id="NBS_UI_48_2errorMessages">
<b> <a name="NBS_UI_48_2errorMessages_errorMessagesHref"></a> Please fix the following errors:</b> <br/>
</div>
<table role="presentation"  class="dtTable" align="center" >
<thead >
<tr> <%String subSecNm = "NBS_UI_48_2"; String batchrec[][]= null;   Iterator mapIt = map2.entrySet().iterator();
while(mapIt .hasNext())
{
Map.Entry mappairs = (Map.Entry)mapIt .next();
if(mappairs.getKey().toString().equals(subSecNm)){
...
<tbody id="questionbodyNBS_UI_48_2">
<tr id="patternNBS_UI_48_2" class="odd" style="display:none">
<td style="width:3%;text-align:center;">
<input id="viewNBS_UI_48_2" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked2(this.id,'NBS_UI_48_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View"></td>
<% for(int i=0;batchrec!=null && i<batchrec.length;i++){%>
<% String validdisplay =batchrec[i][0]; %>
<%    if(batchrec[i][4] != null && batchrec[i][2].equals("Y"))  {%>
<% String per = batchrec[i][4];
...
<tbody id="questionbodyNBS_UI_48_2">
<tr id="nopatternNBS_UI_48_2" class="odd" style="display:">
<td colspan="<%=batchrec.length+1%>"> <span>&nbsp; No Data has been entered.
</span>
</td>
</tr>
...
<tr><td class="fieldName">
<span style="color:#CC0000">*</span>
<span class="requiredInputFieldNBS_UI_48_2 InputFieldLabel" id="INV290_2L" title="Epidemiologic interpretation of the type of test(s) performed for this case.">
Test Type:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV290)" styleId="INV290_2" title="Epidemiologic interpretation of the type of test(s) performed for this case." onchange="unhideBatchImg('NBS_UI_48');enableOrDisableOther('INV290');pgSelectNextFocus(this);">
...
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(INV290Oth)" size="40" maxlength="40" title="Other Epidemiologic interpretation of the type of test(s) performed for this case." onkeyup="unhideBatchImg('NBS_UI_48')" styleId="INV290_2Oth"/></td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_48 InputFieldLabel" id="INV291_2L" title="Epidemiologic interpretation of the results of the test(s) performed for this case. This is a qualitative test result.  (e.g., positive, negative, not done)">
Test Result:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV291)" styleId="INV291_2" title="Epidemiologic interpretation of the results of the test(s) performed for this case. This is a qualitative test result.  (e.g., positive, negative, not done)" onchange="unhideBatchImg('NBS_UI_48');enableOrDisableOther('INV291');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(LAB_TEST_INTERPRETATION_LYME)" value="key" label="value" /> </html:select>
</td></tr>
<!--Other entry allowed for this Coded Question-->
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="Epidemiologic interpretation of the results of the test(s) performed for this case. This is a qualitative test result.  (e.g., positive, negative, not done)" id="INV291_2OthL">Other Test Result:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(INV291Oth)" size="40" maxlength="40" title="Other Epidemiologic interpretation of the results of the test(s) performed for this case. This is a qualitative test result.  (e.g., positive, negative, not done)" onkeyup="unhideBatchImg('NBS_UI_48')" styleId="INV291_2Oth"/></td></tr>
...
<td>
<html:text name="PageForm" property="pageClientVO2.answer(LAB628)"  maxlength="10" title="Quantitative Test Result Value" styleId="LAB628_2" onkeyup="unhideBatchImg('NBS_UI_48');"/>
</td> </tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_48 InputFieldLabel" id="LAB115_2L" title="Units of measure for the Quantitative Test Result Value">
Result Units:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LAB115)" styleId="LAB115_2" title="Units of measure for the Quantitative Test Result Value" onchange="unhideBatchImg('NBS_UI_48');">
<nedss:optionsCollection property="codedValue(UNIT_ISO)" value="key" label="value" /> </html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_48 InputFieldLabel" id="LAB278_2L" title="Species identified through testing">
Organism Name:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LAB278)" styleId="LAB278_2" title="Species identified through testing" onchange="unhideBatchImg('NBS_UI_48');enableOrDisableOther('LAB278');pgSelectNextFocus(this);">
...
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(LAB278Oth)" size="40" maxlength="40" title="Other Species identified through testing" onkeyup="unhideBatchImg('NBS_UI_48')" styleId="LAB278_2Oth"/></td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class="NBS_UI_48 InputFieldLabel" id="667469_2L" title="If Other Arbovirus PCR (Not serum / CSF) was selected as test type, specify the specimen type. List of specimens that are used for Arboviral lab tests include Serum, CSF, Amniotic Fluid, Urine, Semen, Cord blood, etc.">
Specimen Type:</span>
</td>
<td>
...
<!--Other entry allowed for this Coded Question-->
<tr><td class="fieldName">
<span class="InputDisabledLabel otherEntryField" title="If Other Arbovirus PCR (Not serum / CSF) was selected as test type, specify the specimen type. List of specimens that are used for Arboviral lab tests include Serum, CSF, Amniotic Fluid, Urine, Semen, Cord blood, etc." id="667469_2OthL">Other Specimen Type:</span></td>
<td><html:text name="PageForm" disabled="true" property="pageClientVO2.answer(667469Oth)" size="40" maxlength="40" title="Other If Other Arbovirus PCR (Not serum / CSF) was selected as test type, specify the specimen type. List of specimens that are used for Arboviral lab tests include Serum, CSF, Amniotic Fluid, Urine, Semen, Cord blood, etc." onkeyup="unhideBatchImg('NBS_UI_48')" styleId="667469_2Oth"/></td></tr>
...
<td>
<html:text name="PageForm" title="Date of collection of laboratory specimen used for diagnosis of health event reported in this case report."  property="pageClientVO2.answer(LAB163)" maxlength="10" size="10" styleId="LAB163_2" onkeyup="unhideBatchImg('NBS_UI_48');DateMask(this,null,event)" styleClass="NBS_UI_48"/>
</td> </tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<td colspan="2" align="right">
<input type="button" value="     Add     "  style="display: none;"  disabled="disabled" onclick="if (pgNBS_UI_48BatchAddFunction()) writeQuestion('NBS_UI_48_2','patternNBS_UI_48_2','questionbodyNBS_UI_48_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} else {%>
<tr id="AddButtonToggleNBS_UI_48_2">
<td colspan="2" align="right">
<input type="button" value="     Add     " style="display: none;" onclick="if (pgNBS_UI_48BatchAddFunction()) writeQuestion('NBS_UI_48_2','patternNBS_UI_48_2','questionbodyNBS_UI_48_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} %>
<tr id="UpdateButtonToggleNBS_UI_48_2"
style="display:none">
<td colspan="2" align="right">
<input type="button" value="   Update   "  style="display: none;"  onclick="if (pgNBS_UI_48BatchAddFunction()) writeQuestion('NBS_UI_48_2','patternNBS_UI_48_2','questionbodyNBS_UI_48_2')"/>&nbsp;		&nbsp;
&nbsp;
</td>
</tr>
...
style="display:none">
<td colspan="2" align="right">
<input type="button" value="  Add New  " style="display: none;"  onclick="clearClicked('NBS_UI_48_2')"/>&nbsp;	&nbsp;&nbsp;
</td>
</tr>
</nedss:container>
</nedss:container>
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_36_2" name="Comment" isHidden="F" classType="subSect" >

<!--processing Static Comment-->
<tr><td colspan="2" align="left"><span class="staticComment">&nbsp;&nbsp;This section is created for storing answers data after conversion of Legacy Lyme elements which are not collected in new MMG.</span></td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_38_2" name="Lab Info" isHidden="F" classType="subSect" >

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="NBS497_2L" title="Antibody to B. burgdorferi higher in CSF than in serum?">
Antibody to B. burgdorferi higher in CSF than in serum?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS497)" styleId="NBS497_2" title="Antibody to B. burgdorferi higher in CSF than in serum?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="NBS498_2L" title="CSF tested for antibodies to B. burgdorferi">
CSF tested for antibodies to B. burgdorferi?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NBS498)" styleId="NBS498_2" title="CSF tested for antibodies to B. burgdorferi">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
