...
pgDisableElement('INV503');
  ...
  function ruleHideUnhNOT1208800()
{
 var foo = [];
...
pgHideElement('NOT120SPEC_2');
  ...
  function ruleHideUnhINV1788801()
{
 var foo = [];
...
pgHideElement('INV579_2');
  ...
  function ruleEnDisTRAVEL388802()
{
 var foo = [];
...
pgSubSectionDisabled('NBS_UI_39');
  ...
  function ruleEnDisINV11098805()
{
 var foo = [];
$j('#INV1109 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
...
pgSubSectionDisabled('NBS_UI_44');
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1378796();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158797();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1158798();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisINV1288789();ruleEnDisINV1458790();ruleEnDisDEM1278791();ruleEnDisINV1508792();ruleEnDisINV1528793();ruleEnDisDEM1138794();ruleEnDisINV5028799();ruleHideUnhNOT1208800();ruleHideUnhINV1788801();ruleEnDisTRAVEL388802();ruleEnDis90366_68803();ruleEnDisINV7408804();ruleEnDisINV11098805();
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
      		...
      		<jsp:include page="CaseInfo.jsp"/>
      		 ...
      		 <layout:tab key="CP-CRE">     
      		<jsp:include page="CP-CRE.jsp"/>
             	</layout:tab>               	
