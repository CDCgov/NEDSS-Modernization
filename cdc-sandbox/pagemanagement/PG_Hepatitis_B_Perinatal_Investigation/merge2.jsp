...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM113)" styleId="DEM113_2" title="Patient's current sex." onchange="ruleEnDisDEM1137412();ruleEnDisINV1787418();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM127)" styleId="DEM127_2" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1277409();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV150)" styleId="INV150_2" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1507410();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV152)" styleId="INV152_2" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1527411();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV502)" styleId="INV502_2" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_INV_HEP_UI_2');ruleEnDisINV5027417();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NOT120)" styleId="NOT120_2" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1207422();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
multiple="true" size="4"
onchange="displaySelectedOptions(this, 'INV575_2-selectedValues');ruleHideUnhINV5757421()" >
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV576)" styleId="INV576_2" title="Was the patient symptomatic for the illness of interest?" onchange="ruleEnDisINV5767419();ruleDCompINV1377414();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV128)" styleId="INV128_2" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1287407();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1327413();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV178)" styleId="INV178_2" title="Assesses whether or not the patient is pregnant." onchange="ruleEnDisINV1787418();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV145)" styleId="INV145_2" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457408();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV887)" styleId="INV887_2" title="Indicate whether the patient has diabetes" onchange="ruleEnDisINV8877420();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LP38332_0)" styleId="LP38332_0_2" title="Hepatitis C virus Ab result" onchange="ruleHideUnhLP38332_07423();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PNU)" value="key" label="value" /></html:select>
</td></tr>
...
multiple="true" size="4"
onchange="displaySelectedOptions(this, 'MTH157_2-selectedValues');ruleHideUnhMTH1577426()" >
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="MTH171_2L" title="If other race is selected for the mother, please specify">
Other Race for Mother (specify):</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(MTH171)" maxlength="100" title="If other race is selected for the mother, please specify" styleId="MTH171"/>
</td> </tr>
...
<tr style="display:none"> <td class="fieldName">
<span title="If mother's ethnicity is other, specify" id="MTH170_2L">
Other Ethnicity for Mother (specify):</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO2.answer(MTH170)" maxlength="100" title="If mother's ethnicity is other, specify" styleId="MTH170"/>
</td> </tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="MTH161_2L" title="Was the patient's mother born outside of the United States?">
Was Mother born outside of United States?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(MTH161)" styleId="MTH161_2" title="Was the patient's mother born outside of the United States?" onchange="ruleHideUnhMTH1617424();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="MTH162_2L" title="Was the mother confirmed positive for the illness being reported prior to or at the time of delivery?">
Was the mother confirmed positive prior to or at the time of delivery?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(MTH162)" styleId="MTH162_2" title="Was the mother confirmed positive for the illness being reported prior to or at the time of delivery?" onchange="ruleHideUnhMTH1627425();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="MTH163_2L" title="Was the mother confirmed positive for the illness being reported after delivery?">
If no, was the mother confirmed positive after delivery?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(MTH163)" styleId="MTH163_2" title="Was the mother confirmed positive for the illness being reported after delivery?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="MTH164_2L" title="Enter the date of the mother's earliest postive test result">
Date of Earliest Positive Test Result:</span>
</td>
<td>
<html:text name="PageForm" title="Enter the date of the mother's earliest postive test result"  property="pageClientVO2.answer(MTH164)" maxlength="10" size="10" styleId="MTH164_2" onkeyup="DateMask(this,null,event)"/>
</td> </tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="VAC126_2L" title="Has the child ever received a vaccination for Hepatitis B?">
Has the child ever received a vaccination for Hepatitis B?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(VAC126)" styleId="VAC126_2" title="Has the child ever received a vaccination for Hepatitis B?" onchange="ruleHideUnhVAC1267429();ruleHideUnhVAC1267428();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="VAC132_2L" title="Total number of doses of vaccine the child received. Enter a numeric value based on the category on the form.">
How many doses of Hepatitis B vaccine did the child receive?:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(VAC132)" size="2" maxlength="2"  title="Total number of doses of vaccine the child received. Enter a numeric value based on the category on the form." styleId="VAC132_2" onkeyup="isNumericCharacterEntered(this)" onblur="pgCheckFieldMinMax(this,0,4)"/>
</td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_INV_HEPBP_7_2" name="Vaccine Doses Received" isHidden="F" classType="subSect"  addedClass="batchSubSection">
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td>.</td>
<td  width="100%">
<div class="infoBox errors" style="display: none;visibility: none;" id="NBS_INV_HEPBP_7_2errorMessages">
<b> <a name="NBS_INV_HEPBP_7_2errorMessages_errorMessagesHref"></a> Please fix the following errors:</b> <br/>
</div>
<table role="presentation"  class="dtTable" align="center" >
<thead >
...
<td style="width:3%;text-align:center;">
<input id="viewNBS_INV_HEPBP_7_2" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked2(this.id,'NBS_INV_HEPBP_7_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View"></td>
<% for(int i=0;batchrec!=null && i<batchrec.length;i++){%>
<% String validdisplay =batchrec[i][0]; %>
<%    if(batchrec[i][4] != null && batchrec[i][2].equals("Y"))  {%>
<% String per = batchrec[i][4];
...
<tbody id="questionbodyNBS_INV_HEPBP_7_2">
<tr id="nopatternNBS_INV_HEPBP_7_2" class="odd" style="display:">
<td colspan="<%=batchrec.length+1%>"> <span>&nbsp; No Data has been entered.
</span>
</td>
</tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="VAC120_2L" title="Enter the vaccine dose number in the series of vaccination (e.g. 1, 2, 3, etc.)">
Dose Number:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(VAC120)" size="2" maxlength="2"  title="Enter the vaccine dose number in the series of vaccination (e.g. 1, 2, 3, etc.)" styleId="VAC120_2" onkeyup="unhideBatchImg('NBS_INV_HEPBP_7');isNumericCharacterEntered(this)" onblur="pgCheckFieldMinMax(this,1,4)"/>
</td></tr>

<!--processing Date Question-->
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="VAC103_2L" title="Enter the date the vaccine was administered">
Date of Vaccination:</span>
</td>
<td>
<html:text name="PageForm" title="Enter the date the vaccine was administered"  property="pageClientVO2.answer(VAC103)" maxlength="10" size="10" styleId="VAC103_2" onkeyup="unhideBatchImg('NBS_INV_HEPBP_7');DateMask(this,null,event)" styleClass="NBS_INV_HEPBP_7"/>
</td> </tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<td colspan="2" align="right">
<input type="button" value="     Add     "  style="display: none;"  disabled="disabled" onclick="if (pgNBS_INV_HEPBP_7BatchAddFunction()) writeQuestion('NBS_INV_HEPBP_7_2','patternNBS_INV_HEPBP_7_2','questionbodyNBS_INV_HEPBP_7_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} else {%>
<tr id="AddButtonToggleNBS_INV_HEPBP_7_2">
<td colspan="2" align="right">
<input type="button" value="     Add     " style="display: none;" onclick="if (pgNBS_INV_HEPBP_7BatchAddFunction()) writeQuestion('NBS_INV_HEPBP_7_2','patternNBS_INV_HEPBP_7_2','questionbodyNBS_INV_HEPBP_7_2')"/>&nbsp;&nbsp;
&nbsp;
</td>
</tr>
<%} %>
<tr id="UpdateButtonToggleNBS_INV_HEPBP_7_2"
style="display:none">
<td colspan="2" align="right">
<input type="button" value="   Update   "  style="display: none;"  onclick="if (pgNBS_INV_HEPBP_7BatchAddFunction()) writeQuestion('NBS_INV_HEPBP_7_2','patternNBS_INV_HEPBP_7_2','questionbodyNBS_INV_HEPBP_7_2')"/>&nbsp;		&nbsp;
&nbsp;
</td>
</tr>
...
style="display:none">
<td colspan="2" align="right">
<input type="button" value="  Add New  " style="display: none;"  onclick="clearClicked('NBS_INV_HEPBP_7_2')"/>&nbsp;	&nbsp;&nbsp;
</td>
</tr>
</nedss:container>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(VAC143)" styleId="VAC143_2" title="Has the patient ever received immune globulin for this condition?" onchange="ruleHideUnhVAC1437427();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="VAC144_2L" title="Date the child received the dose of HBIG.">
If yes, on what date did the child receive HBIG?:</span>
</td>
<td>
<html:text name="PageForm" title="Date the child received the dose of HBIG."  property="pageClientVO2.answer(VAC144)" maxlength="10" size="10" styleId="VAC144_2" onkeyup="DateMask(this,null,event)"/>
</td> </tr>
</nedss:container>
</nedss:container>
</div> </td></tr>
