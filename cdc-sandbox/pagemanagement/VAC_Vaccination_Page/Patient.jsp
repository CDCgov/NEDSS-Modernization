...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(DEM115)" maxlength="10" size="10" styleId="DEM115" onkeyup="DateMask(this,null,event)" onblur="pgCalculateReportedAge('DEM115','INV2001','INV2002','NBS096','NBS104');calculateAgeAtVaccination()" onchange="pgCalculateReportedAge('DEM115','INV2001','INV2002','NBS096','NBS104');calculateAgeAtVaccination()" title="Reported date of birth of patient."/>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM113)" styleId="DEM113" title="Patient's current sex.">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM127)" styleId="DEM127" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1276361();pgSelectNextFocus(this);">
