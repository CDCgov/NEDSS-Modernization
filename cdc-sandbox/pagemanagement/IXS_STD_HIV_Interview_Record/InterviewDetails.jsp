...
</td><td><html:hidden name="PageForm" property="pageClientVO.answer(IXS100)" styleId="IXS100cd" />
</td> </tr>
...
<td>
<html:text  name="PageForm" styleClass="requiredInputField" property="pageClientVO.answer(IXS101)" maxlength="10" size="10" styleId="IXS101" onkeyup="DateMask(this,null,event)" title="The date of the interview."/>
<html:img src="calendar.gif" alt="Select a Date" onclick="getCalDate('IXS101','IXS101Icon'); return false;" styleId="IXS101Icon" onkeypress="showCalendarEnterKey('IXS101','IXS101Icon',event)"></html:img>
</td> </tr>
...
<nedss:optionsCollection property="codedValue(NBS_INTERVIEW_TYPE_STDHIV)" value="key" label="value" /></html:select>
</td></tr>
...
<nedss:optionsCollection property="codedValue(NBS_INTVW_LOC_STDHIV)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="STD301L" title="Indicate whether or not contacts were named during this interview.">
Were contacts named at this interview?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD301)" styleId="STD301" title="Indicate whether or not contacts were named during this interview.">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Static Comment-->
<tr><td colspan="2" align="left"><span id="GA13000L">&nbsp;&nbsp;Please complete the section below if this interview record is linked to an HIV/AIDS investigation.</span> </td></tr>

<!--processing Organization Type Participation Question-->
<tr>
<td class="fieldName">
<logic:notEqual name="PageForm" property="attributeMap.readOnlyParticipant" value="NBS442">
<span id="NBS442L" title="The site of the original interview. For HIV/AIDS cases only.">
900 Site:</span>
</logic:notEqual>
</td>
<td>
<logic:empty name="PageForm" property="attributeMap.NBS442Uid">
<span id="clearNBS442" class="none">
</logic:empty>
<logic:notEmpty name="PageForm" property="attributeMap.NBS442Uid">
<span id="clearNBS442">
</logic:notEmpty>
<logic:notEqual name="PageForm" property="attributeMap.readOnlyParticipant" value="NBS442">
<input type="button" class="Button" value="Clear/Reassign" id="NBS442CodeClearButton" onclick="clearOrganization('NBS442')"/>
</logic:notEqual>
</span>
<span id="NBS442SearchControls"
<logic:notEmpty name="PageForm" property="attributeMap.NBS442Uid">
class="none"
</logic:notEmpty>
><input type="button" class="Button" value="Search"
id="NBS442Icon" onclick="getReportingOrg('NBS442');" />&nbsp; - OR - &nbsp;
<html:text property="pageClientVO.answer(NBS442)" styleId="NBS442Text"
size="10" maxlength="10" onkeydown="genOrganizationAutocomplete('NBS442Text','NBS442_qec_list')"
title="The site of the original interview. For HIV/AIDS cases only."/>
<input type="button" class="Button" value="Quick Code Lookup"
id="NBS442CodeLookupButton" onclick="getDWROrganization('NBS442')"
<logic:notEmpty name="PageForm" property="attributeMap.NBS442Uid">
style="visibility:hidden"
</logic:notEmpty>
/><div class="page_name_auto_complete" id="NBS442_qec_list" style="background:#DCDCDC"></div>
</span>
</td> </tr>
<tr>
<td class="fieldName" valign="top" id="NBS442S">900 Site Selected: </td>
<logic:empty name="PageForm" property="attributeMap.NBS442Uid">
<td> <span id="test2">
</logic:empty>
<logic:notEmpty name="PageForm" property="attributeMap.NBS442Uid">
...
<html:hidden property="attributeMap.NBS442Uid"/>
<span id="NBS442">${PageForm.attributeMap.NBS442SearchResult}</span>
</span> </td>
</tr>
<tr>
<td colspan="2" style="text-align:center;">
...
<!--processing Hidden ReadOnly Textbox Text Question-->
<tr style="display:none"><td class="fieldName">
<span title="The Site ID of the location of the original interview. For HIV/AIDS cases only." id="IXS107L">
900 Site ID:</span>
</td>
<td>
<span id="IXS107S"/>
<nedss:view name="PageForm" property="pageClientVO.answer(IXS107)" />
</td>
<td>
<html:hidden name="PageForm"  property="pageClientVO.answer(IXS107)" styleId="IXS107" />
</td>
</tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<!--processing Hidden ReadOnly Textbox Text Question-->
<tr style="display:none"><td class="fieldName">
<span title="The zip code of the agency where the case was assigned. For HIV/AIDS cases only." id="IXS108L">
900 Site Zip Code:</span>
</td>
<td>
<span id="IXS108S"/>
<nedss:view name="PageForm" property="pageClientVO.answer(IXS108)" />
</td>
<td>
<html:hidden name="PageForm"  property="pageClientVO.answer(IXS108)" styleId="IXS108" />
</td>
</tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="IXS109L" title="The setting in which HIV prevention services are provided. Select the site type that best represents the setting and/or primary type of services offered.">
900 Site Type:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO.answer(IXS109)" styleId="IXS109" title="The setting in which HIV prevention services are provided. Select the site type that best represents the setting and/or primary type of services offered.">
<nedss:optionsCollection property="codedValue(NBS_SITE_TYPE_HIV)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>
<logic:equal name="PageForm" property="securityMap.hasHIVPermissions" value="T">
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="IXS110L" title="Document if the patient belongs to locally identified epidemiological groups.  Interventions may be performed for these groups.">
Interventions:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO.answer(IXS110)" styleId="IXS110" title="Document if the patient belongs to locally identified epidemiological groups.  Interventions may be performed for these groups.">
<nedss:optionsCollection property="codedValue(NBS_INTERVENTION_HIV)" value="key" label="value" /></html:select>
</td></tr>
</logic:equal>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="NBS445L" title="Indicate whether or not the patient was in medical care at the time of the interview event.">
Care Status at Interview:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS445)" styleId="NBS445" title="Indicate whether or not the patient was in medical care at the time of the interview event.">
