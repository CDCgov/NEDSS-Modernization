...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM113)" styleId="DEM113_2" title="Patient's current sex." onchange="ruleEnDisDEM1137456();ruleEnDisINV1787462();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(DEM127)" styleId="DEM127_2" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1277453();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV169)" styleId="INV169_2" title="Condition_Cd should always be a hidden or read-only field." disabled="true" onchange="ruleHideUnhINV1697485();ruleHideUnhINV1697484()">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV150)" styleId="INV150_2" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1507454();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV152)" styleId="INV152_2" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1527455();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV502)" styleId="INV502_2" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS_INV_HEP_UI_2');ruleEnDisINV5027461();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(NOT120)" styleId="NOT120_2" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1207466();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
multiple="true" size="4"
onchange="displaySelectedOptions(this, 'INV575_2-selectedValues');ruleHideUnhINV5757465()" >
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV576)" styleId="INV576_2" title="Was the patient symptomatic for the illness of interest?" onchange="ruleEnDisINV5767463();ruleDCompINV1377458();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV178)" styleId="INV178_2" title="Assesses whether or not the patient is pregnant." onchange="ruleEnDisINV1787462();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV145)" styleId="INV145_2" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457452();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV887)" styleId="INV887_2" title="Indicate whether the patient has diabetes" onchange="ruleEnDisINV8877464();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(LP38332_0)" styleId="LP38332_0_2" title="Hepatitis C virus Ab result" onchange="ruleHideUnhLP38332_07467();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="5199_5_2L" title="supplemental anti-HCV assay (e.g. RIBA) result">
Supplemental anti-HCV Assay Result:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(5199_5)" styleId="5199_5_2" title="supplemental anti-HCV assay (e.g. RIBA) result">
<nedss:optionsCollection property="codedValue(PNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV832_2L" title="Did the patient have a negative hepatitis-related test in the previous 6 months? For Hep B: Did patient have a negative HBsAg test in the previous 6 months? For Hep C: Did patient have a negative HCV antibody test in the previous 6 months?">
Did the patient have a negative hepatitis-related test in the previous 6 months?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV832)" styleId="INV832_2" title="Did the patient have a negative hepatitis-related test in the previous 6 months? For Hep B: Did patient have a negative HBsAg test in the previous 6 months? For Hep C: Did patient have a negative HCV antibody test in the previous 6 months?" onchange="ruleHideUnhINV8327481();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="INV843_2L" title="If the patient had a previous negative hepatitis test within 6 months, enter the date of the test.">
Verified Test Date:</span>
</td>
<td>
<html:text name="PageForm" title="If the patient had a previous negative hepatitis test within 6 months, enter the date of the test."  property="pageClientVO2.answer(INV843)" maxlength="10" size="10" styleId="INV843_2" onkeyup="DateMask(this,null,event)"/>
</td> </tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV840_2L" title="Was the patient tested for Hepatitis D">
Was the patient tested for hepatitis D?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV840)" styleId="INV840_2" title="Was the patient tested for Hepatitis D">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV831_2L" title="Did the patient have a co-infection with Hepatitis D?">
Did the patient have a co-infection with hepatitis D?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV831)" styleId="INV831_2" title="Did the patient have a co-infection with Hepatitis D?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV602_2L" title="During the time period prior to the onset of symptoms, was the subject a contact of a person with confirmed or suspected hepatitis virus infection? For hepatitis B, the time period is 6 weeks to 6 months. For hepatitis C, it is 2 weeks to 6 months.">
During the time period prior to onset, was patient a contact of a case?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV602)" styleId="INV602_2" title="During the time period prior to the onset of symptoms, was the subject a contact of a person with confirmed or suspected hepatitis virus infection? For hepatitis B, the time period is 6 weeks to 6 months. For hepatitis C, it is 2 weeks to 6 months." onchange="ruleHideUnhINV6027468();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV603_5_2L" title="If the patient was a contact of a confirmed or suspected case, was the contact type sexual?">
Sexual (Contact Type):</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV603_5)" styleId="INV603_5_2" title="If the patient was a contact of a confirmed or suspected case, was the contact type sexual?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV603_3_2L" title="If the patient is a contact of a confirmed or suspected case, was the contact type  household non-sexual)?">
Household (Non-Sexual) (Contact Type):</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV603_3)" styleId="INV603_3_2" title="If the patient is a contact of a confirmed or suspected case, was the contact type  household non-sexual)?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV603_6)" styleId="INV603_6_2" title="If the patient was a contact of a confirmed or suspected case, was the contact type other?" onchange="ruleHideUnhINV603_67469();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV592_2L" title="Please enter the sexual preference of the patient.">
What is the sexual preference of the patient?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV592)" styleId="INV592_2" title="Please enter the sexual preference of the patient.">
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV605_2L" title="During the 6 months prior to the onset of symptoms, number of male sex partners the person had.">
Male Sex Partners Did the Patient Have:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(INV605)" size="4" maxlength="4"  title="During the 6 months prior to the onset of symptoms, number of male sex partners the person had." styleId="INV605_2" onkeyup="isNumericCharacterEntered(this)"/>
</td></tr>

<!--processing Numeric Question-->
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV606_2L" title="During the 6 months prior to the onset of symptoms, number of female sex partners the person had.">
Female Sex Partners Did the Patient Have:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(INV606)" size="4" maxlength="4"  title="During the 6 months prior to the onset of symptoms, number of female sex partners the person had." styleId="INV606_2" onkeyup="isNumericCharacterEntered(this)"/>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV653b)" styleId="INV653b_2" title="Was the patient ever treated for a sexually transmitted disease?" onchange="ruleHideUnhINV653b7470();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV654_2L" title="If the subject was ever treated for a sexually-transmitted diases, in what year was the most recent treatment?">
If yes, in what year was the most recent treatment?:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(INV654)" size="10" maxlength="10"  title="If the subject was ever treated for a sexually-transmitted diases, in what year was the most recent treatment?" styleId="INV654_2" onkeyup="YearMask(this, event)" onblur="pgCheckFullYear(this)"/>
</td></tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV583_2L" title="Prior to the onset of symptoms, did the patient undergo hemodialysis? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Undergo Hemodialysis:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV583)" styleId="INV583_2" title="Prior to the onset of symptoms, did the patient undergo hemodialysis? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV655_2L" title="Prior to the onset of symptoms, did the patient have an accidental stick or puncture with a needle or other object contaminated with blood? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Have an Accidental Stick or Puncture With a Needle or Other Object Contaminated With Blood:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV655)" styleId="INV655_2" title="Prior to the onset of symptoms, did the patient have an accidental stick or puncture with a needle or other object contaminated with blood? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV580_2L" title="Prior to the onset of symptoms, did the patient receive blood or blood products (transfusion)? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Receive Blood or Blood Products (Transfusion):</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV580)" styleId="INV580_2" title="Prior to the onset of symptoms, did the patient receive blood or blood products (transfusion)? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months." onchange="ruleHideUnhINV5807471();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr><td class="fieldName">
<span class="
InputFieldLabel" id="INV614_2L" title="Date the subject began receiving blood or blood products (transfusion) prior to symptom onset. For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
If Yes, Date of Transfusion:</span>
</td>
<td>
<html:text name="PageForm" title="Date the subject began receiving blood or blood products (transfusion) prior to symptom onset. For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months."  property="pageClientVO2.answer(INV614)" maxlength="10" size="10" styleId="INV614_2" onkeyup="DateMask(this,null,event)"/>
</td> </tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV620_2L" title="Prior to the onset of symptoms, did the patient receive any IV infusions and/or injections in an outpatient setting? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Receive Any IV Infusions and/or Injections in the Outpatient Setting:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV620)" styleId="INV620_2" title="Prior to the onset of symptoms, did the patient receive any IV infusions and/or injections in an outpatient setting? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV617_2L" title="Prior to the onset of symptoms, did the patient have other exposure to someone else's blood? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Have Other Exposure to Someone Else's Blood:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV617)" styleId="INV617_2" title="Prior to the onset of symptoms, did the patient have other exposure to someone else's blood? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months." onchange="ruleHideUnhINV6177472();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV898_2L" title="If patient had exposure to someone else's blood prior to symptom onset, specify the other blood exposure.">
Other Blood Exposure (Specify):</span>
</td>
<td>
<html:textarea style="WIDTH: 500px; HEIGHT: 100px; background-color:white; color:black; border:currentColor;" name="PageForm" property="pageClientVO2.answer(INV898)" styleId ="INV898_2" onkeyup="checkTextAreaLength(this, 200)" title="If patient had exposure to someone else's blood prior to symptom onset, specify the other blood exposure."/>
</td> </tr>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV590_2L" title="Prior to the onset of symptoms, was the patient employed in a medical or dental field involving direct contact with human blood? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Was the patient employed in a medical or dental field involving contact with human blood?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV590)" styleId="INV590_2" title="Prior to the onset of symptoms, was the patient employed in a medical or dental field involving direct contact with human blood? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months." onchange="ruleHideUnhINV5907473();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV594_2L" title="Subject's frequency of blood contact as an employee in a medical or dental field involving direct contact with human blood. For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months">
If Yes, Frequency of Direct Blood Contact:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV594)" styleId="INV594_2" title="Subject's frequency of blood contact as an employee in a medical or dental field involving direct contact with human blood. For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months">
<nedss:optionsCollection property="codedValue(PHVS_BLOODCONTACTFREQUENCY_HEPATITIS)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV595_2L" title="Prior to the onset of symptoms, was the subject employed as a public safety worker (fire fighter, law enforcement, or correctional officer) having direct contact with human blood? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months.  For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Was the patient employed as a public safety worker having direct contact with human blood?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV595)" styleId="INV595_2" title="Prior to the onset of symptoms, was the subject employed as a public safety worker (fire fighter, law enforcement, or correctional officer) having direct contact with human blood? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months.  For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months." onchange="ruleHideUnhINV5957474();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV596_2L" title="Subject's frequency of blood contact as a public safety worker (fire fighter, law enforcement, or correctional officer) having direct contact with human blood. For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
If Yes, Frequency of Direct Blood Contact:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV596)" styleId="INV596_2" title="Subject's frequency of blood contact as a public safety worker (fire fighter, law enforcement, or correctional officer) having direct contact with human blood. For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
<nedss:optionsCollection property="codedValue(PHVS_BLOODCONTACTFREQUENCY_HEPATITIS)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV597_2L" title="Prior to the onset of symptoms, did the patient receive a tattoo? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Did the patient receive a tattoo?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV597)" styleId="INV597_2" title="Prior to the onset of symptoms, did the patient receive a tattoo? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months." onchange="ruleHideUnhINV5977475();ruleHideUnhINV5987476();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV598_2L" title="Where was the tattooing performed (check all that apply)">
Where was the tattooing performed (check all that apply)?:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(INV598)" styleId="INV598_2" title="Where was the tattooing performed (check all that apply)"
multiple="true" size="4"
onchange="displaySelectedOptions(this, 'INV598_2-selectedValues');ruleHideUnhINV5987476()" >
<nedss:optionsCollection property="codedValue(PHVS_TATTOOOBTAINEDFROM_HEPATITIS)" value="key" label="value" /> </html:select>
<div id="INV598_2-selectedValues" style="margin:0.25em;">
<b> Selected Values: </b>
</div>
</div></td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV900_2L" title="specify other location(s) where the patient received a tattoo">
Other Location(s) Tattoo Received:</span>
</td>
<td>
<html:textarea style="WIDTH: 500px; HEIGHT: 100px; background-color:white; color:black; border:currentColor;" name="PageForm" property="pageClientVO2.answer(INV900)" styleId ="INV900_2" onkeyup="checkTextAreaLength(this, 150)" title="specify other location(s) where the patient received a tattoo"/>
</td> </tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV607_2L" title="During the timeperiod prior to the onset of symptoms, did the subject inject drugs?">
Inject Drugs Not Prescribed By a Doctor:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV607)" styleId="INV607_2" title="During the timeperiod prior to the onset of symptoms, did the subject inject drugs?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV608_2L" title="During the time period prior to the onset of symptoms, did the subject use street drugs but not inject?">
Use Street Drugs But Not Inject:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV608)" styleId="INV608_2" title="During the time period prior to the onset of symptoms, did the subject use street drugs but not inject?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV622_2L" title="Did the patient have any part of their body pierced (other than ear)?">
Did the patient have any part of their body pierced (other than ear)?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV622)" styleId="INV622_2" title="Did the patient have any part of their body pierced (other than ear)?" onchange="ruleHideUnhINV6227477();ruleHideUnhINV6237478();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Multi-Select Coded Question-->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV623_2L" title="Where was the piercing performed (check all that apply)">
Where was the piercing performed (check all that apply)?:</span>
</td>
<td>
<div class="multiSelectBlock">
<i> (Use Ctrl to select more than one) </i> <br/>
<html:select property="pageClientVO2.answerArray(INV623)" styleId="INV623_2" title="Where was the piercing performed (check all that apply)"
multiple="true" size="4"
onchange="displaySelectedOptions(this, 'INV623_2-selectedValues');ruleHideUnhINV6237478()" >
<nedss:optionsCollection property="codedValue(PHVS_TATTOOOBTAINEDFROM_HEPATITIS)" value="key" label="value" /> </html:select>
<div id="INV623_2-selectedValues" style="margin:0.25em;">
<b> Selected Values: </b>
</div>
</div></td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV899_2L" title="Specify other location(s) where the patient received a piercing">
Other Location(s) Piercing Received:</span>
</td>
<td>
<html:textarea style="WIDTH: 500px; HEIGHT: 100px; background-color:white; color:black; border:currentColor;" name="PageForm" property="pageClientVO2.answer(INV899)" styleId ="INV899_2" onkeyup="checkTextAreaLength(this, 150)" title="Specify other location(s) where the patient received a piercing"/>
</td> </tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV633_2L" title="Prior to the onset of symptoms, did the patient have dental work or oral surgery? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Did the patient have dental work or oral surgery?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV633)" styleId="INV633_2" title="Prior to the onset of symptoms, did the patient have dental work or oral surgery? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV634_2L" title="Prior to the onset of symptoms, did the patient have surgery (other than oral surgery)? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Did the patient have surgery (other than oral surgery)?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV634)" styleId="INV634_2" title="Prior to the onset of symptoms, did the patient have surgery (other than oral surgery)? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV635_2L" title="Prior to the onset of symptoms, was the patient hospitalized? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Was the patient hospitalized?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV635)" styleId="INV635_2" title="Prior to the onset of symptoms, was the patient hospitalized? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV636_2L" title="Prior to the onset of symptoms, was the patient a resident of a long-term care facility? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Was the patient a resident of a long-term care facility?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV636)" styleId="INV636_2" title="Prior to the onset of symptoms, was the patient a resident of a long-term care facility? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV637_2L" title="Prior to the onset of symptoms, was the patient incarcerated for longer than 24 hours? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months.">
Was the patient incarcerated for longer than 24 hours?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV637)" styleId="INV637_2" title="Prior to the onset of symptoms, was the patient incarcerated for longer than 24 hours? For Acute Hep B, the time period prior to onset of symptoms is 6 weeks - 6 months. For Acute Hep C, the time period prior to onset of symptoms is 2 weeks - 6 months." onchange="ruleHideUnhINV6377480();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV638_3_2L" title="If patient was incarcerated, indicate if the incarceration type was prison.">
Prison:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV638_3)" styleId="INV638_3_2" title="If patient was incarcerated, indicate if the incarceration type was prison.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV638_1_2L" title="If patient was incarcerated, what type of facility?">
Jail:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV638_1)" styleId="INV638_1_2" title="If patient was incarcerated, what type of facility?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV638_2_2L" title="If patient was incarcerated, indicate the type of facility?">
Juvenile Facility:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV638_2)" styleId="INV638_2_2" title="If patient was incarcerated, indicate the type of facility?">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="INV639_2L" title="During his/her lifetime, was the patient EVER incarcerated for more than 6 months?">
Was the patient ever incarcerated for longer than 6 months?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(INV639)" styleId="INV639_2" title="During his/her lifetime, was the patient EVER incarcerated for more than 6 months?" onchange="ruleHideUnhINV6397479();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV640_2L" title="Enter the 4-digit year the patient was most recently incarcerated for longer than 6 months.">
If yes, what year was the most recent incarceration?:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(INV640)" size="10" maxlength="10"  title="Enter the 4-digit year the patient was most recently incarcerated for longer than 6 months." styleId="INV640_2" onkeyup="YearMask(this, event)" onblur="pgCheckFullYear(this)"/>
</td></tr>

<!--processing Numeric Question-->
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="INV641_2L" title="If the patient was incarcerated for longer than 6 months, enter the length of time of incarceration in months">
If yes, for how long (answer in months)?:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(INV641)" size="3" maxlength="3"  title="If the patient was incarcerated for longer than 6 months, enter the length of time of incarceration in months" styleId="INV641_2" onkeyup="isNumericCharacterEntered(this)"/>
</td></tr>
</nedss:container>
</nedss:container>
...
<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="VAC126_2L" title="Did the patient ever receive hepatitis B vaccine?">
Did the patient ever receive hepatitis B vaccine?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(VAC126)" styleId="VAC126_2" title="Did the patient ever receive hepatitis B vaccine?" onchange="ruleEnDisVAC1267486();ruleHideUnhVAC1267482();ruleHideUnhHEP1907483();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="VAC132_2L" title="Total number of doses of vaccine the patient received for this condition (e.g. if the condition is hepatitis A, total number of doses of hepatitis A-containing vaccine).">
If yes, how many doses?:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(VAC132)" size="2" maxlength="2"  title="Total number of doses of vaccine the patient received for this condition (e.g. if the condition is hepatitis A, total number of doses of hepatitis A-containing vaccine)." styleId="VAC132_2" onkeyup="isNumericCharacterEntered(this)"/>
</td></tr>

<!--processing Numeric Question-->
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="VAC142b_2L" title="Enter the 4 digit year of when the last dose of vaccine for the condition being investigated was received.">
In what year was the last dose received?:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO2.answer(VAC142b)" size="10" maxlength="10"  title="Enter the 4 digit year of when the last dose of vaccine for the condition being investigated was received." styleId="VAC142b_2" onkeyup="YearMask(this, event)" onblur="pgCheckFullYear(this)"/>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="HEP190_2L" title="Was the patient tested for antibody to HBsAg (anti-HBS) within 1-2 months after the last does of vaccine?">
Was patient tested for antibody to HBsAg (anti-HBs) within 1-2 mos after last dose?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(HEP190)" styleId="HEP190_2" title="Was the patient tested for antibody to HBsAg (anti-HBS) within 1-2 months after the last does of vaccine?" onchange="ruleHideUnhHEP1907483();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="HEP191_2L" title="Was the serum anti-HBs &gt;= 10ml U/ml?  (Answer 'Yes' if lab result reported as positive or reactive.)">
Was the serum anti-HBs &gt;= 10ml U/ml?:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO2.answer(HEP191)" styleId="HEP191_2" title="Was the serum anti-HBs &gt;= 10ml U/ml?  (Answer 'Yes' if lab result reported as positive or reactive.)">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
</nedss:container>
</nedss:container>
