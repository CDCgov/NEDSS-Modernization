...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_38_2" name="Industry and Occupation" isHidden="F" classType="subSect" >
...
<tr>
<td class="fieldName">
<span title="Indicate if the patient received overnight healthcare within the United States, but outside of the patient's resident state in the year prior to the date of specimen collection." id="91515_7_2L" >
Was Overnight Healthcare Received within the USA, but outside the patient's state of residence?:</span></td><td>
<span id="91515_7_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(91515_7)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="Did the patient travel internationally in the year prior to the date of specimen collection?" id="TRAVEL38_2L" >
...
<tr>
<td class="fieldName">
<span id="TRAVEL05_2L" title="List the names of the country(ies) outside of the United States the patient traveled to in the year prior to the date of specimen collection, if the patient traveled outside of the United States during that time.">
...
<tr>
<td class="fieldName">
<span title="This data element is used to capture if the patient received overnight healthcare outside of the United States in the year prior to the date of specimen collection." id="90366_6_2L" >
...
<tr>
<td class="fieldName">
<span id="91514_0_2L" title="This data element is used to capture if the patient received overnight healthcare outside of the United States in the year prior to the date of specimen collection.">
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_37_2" name="Lab Testing Repeating Block" isHidden="F" classType="subSect" >
<tr> <td colspan="2" width="100%">
<table role="presentation" width="100%"  border="0" align="center">
<tr><td width="5%">.</td>
<td   width="90%">
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span title="State laboratory specimen identification number." id="FDD_Q_1141_2L">
...
<tr>
<td class="fieldName">
<span title="Indicate the type of specimen tested." id="667469_2L" >
...
<tr>
<td class="fieldName">
<span title="If specimen type is unspecified swab, please provide anatomical site of swab." id="LAB165_2L" >
...
<tr><td class="fieldName">
<span title="If specimen type is unspecified swab, please provide anatomical site of swab." id="LAB165_2_OthL">Other Anatomical Site of Swab (if Specimen Type is unspecified swab):</span></td>
...
<tr>
<td class="fieldName">
<span title="Epidemiologic interpretation of the results of the test(s) performed for this case. This is a qualitative test result (e.g, positive, negative)." id="INV291_2L" >
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span title="Specify the test method (Text) for the type of test performed for this case (e.g., test brand or software, or type of PCR)." id="NBS482_2L">
Test Method:</span>
</td>
<td>
<span id="NBS482_2"/>
<nedss:view name="PageForm" property="pageClientVO2.answer(NBS482)" />
</td> </tr>
</nedss:container>
...
<tr>
<td class="fieldName">
<span title="Indicate the physical location type of the patient when the specimen was collected." id="90041_5_2L" >
Location of Specimen Collection:</span></td><td>
<span id="90041_5_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(90041_5)"
codeSetNm="SPECIMEN_COLLECTION_SETTING_TYPE_C_AURIS"/>
</td> </tr>
<!--Other allowed for this Coded Question-->
<tr><td class="fieldName">
<span title="Indicate the physical location type of the patient when the specimen was collected." id="90041_5_2_OthL">Other Location of Specimen Collection:</span></td>
<td> <span id="90041_5_2_Oth" /> <nedss:view name="PageForm" property="pageClientVO2.answer(90041_5Oth)"/></td></tr>
...
<!--Other allowed for this Coded Question-->
<tr><td class="fieldName">
<span title="County of facility where specimen was collected" id="89202_6_2_OthL">Other County of facility where specimen was collected:</span></td>
<td> <span id="89202_6_2_Oth" /> <nedss:view name="PageForm" property="pageClientVO2.answer(89202_6Oth)"/></td></tr>
</nedss:container>
</nedss:container>
...
<tr>
<td class="fieldName">
<span title="Was patient previously counted as a colonization/screening case?" id="INV1109_2L" >
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span title="If patient was previously counted as a colonization/screening case (clinical C. auris only) or a CP-CRE case, please provide the related case ID(s)." id="INV1110_1_2L">
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span title="If patient was previously counted as a colonization/screening case (clinical C. auris only) or a CP-CRE case, please provide the related case ID(s)." id="INV1110_2_2L">
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span title="If patient was previously counted as a colonization/screening case (clinical C. auris only) or a CP-CRE case, please provide the related case ID(s)." id="INV1110_3_2L">
...
<tr>
<td class="fieldName">
<span title="Does the patient have a history of infection or colonization with another MDRO?" id="INV1270_2L" >
History of infection or colonization with another MDRO?:</span></td><td>
<span id="INV1270_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(INV1270)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span id="INV831_2L" title="If patient has a history of infection or colonization with another MDRO, indicate the MDRO.">
If patient has a history of infection or colonization with another MDRO, indicate the MDRO:</span></td><td>
<span id="INV831_2" />
<nedss:view name="PageForm" property="pageClientVO2.answerArray(INV831)"
codeSetNm="TYPE_COINFECTION_C_AURIS"/>
</td> </tr>
<!--Other allowed for this Coded Question-->
<tr><td class="fieldName">
<span title="If patient has a history of infection or colonization with another MDRO, indicate the MDRO." id="INV831_2_OthL">Other If patient has a history of infection or colonization with another MDRO, indicate the MDRO:</span></td>
<td> <span id="INV831_2_Oth" /> <nedss:view name="PageForm" property="pageClientVO2.answer(INV831Oth)"/></td></tr>
</nedss:container>
</nedss:container>
...
<tr>
<td class="fieldName">
<span title="Did patient have a tracheostomy tube at the time of specimen collection?" id="448621002_2L" >
At the time of specimen collection, did patient have a tracheostomy tube?:</span></td><td>
<span id="448621002_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(448621002)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="Was patient on a ventilator at the time of specimen collection?" id="250870006_2L" >
At the time of specimen collection, was patient on a ventilator?:</span></td><td>
<span id="250870006_2" />
<nedss:view name="PageForm" property="pageClientVO2.answer(250870006)"
codeSetNm="YNU"/>
</td> </tr>
...
<tr>
<td class="fieldName">
<span title="Did the patient have a stay in a long-term care facility in the 90 days before specimen collection date?" id="INV636_2L" >
...
<tr>
<td class="fieldName">
<span id="INV1120_2L" title="If patient had a stay in a long-term care facility in the 90 days before specimen collection date, indicate the type of long-term care facility.">
Long-term Care Facility Type:</span></td><td>
<span id="INV1120_2" />
<nedss:view name="PageForm" property="pageClientVO2.answerArray(INV1120)"
codeSetNm="LONG_TERM_CARE_FACILITY_TYPE_C_AURIS"/>
</td> </tr>
<!--Other allowed for this Coded Question-->
<tr><td class="fieldName">
<span title="If patient had a stay in a long-term care facility in the 90 days before specimen collection date, indicate the type of long-term care facility." id="INV1120_2_OthL">Other Long-term Care Facility Type:</span></td>
<td> <span id="INV1120_2_Oth" /> <nedss:view name="PageForm" property="pageClientVO2.answer(INV1120Oth)"/></td></tr>
</nedss:container>
</nedss:container>
</div> </td></tr>
