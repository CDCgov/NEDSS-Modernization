...
<td>
<html:select name="contactTracingForm" property="cTContactClientVO.answer(DEM113)" styleId="DEM113" title="Patient's current sex.">
...
<td>
<html:select name="contactTracingForm" property="cTContactClientVO.answer(DEM127)" styleId="DEM127" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1277355();pgSelectNextFocus(this);">
...
<td>
<html:text name="contactTracingForm"  property="cTContactClientVO.answer(NBS003)" size="8" maxlength="8"  title="The patient's work phone number extension." styleId="NBS003" onkeyup="isNumericCharacterEntered(this)"/>
</td></tr>
...
<td>
<html:select name="contactTracingForm" property="cTContactClientVO.answer(DEM155)" styleId="DEM155" title="Indicates if the patient is hispanic or not." onchange="ruleEnDisDEM1557362();pgSelectNextFocus(this);">
