...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS143)" styleId="NBS143" title="For field follow-up, is patient eligible for notification of exposure?" onchange="ruleEnDisNBS1437952();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS168)" styleId="NBS168" title="Do you expect the patient to come in for examination?" onchange="ruleHideUnhNBS1687948();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YN)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS173)" styleId="NBS173" title="The disposition of the field follow-up activities." onchange="stdFixedRuleFieldFollowupDispositionEntry();pgSelectNextFocus(this);">
...
<tr>
<td class="fieldName" valign="top" id="NBS186S">Interviewer Selected: </td>
<logic:empty name="PageForm" property="attributeMap.NBS186Uid">
<td> <span id="test2">
</logic:empty>
<logic:notEmpty name="PageForm" property="attributeMap.NBS186Uid">
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS187)" maxlength="10" size="10" styleId="NBS187" onkeyup="DateMaskFuture(this,null,event)" title="The date assigned for interview."/>
...
<tr>
<td class="fieldName" valign="top" id="NBS188S">Initially Assigned Selected: </td>
<logic:empty name="PageForm" property="attributeMap.NBS188Uid">
<td> <span id="test2">
</logic:empty>
<logic:notEmpty name="PageForm" property="attributeMap.NBS188Uid">
...
<tr>
<td class="fieldName" valign="top" id="NBS190S">Supervisor Selected: </td>
<logic:empty name="PageForm" property="attributeMap.NBS190Uid">
<td> <span id="test2">
</logic:empty>
<logic:notEmpty name="PageForm" property="attributeMap.NBS190Uid">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS192)" styleId="NBS192" title="Indicate the status of interviewing the patient of this investigation." onchange="ruleEnDisNBS1927962();ruleEnDisNBS2767963();stdFixedRulePatientInterviewStatusEntry();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS276)" styleId="NBS276" title="Provide reason for not being able to locate the 900 case patient for interview." onchange="ruleEnDisNBS2767963();pgSelectNextFocus(this);">
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS277)" size="50" maxlength="50" title="Describe other reason for not being able to locate the 900 case patient for interview." styleId="NBS277"/>
</td> </tr>
</logic:equal>
</nedss:container>
...
<td style="display:none"><input name="rowKey" type="hidden" value=""></input></td>
<td style="width:3%;text-align:center;">
<input id="viewNBS_INV_STD_UI_30" type="image" src="page_white_text.gif" tabIndex="0" onclick="viewClicked(this.id,'NBS_INV_STD_UI_30');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View" alt="View">
</td><td style="width:3%;text-align:center;">
<input id="editNBS_INV_STD_UI_30" type="image" src="page_white_edit.gif" tabIndex="0" onclick="editClicked(this.id,'NBS_INV_STD_UI_30');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit" alt="Edit">
</td><td style="width:3%;text-align:center;">
<input id="deleteNBS_INV_STD_UI_30" type="image" src="cross.gif" tabIndex="0" onclick="deleteClicked(this.id,'NBS_INV_STD_UI_30','patternNBS_INV_STD_UI_30','questionbodyNBS_INV_STD_UI_30');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete" alt="Delete">	</td>
<% for(int i=0;i<batchrec.length;i++){%>
<% String validdisplay =batchrec[i][0]; %>
<%    if(batchrec[i][4] != null && batchrec[i][2].equals("Y"))  {%>
<% String per = batchrec[i][4];
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS195User)" size="30" maxlength="30" title="This is a hidden read-only field for the user that added or updated the note" styleId="NBS195User" onkeyup="unhideBatchImg('NBS_INV_STD_UI_30');"/>
</td> </tr>
<% String disableSubmitButton="no";
if(request.getAttribute("disableSubmitButton") != null){
disableSubmitButton= request.getAttribute("disableSubmitButton").toString();
...
<tr><td colspan="2" align="left"><span id="NBS_INV_STD_UI_33L">&nbsp;&nbsp;Investigation may not be closed while interview status is awaiting or investigation is pending supervisor approval of field record closure. Also all contact records identified in this investigation must have a disposition.</span> </td></tr>
