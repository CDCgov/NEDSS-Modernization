...
<tr>
<td class="fieldName" valign="top">
<span title="Provide reason for not being able to locate the 900 case patient for interview." id="NBS276L" >
Reason Unable to Locate 900 Case:</span></td><td>
<span id="NBS276" />
<nedss:view name="PageForm" property="pageClientVO.answer(NBS276)"
...
<!--processing Text Question-->
<tr> <td valign="top" class="fieldName">
<span title="Describe other reason for not being able to locate the 900 case patient for interview." id="NBS277L">
Other Reason, Specify:</span>
</td>
<td>
<span id="NBS277"/>
<nedss:view name="PageForm" property="pageClientVO.answer(NBS277)" />
</td> </tr>
</logic:equal>
</nedss:container>
