...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS111)" styleId="NBS111" title="The Initiating Agency which sent the OOJ Contact Report." onchange="ruleEnDisNBS1117931();pgSelectNextFocus(this);">
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS118)" maxlength="10" size="10" styleId="NBS118" onkeyup="DateMask(this,null,event)" title="The date of first exposure with sex partner reported  by OOJ Contact."/>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS119)" size="40" maxlength="40" title="The frequency of exposure with sex partner reported by OOJ Contact." styleId="NBS119"/>
</td> </tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS120)" maxlength="10" size="10" styleId="NBS120" onkeyup="DateMask(this,null,event)" title="The date of last exposure with sex partner reported by OOJ Contact."/>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS121)" maxlength="10" size="10" styleId="NBS121" onkeyup="DateMask(this,null,event)" title="The date of first exposure with needle-sharing partner reported by OOJ Contact."/>
...
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS122)" size="40" maxlength="40" title="The frequency of exposure with needle-sharing partner reported by OOJ Contact." styleId="NBS122"/>
</td> </tr>
...
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS123)" maxlength="10" size="10" styleId="NBS123" onkeyup="DateMask(this,null,event)" title="The date of last exposure with needle-sharing partner reported by OOJ Contact."/>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS127)" styleId="NBS127" title="During the course of the interview, did the DIS elicit internet information about the named contact?" onchange="stdConInternetInfoElicitedRequireInternetFollowup();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV128)" styleId="INV128" title="Was the patient hospitalized as a result of this event?" onchange="ruleEnDisINV1287913();updateHospitalInformationFields('INV128', 'INV184','INV132','INV133','INV134');pgSelectNextFocus(this);;ruleDCompINV1327918();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV145)" styleId="INV145" title="Indicates if the subject dies as a result of the illness." onchange="ruleEnDisINV1457914();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV150)" styleId="INV150" title="Denotes whether the reported case was associated with an identified outbreak." onchange="ruleEnDisINV1507916();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV152)" styleId="INV152" title="Indication of where the disease/condition was likely acquired." onchange="ruleEnDisINV1527917();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(INV502)" styleId="INV502" title="Indicates the country in which the disease was potentially acquired." onchange="unhideBatchImg('NBS11002');ruleEnDisINV5027945();getDWRStatesByCountry(this, 'INV503');pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(PSL_CNTRY)" value="key" label="value" /> </html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NOT120)" styleId="NOT120" title="Does this case meet the criteria for immediate (extremely urgent or urgent) notification to CDC?" onchange="ruleHideUnhNOT1207947();pgSelectNextFocus(this);">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(STD102)" styleId="STD102" title="Neurological Involvement?" onchange="ruleEnDisSTD1027967();enableOrDisableOther('102957003');enableOrDisableOther('102957003');pgSelectNextFocus(this);">
