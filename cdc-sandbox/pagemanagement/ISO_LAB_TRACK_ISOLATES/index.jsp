...
pgHideElement('NBS_LAB333_2');
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
    	...
    	var retVal;
     	retVal = ruleDCompNBS_LAB3616409();
        ...
        retVal = ruleDCompNBS_LAB3616410();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompNBS_LAB3626411();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisNBS_LAB3536395();ruleHideUnhNBS_LAB3316396();ruleHideUnhNBS_LAB3316397();ruleHideUnhNBS_LAB3376398();ruleHideUnhNBS_LAB3386399();ruleHideUnhNBS_LAB3456400();ruleHideUnhNBS_LAB3466401();ruleHideUnhNBS_LAB3466402();ruleHideUnhNBS_LAB3516403();ruleHideUnhNBS_LAB3526404();ruleHideUnhNBS_LAB3596405();ruleHideUnhNBS_LAB3586406();ruleHideUnhNBS_LAB3536407();ruleHideUnhNBS_LAB3526408();ruleHideUnhNBS_LAB3326412();
    ...
    pgCheckOnloadOtherEntryAllowedFields();pgCheckDynamicRulesOnLoad();pgCheckForFieldsToHighlightOnEdit();pgPopulateCounties();addRolePresentationToTabsAndSections();populateDrugTestData();populateCodedResultDataSusc(); populateResultMethodDataSusc();onloadBlockParent();" onunload="unloadSubForms(true, event);">
     ...
     <!-- ################### PAGE TAB ###################### - - -->
      <layout:tabs width="100%" styleClass="tabsContainer">
      		...
      		<jsp:include page="IsolateTracking.jsp"/>
             	</layout:tab>               	
