...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_27" name="Patient Search" isHidden="F" classType="subSect" >

<!--processing Patient search Button-->
<tr><td align="left"><input id="NBS_UI_24L" onclick="getPatient('PatentSearch')" type="button" value="Search"/><img width="2" height="0" alt="" src="transparent.gif" border="0"/><input onclick="clearPatientData()" type="button" value="Clear"/></td></tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_4" name="General Information" isHidden="F" classType="subSect" >
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(NBS455)" styleId="NBS455" title="Provide context of the Lab Report. That is if Lab is created Internally, Externally or Electronically." onchange="ruleHideUnhNBS4556425();ruleHideUnhNBS4556424();ruleHideUnhNBS4556423();ruleHideUnhNBS4556421();ruleHideUnhNBS4556420();ruleHideUnhNBS4556419()">
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_5" name="Name Information" isHidden="F" classType="subSect" >
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="NBS462L" title="Patient Name">
Name:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS462)" size="200" maxlength="200" title="Patient Name" styleId="NBS462"/>
</td> </tr>

<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="NBS463L" title="Patient Alias">
Alias:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO.answer(NBS463)" size="200" maxlength="200" title="Patient Alias" styleId="NBS463"/>
</td> </tr>
</nedss:container>

<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_6" name="Other Personal Details" isHidden="F" classType="subSect" >
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM113)" styleId="DEM113" title="Patient's current sex." onchange="ruleEnDisDEM1136417();ruleEnDisINV1786418();pgSelectNextFocus(this);">
...
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM127)" styleId="DEM127" title="Indicator of whether or not a patient is alive or dead." onchange="ruleEnDisDEM1276416();pgSelectNextFocus(this);">
...
<logic:notEqual name="PageForm" property="actionMode" value="Create">
<tr><td class="fieldName">
<span class="InputFieldLabel" id="NBS451L" title="As of Date is the last known date for which the information is valid.">
SSN As Of Date:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO.answer(NBS451)" maxlength="10" size="10" styleId="NBS451" onkeyup="DateMask(this,null,event)" title="As of Date is the last known date for which the information is valid."/>
...
<!--processing Text Question-->
<tr> <td class="fieldName">
<span class="InputFieldLabel" id="DEM133L" title="The patient's social security number.">
SSN:</span>
</td>
<td>
<html:text name="PageForm" property="pageClientVO.answer(DEM133)" size="40" maxlength="40" title="The patient's social security number." styleId="DEM133" onkeyup="SSNMask(this, event)"/>
</td> </tr>
</nedss:container>
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_7" name="Reporting Address for Case Counting" isHidden="F" classType="subSect" >
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_8" name="Telephone Information" isHidden="F" classType="subSect" >
...
<!-- ########### SUB SECTION ###########  -->
<nedss:container id="NBS_UI_10" name="Birth Information" isHidden="F" classType="subSect" >

<!--processing Coded Question  -->
<tr><td class="fieldName">
<span class=" InputFieldLabel" id="DEM116_BL" title="An indicator whether a patient is part of a multiple birth.">
Multiple Birth:</span>
</td>
<td>
<html:select name="PageForm" property="pageClientVO.answer(DEM116_B)" styleId="DEM116_B" title="An indicator whether a patient is part of a multiple birth.">
<nedss:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
</td></tr>
...
<tr>
<td class="fieldName">
<span class="InputFieldLabel" id="DEM117_BL" title="patients birth order in a multiple birth.">
Birth Order:</span>
</td>
<td>
<html:text name="PageForm"  property="pageClientVO.answer(DEM117_B)" size="100" maxlength="100"  title="patients birth order in a multiple birth." styleId="DEM117_B" onkeyup="isNumericCharacterEntered(this)"/>
</td></tr>
