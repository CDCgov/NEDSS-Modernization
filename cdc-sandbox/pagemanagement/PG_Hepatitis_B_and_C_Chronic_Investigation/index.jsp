...
pgDisableElement('INV842');
  ...
  function ruleHideUnhINV5757444()
{
 var foo = [];
...
pgHideElement('INV901_2');
  ...
  function ruleHideUnhNOT1207445()
{
 var foo = [];
...
pgHideElement('NOT120SPEC_2');
  ...
  function ruleHideUnhLP38332_07446()
{
 var foo = [];
...
pgHideElement('INV841_2');
  ...
  function ruleHideUnhINV8297447()
{
 var foo = [];
$j('#INV829 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
 });
if(foo=='' && $j('#INV829').html()!=null){foo[0]=$j('#INV829').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Yes')==true)){
pgSubSectionShown('NBS_INV_HEPCHBC_UI_5');
 } else { 
pgSubSectionHidden('NBS_INV_HEPCHBC_UI_5');
 }
 var foo_2 = [];
$j('#INV829_2 :selected').each(function(i, selected){
 foo_2[i] = $j(selected).val();
 });
if(foo_2=='' && $j('#INV829_2').html()!=null){foo_2[0]=$j('#INV829_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('Y',foo_2) > -1) || ($j.inArray('Yes'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Yes')==true)){
pgSubSectionShown('NBS_INV_HEPCHBC_UI_5_2');
 } else { 
pgSubSectionHidden('NBS_INV_HEPCHBC_UI_5_2');
 }   
}
      
  function ruleHideUnhINV1697448()
{
 var foo = [];
...
if(foo=='' && $j('#INV169').html()!=null){foo[0]=$j('#INV169').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('10106',foo) > -1) || ($j.inArray('Hepatitis C virus infection (past or present)'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Hepatitis C virus infection (past or present)')==true) || ($j.inArray('JWHepCChronic',foo) > -1) || ($j.inArray(' JW Hepatitis C'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,' JW Hepatitis C')==true)){
pgSubSectionShown('NBS_INV_HEPCHBC_UI_3');
 } else { 
pgSubSectionHidden('NBS_INV_HEPCHBC_UI_3');
 }
 var foo_2 = [];
...
if(foo_2=='' && $j('#INV169_2').html()!=null){foo_2[0]=$j('#INV169_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('10106',foo_2) > -1) || ($j.inArray('Hepatitis C virus infection (past or present)'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Hepatitis C virus infection (past or present)')==true) || ($j.inArray('JWHepCChronic',foo_2) > -1) || ($j.inArray(' JW Hepatitis C'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,' JW Hepatitis C')==true)){
pgSubSectionShown('NBS_INV_HEPCHBC_UI_3_2');
 } else { 
pgSubSectionHidden('NBS_INV_HEPCHBC_UI_3_2');
 }   
}
      
  function ruleHideUnhINV1697449()
{
 var foo = [];
$j('#INV169 :selected').each(function(i, selected){
 foo[i] = $j(selected).val();
...
if(foo=='' && $j('#INV169').html()!=null){foo[0]=$j('#INV169').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('10105',foo) > -1) || ($j.inArray('Chronic hepatitis B'.replace(/^\s+|\s+$/g,''),foo) > -1 || indexOfArray(foo,'Chronic hepatitis B')==true)){
...
if(foo_2=='' && $j('#INV169_2').html()!=null){foo_2[0]=$j('#INV169_2').html().replace(/^\s+|\s+$/g,'');}
 if(($j.inArray('10105',foo_2) > -1) || ($j.inArray('Chronic hepatitis B'.replace(/^\s+|\s+$/g,''),foo_2) > -1 || indexOfArray(foo,'Chronic hepatitis B')==true)){
...
pgHideElement('MTH109_2');
  ...
  function ruleHideUnhINV603_67450()
{
 var foo = [];
...
pgHideElement('INV897_2');
     ...
     function pgCheckForDynamicRuleErrorsOnSubmit() {
        ...
        retVal = ruleDCompINV1377437();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1157438();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
        retVal = ruleDCompDEM1157439();
     	   if (retVal != null && retVal.elements != undefined) { errorElts = errorElts.concat(retVal.elements); errorLabels = errorLabels.concat(retVal.labels); }  
      ...
      function pgCheckDynamicRulesOnLoad() {
           	...
           	ruleEnDisINV1287430();ruleEnDisINV1457431();ruleEnDisDEM1277432();ruleEnDisINV1507433();ruleEnDisINV1527434();ruleEnDisDEM1137435();ruleEnDisINV5027440();ruleEnDisINV1787441();ruleEnDisINV5767442();ruleEnDisINV8877443();ruleHideUnhINV5757444();ruleHideUnhNOT1207445();ruleHideUnhLP38332_07446();ruleHideUnhINV8297447();ruleHideUnhINV1697448();ruleHideUnhINV1697449();ruleHideUnhINV603_67450();
