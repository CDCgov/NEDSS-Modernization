...
public class EthnicityMother {
    ...
    public static CodeValueGeneral hispanicOrLatino() {
        ...
        return CodeValueGeneral.builder()
                .id(new CodeValueGeneralId("PHVS_ETHNICITYGROUP_CDC_UNK", HISPANIC_OR_LATINO))
                ...
                .statusTime(now)
                .conceptTypeCd("PHIN")
                .conceptCode(HISPANIC_OR_LATINO)
    ...
    public static CodeValueGeneral notHispanicOrLatino() {
        var now = Instant.now();
        return CodeValueGeneral.builder()
                .id(new CodeValueGeneralId("PHVS_ETHNICITYGROUP_CDC_UNK", NOT_HISPANIC_OR_LATINO))
                ...
                .statusTime(now)
                .conceptTypeCd("PHIN")
                .conceptCode(NOT_HISPANIC_OR_LATINO)
    ...
    public static CodeValueGeneral unknown() {
        var now = Instant.now();
        return CodeValueGeneral.builder()
                .id(new CodeValueGeneralId("PHVS_ETHNICITYGROUP_CDC_UNK", UNKNOWN))
                .codeDescTxt("unknown")
