...
export default class EditHomePageLdfPage extends BasePage {
    constructor(id: string) {
        super(`/LocalFields.do?method=editLDF&uiMetadataUid=${id}#localField`);
    }
    ...
    setDisplayOrder(displayOrder: string): void {
        // workaround as the cy.clear doesn't seem to work on this input
        cy.get(Selector.DISPLAY_ORDER_INPUT, this.defaultOptions).invoke('val', '');
